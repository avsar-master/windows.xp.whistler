...
LONG APIENTRY
DrawPoly(HDC dstDC, LPRECT lprBounds, WPARAM wParam)
{
   int dx, dy;
...
void
PolyDP(HWND hWnd, UINT message, WPARAM wParam, LONG lParam)
{
   ...
   case WM_LBUTTONDOWN:
      ...
      if(TrackTool(hWnd, DrawPoly, &rcReturn, &wParam, NULL) == WM_RBUTTONDOWN)
      {
