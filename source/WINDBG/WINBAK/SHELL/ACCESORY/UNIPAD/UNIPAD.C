  ...
  FARPROC  lpfn;
    ...
    switch (GET_WM_COMMAND_ID(wParam, lParam))
    {
        ...
        case M_WW:
             ...
             * the Find and Find/Replace dialogs.    13 June 2000     clarkc
             */
 ...
 * use the default printer.    31 August 2000   Clark Cyr
 */
 ...
 * the fRunBySetup conditional!    28 June 2000    Clark Cyr
 */
    ...
    LPTSTR sz)
{
    ...
    /* Strip path/drive specification from name if there is one */
    /* Ripped out AnsiPrev calls.     21 March 2000  clarkc     */
