...
HISTORY
    ...
    sds		27 Mar 2000	now discarding trailing shift/down msgs
    sds		28 Mar 2000	now clears old BREAK's when starting record
    sds		3 Apr 2000	Heuristics no longer allows macro to end
				with naked KEYDOWN
    sds		6 Apr 2000	Changed recording suspension handling
    sds		26 Apr 2000	added B_FORCEACTIVE bit to buttondown
				msg following junked alt/tab/esc sequence
    sds		16 May 2000	taking advantage of protectmode
    sds		12 Jun 2000	bProtMode now bNotBanked
    sds		7 Aug 2000	fixed ctrl/numlock hotkey bug - is a PAUSE
    sds		10 Aug 2000	fixed bug adding time delay of trashed
    ...
    sds 	7 Jan 2000	cleanup for MSC6
    johnsp	13 Feb 2000
*/
/* -------------------------------------------------------------------- */
