...
HISTORY
    ...
    sds		6 Dec 88	Initial Coding
		...
		28 Mar 2000	output file now written to TEMP or \
				of destination drive before rename
		29 Mar 2000	now warns of overwrite existing file
		30 Mar 2000	LdStr upgrade
		31 Mar 2000	fixed check-for-existing-file bug, better
				bogus filename handling
		3 Apr 2000	dlgSave now hilites EDIT ctl string
		26 Apr 2000	dlgSave now uppercases new file name
		2 May 2000	fixed bug in dodirlb
		16 May 2000	tdyn.h now tracerd.h
				healed drain-bamaged dlgSave
		18 May 2000	now using OpenIt to load file
		18 May 2000	massive user intfc changes
		23 May 2000	fixed bug losing merged macro code/desc
		26 May 2000	added directory listbox to File/Save
		30 May 2000	fixed initial dir in File/Save
    sds		30 May 2000	system menu support
    sds		7 Jun 2000	removed unused code
    sds		9 Jun 2000	name change to recorder
    sds		12 Jun 2000	SaveIt now supports bOverWrite
    sds		3 Jul 2000	FixSysMenu not needed for Win30
				now using wsprintf
    				merge not sets bFileChanged
    sds		27 Jul 2000	now using AnsiUpper, not toupper
    sds		18 Aug 2000	AddHotKey now passes id
				fixed bug not reporting File/Save errors
				fixed File/Save to bogus file handling
    sds		29 Sep 2000	fixed oem/ansi bugs with file names
    sds		10 Oct 2000	fixed bug not restoring listbox on
				  failed file/merge
				workaround for OpenFile oddity of looking
				  in Windows startup directory
    sds		11 Oct 2000	now catches _dos_close error
    sds		31 Oct 2000	dlgSave no longer puts template in EDIT ctl
				now enables OK only if file name not blank
    sds		28 Nov 2000	E_NOTRECORDERFILE on read of bogus file
    sds		30 Nov 2000	changed MB_ICONQUESTION to MB_ICONEXCLAMATION
    sds		26 Dec 2000	warns on merge creating 2 macros with no
