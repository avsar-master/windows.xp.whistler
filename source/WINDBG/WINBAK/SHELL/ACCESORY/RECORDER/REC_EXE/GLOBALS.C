...
HISTORY
    ...
    sds		3 Jan 89	added szWinOldApp, globalized common strings
		...
		28 Mar 2000	szTempDir
		30 Mar 2000	szNomem
		5 Apr 2000	bRecording
		27 Apr 2000	fBreakType, szDeskInt
		5 May 2000	szDeskInt deleted
		9 May 2000	hWndKey
		16 May 2000	bProtMode
		18 May 2000	REMOTECTL stuff
		18 May 2000	massive user intfc changes
		12 Jun 2000	bProtMode now bNotBanked, bNoFlash, WIN2 stuff
		27 Jul 2000	.hlp now loaded in szDothlp
		17 Aug 2000	fBreakType now a word
		18 Sep 2000	bSuspended
