...
/* This has the problem that spaces do not have the same width as numbers
   ...
   bandaid and should be written correctly later.  17 July 2000  Clark Cyr */
...
#if defined (JAPAN)||defined(KOREA) //  added 29 May 2000  by Hiraisi
/*
