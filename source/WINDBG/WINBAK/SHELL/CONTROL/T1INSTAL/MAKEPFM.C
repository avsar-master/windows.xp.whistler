...
//---------------------------------------------------------------------------
//
//      Copyright 1990, 2000 -- Adobe Systems, Inc.
...
"Copyright (C) 2000-91, Adobe Systems Inc. All Rights Reserved.\n\n",
...
*****************************************************************/
static CHAR szCopyright[] = "Copyright 1988-2000 Adobe Systems Inc.";
VOID SetDf(pcl)
INT pcl;
{
//WORD minAscent;
