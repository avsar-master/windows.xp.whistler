...
*
* History:
*  31-May-2000 -by- Gilman Wong [gilmanw]
* Wrote it.
\**************************************************************************/
...
*
* History:
*  11-Oct-2000 -by- Gilman Wong [gilmanw]
* Wrote it.
\**************************************************************************/
...
*
* History:
*  07-Feb-2000 -by- Gilman Wong [gilmanw]
* Wrote it.
\**************************************************************************/
...
*
* History:
*  09-May-2000 -by- Gilman Wong [gilmanw]
* Wrote it.
\**************************************************************************/
...
*
* History:
*  29-May-2000 -by- Gilman Wong [gilmanw]
* Wrote it.
\**************************************************************************/
...
*
* History:
*  22-Aug-2000 -by- Gilman Wong [gilmanw]
* Wrote it.
\**************************************************************************/
...
// Test description string.
    ...
    AddFontResource((LPSTR) "c:\\xp\\windows\\fonts\\tmsre.fon");

    cjBuf = 0;
    if (!GetFontResourceInfo((LPSTR) "c:\\xp\\windows\\fonts\\tmsre.fon", (LPDWORD) &cjBuf, (LPVOID) NULL, GFRI_DESCRIPTION))
        DbgPrint("vPrintGetFontResourceInfoTest(); GetFontResourceInfo failed\n");

    DbgPrint("Text string length is: %ld\n", cjBuf-1);

    if (!GetFontResourceInfo((LPSTR) "c:\\xp\\windows\\fonts\\tmsre.fon", (LPDWORD) &cjBuf, (LPVOID) gach, GFRI_DESCRIPTION))
        DbgPrint("vPrintGetFontResourceInfoTest(); GetFontResourceInfo failed\n");
...
// Log font test.
    ...
    cjBuf = sizeof(nFonts);
    if (!GetFontResourceInfo((LPSTR) "c:\\xp\\windows\\fonts\\tmsre.fon", (LPDWORD) &cjBuf, (LPVOID) &nFonts, GFRI_NUMFONTS))
        DbgPrint("vPrintGetFontResourceInfoTest(); GetFontResourceInfo failed\n");

    DbgPrint("There are %ld fonts in the file\n", nFonts);

    cjBuf = 0;
    if (!GetFontResourceInfo((LPSTR) "c:\\xp\\windows\\fonts\\tmsre.fon", (LPDWORD) &cjBuf, (LPVOID) NULL, GFRI_LOGFONTS))
        DbgPrint("vPrintGetFontResourceInfoTest(); GetFontResourceInfo failed\n");

    DbgPrint("Size of buffer needed for LOGFONTS: %ld\n", cjBuf);
    DbgPrint("nFonts * sizeof(LOGFONT) = %ld\n", nFonts * sizeof(LOGFONT));

    if (!GetFontResourceInfo((LPSTR) "c:\\xp\\windows\\fonts\\tmsre.fon", (LPDWORD) &cjBuf, (LPVOID) galf, GFRI_LOGFONTS))
        DbgPrint("vPrintGetFontResourceInfoTest(); GetFontResourceInfo failed\n");
    ...
    RemoveFontResource((LPSTR) "c:\\xp\\windows\\fonts\\tmsre.fon");
