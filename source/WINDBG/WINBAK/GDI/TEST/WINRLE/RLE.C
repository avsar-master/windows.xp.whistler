...
*
* History:
*  15 Feb 2000 - Andrew Milton (w-andym):  Creation.
*
\*****************************************************************************/
...
*
* History:
*  29 Jan 2000 - Andrew Milton (w-andym):
*      Removed the sizing of the client window.
*
*  29-Oct-2000 -by- Patrick Haluptzok patrickh
* Wrote it.
\**************************************************************************/
...
*
* History:
*  28 Jan 2000 - Andrew Milton (w-andym):
...
*
*  15-Mar-2000 -by- Patrick Haluptzok patrickh
* Wrote it.
\**************************************************************************/
...
*
* History:
*  12 Mar 2000 - Andrew Milton (w-andym):
...
*
*  12-Oct-2000 -by- Patrick Haluptzok patrickh
* Wrote it.
\**************************************************************************/
...
*
* History:
*  20-Mar-2000 -by- Patrick Haluptzok patrickh
* Wrote it.
\**************************************************************************/
...
*
* History:
*  26-Sep-2000 -by- Patrick Haluptzok patrickh
* Wrote it.
\**************************************************************************/
...
*
*  27 Jan 2000 - Andrew Milton (w-andym):
*      Added message boxes for telling the user about error conditions.
*
*  15 Jan 2000 - Andrew Milton (w-andym):
