...
// Created: 12-Feb-2000
//
//  26-Mar-2000 Thu 23:29:37 updated  -by-  Daniel Chou (danielc)
...
//
// History:
//   12-Feb-2000     -by-     Kent Settle     (kentse)
//  Wrote it.
//--------------------------------------------------------------------------
...
//
// History:
//  26-Mar-2000 Thu 23:33:58 updated  -by-  Daniel Chou (danielc)
...
//
// History:
//   26-Apr-2000     -by-     Kent Settle     (kentse)
//  Wrote it.
//--------------------------------------------------------------------------
...
//   26-Apr-2000     -by-     Kent Settle     (kentse)
//  Wrote it.
//   14-Nov-2000    -by-    Kent Settle     [kentse]
...
//
// History:
//   27-Sep-2000     -by-     Kent Settle     (kentse)
//  Wrote it.
//--------------------------------------------------------------------
...
//
// History:
//   27-Mar-2000    -by-        Kent Settle     (kentse)
//  Wrote it.
//--------------------------------------------------------------------
...
//
// History:
//   15-Jul-2000    -by-    Kent Settle     (kentse)
//  Added Font Substitution support.
//   27-Feb-2000    -by-    Kent Settle     (kentse)
//  Added support for downloading, ie caching, GDI fonts.
//   20-Feb-2000    -by-    Kent Settle     (kentse)
...
//
// History:
//   12-Sep-2000     -by-     Kent Settle     (kentse)
//  Wrote it.
//--------------------------------------------------------------------
...
//
// History:
//   26-Sep-2000     -by-     Kent Settle     (kentse)
//  Wrote it.
//--------------------------------------------------------------------
...
//
// History:
//   11-Jun-2000    -by-    Kent Settle     (kentse)
//  Wrote it.
//--------------------------------------------------------------------
...
//
// History:
//   14-Jul-2000    -by-    Kent Settle     (kentse)
//  Wrote it.
//--------------------------------------------------------------------
...
//
// History:
//   22-Jul-2000    -by-    Kent Settle     (kentse)
//  Wrote it.
//--------------------------------------------------------------------
...
//  Stole from RASDD.
//   21-Aug-2000    -by-    Lindsay Harris  (lindsayh)
