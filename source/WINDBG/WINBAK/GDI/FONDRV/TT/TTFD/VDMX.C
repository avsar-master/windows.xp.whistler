...
* History:
*
*  Tue 21-Jul-2000 -by- Bodin Dresevic [BodinD]
* update: ported to NT
*	15 Nov 2000	-by-	Raymond E. Endres	[rayen]
* Added aspect ratio option and optimized the function.
*	3  Oct 2000	-by-	Jean-francois Peyroux	[jeanp]
* Wrote it.
**************************************************************************/
...
*
* History:
*  25-Jul-2000 -by- Bodin Dresevic [BodinD]
* Wrote it.
\**************************************************************************/
