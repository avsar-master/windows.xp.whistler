...
*  08-Feb-2000 JohnSc   bug 824: CallPath() -> FCallPath() (can fail)
*  2000/02/11 kevynct  Added calls to ToggleHotspots when losing focus and
*                      when completing a Vscroll
*  2000/02/12 kevynct  Or an Hscroll. Oops.
*  11-Feb-2000 JohnSc   bug 873: Backup() -> FBackup() to allow OOM
*                                message on alloc failure
*  2000/02/13 kevynct  H3.5 892: Added WM_JUMPPA handler
* 12-Mar-2000 RussPJ    Took ownership.
*  14-Mar-2000 LeoN    FScrollHde looses its line count parameter.
*                      MouseInFrame => MouseInTopicHde RefreshHde =>
*                      RepaintHde; PtGetLayoutSizeHde =>
*                      GetLayoutSizeHdePpt; SCROLL_LINE* constants become
*                      SCROLL_INCR*;
*  01-Apr-2000 LeoN    WM_ENDSESSION: don;t call destroy help for 2ndwin
*  05-Apr-2000 LeoN    YArrangeButtons takes an additional param.
*  09-Apr-2000 LeoN    HELP31 #1028; make sure that buttons are redrawn
...
* 20-Apr-2000 RussPJ    Removed some -W4s
*  17-Apr-2000 LeoN    Add Help-On-Top support
*  23-Apr-2000 LeoN    If minimized, restore before hiding.
*  01-May-2000 LeoN    HELP31 #1081: Add fNoHide.
*  03-May-2000 LeoN    HELP31 #1094: shadow window ought to be dark gray
*  14-May-2000 JohnSc  comments and stuff concerning timestamp bs
* 09-May-2000 RussPJ  Added support for WM_MACRO message in HelpWndProc:
*                     This fixes 3.1 bug #1092.
* 13-May-2000 LeoN    Minor Optimization
* 15-May-2000 LeoN    HELP31 #1078: Clean up the way we dismiss dialogs on
*                     a WM_KILLDLG message
* 15-May-2000 LeoN    HELP3.1 #1012: don;t hide under win3.0 if we're
*                     iconic.
* 27-May-2000 LeoN    HELP31 #1145: Free any pre-existing icon on destroy
* 29-Jul-2000 Tomsn   win32: use MSetWindowWord() meta api.
* 27-Aug-2000 LeoN    HELP31 #1245: rctHelp applies ONLY to the main window
* 27-Aug-2000 LeoN    HELP31 #1262: as veiwer, never hide.
* 27-Aug-2000 LeoN    HELP31 #1268: Send WM_CLOSE to secondary window on
*                     exit.
* 27-Aug-2000 LeoN    Remove mini-frame support.
* 28-Aug-2000 LeoN    Clean up doc in TrackShadowHwnd to account for Win 3.1
*                     wierdness.
* 04-Sep-2000 JohnSc  H35 #129 (H31 #1013) actually do timestamp stuff
* 06-Sep-2000 RussPJ  3.5 #318 - Killed CBT on help support.
* 06-Sep-2000 RussPJ  3.5 #224 - palette support for dying EWs.
* 08-Sep-2000 RussPJ  3.5 #231 & 338 - Restoring to maximized state.
* 08-Sep-2000 RussPJ  3.5 #363 - Using hpalSystemCopy for WM_ASKPALETTE
* 16-Sep-2000 JahyenC 3.5 #5 - Added lock count increment/decrement to
*                     GetAndSetHDS() and RelHDS() with associated checks
* 05-Oct-2000 RussPJ  Cleaned up GetAndSetHDS() a little in error case.
* 06-Nov-2000 BethF   HELP35 #589: Added call to UpdateWinIniValues() on
*                     WM_WININICHANGE message.
* 08-Nov-2000 BethF   HELP35 #615: Don't process button accelerators in
*                     FExecKey() if called by the NoteWndProc().
* 12-Nov-2000 BethF   HELP35 #572: Destroy fake parent window and floating
*                     menu on HelpWndProc WM_CLOSE.
* 09-Dec-2000 LeoN    Ensure that shadow background tracks appropriately.
*                     Ensure GHWW_HWNDSHDW is null after shadow window
*                     destroyed.
* 08-Jan-2000 LeoN    HELP31 #1351: remove WFLAGS_SHADOW
* 13-Jan-2000 LeoN    HELP31 #1389: Ensure shadow window gone on close
* 10-Feb-2000 RussPJ  3.1 #1363 - Removing goofy CBT support.
* 22-Feb-2000 LeoN    HELP31 #1403: hide shadow window when iconized
* 22-Feb-2000 LeoN    HELP35 #744: GetVersion => GetWindowsVersion
* 22-Feb-2000 LeoN    HELP35 #1401: Add wERRA_LINGER in timestamp checking
*                     code.
* 25-Feb-2000 RussPJ  3.5 #609 - Better Int'l browse buttons support.
* 27-Feb-2000 RussPJ  3.5 #581 - More goofiness with EWs.
* 28-Feb-2000 RussPJ  3.5 #677 - Killing hwndPath
* 03-Apr-2000 RussPJ  3.5 #630 - Removed fNoHide.
* 03-Apr-2000 RussPJ  3.5 #739 - Search macro killed subsequent macros.
* 08-Apr-2000 JohnSc  3.5 #754 - back (any button, actually) happens twice
* 08-Jun-2000 Sanfords Removed GMEM_DDESHARE dependencies, removed fInformCBT
*
*****************************************************************************/
...
******/
    ...
    case WM_HREPAINT:
       ...
       * display the same topic. At this time (19-Jan-2000) this message
