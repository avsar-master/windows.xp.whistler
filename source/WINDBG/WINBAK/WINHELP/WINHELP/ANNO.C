...
*  ANNO.C                                                                    *
*                                                                            *
*  Copyright (C) Microsoft Corporation 2000, 1990.                           *
*  All Rights reserved.                                                      *
*                                                                            *
******************************************************************************
*                                                                            *
...
*
*  May 21, 2000   w-kevct   uses Help 3.0 FS now.
*  Sep 26, 2000   kevynct   Creates annotation file only on first write
*                           attempt, using HadsCreateAnnoDoc call.
*  Oct  3, 2000   kevynct   Totally rewritten; now uses a single file
*                           for each annotation.
