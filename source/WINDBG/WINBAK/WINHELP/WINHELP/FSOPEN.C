...
*  08-Feb-2000 JohnSc   Bug 848: FM shit can fail
*  06-Jun-2000 Tomsn    Call IDiscardFileSDFF() when closing a file.
*  22-Jul-2000 DavidFe  Took a function call out of an assert
*  07-Oct-2000 JahyenC  3.5 #525. Dispose FM in error_no_sdff condition
*                       in HfsOpenFm().
* 16-Oct-2000 RussPJ    Removed a line that caused errors with retail
*                       optimizations.
*
*****************************************************************************/
