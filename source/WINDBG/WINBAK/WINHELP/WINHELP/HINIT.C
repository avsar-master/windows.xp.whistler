...
* 02-Jan-2000 LeoN      Correct for a couple of windows assumptions I busted.
* 14-Jan-2000 JohnSc    removed bookmark stuff (now open bmfs at menu time)
* 16-Jan-2000 LeoN      Move creation of note and history windows to happen
*                       on first use. Moved some common stuff to wndclass.h
* 25-Jan-2000 RussPJ    Took ownership after review.
* 01-Feb-2000 LeoN      Copied command line into local buffer.
* 02-Feb-2000 RussPJ    Using near pointers only in command line parsing.
* 02-Feb-2000 RussPJ    Fixed bug with '-' terminated command lines.
* 04-Feb-2000 RussPJ    Copying command line even more safely.
* 10-Feb-2000 RussPJ    Adding extension of command line filename from
*                       sidOpenExt in winhelp.rc.
* 20-Feb-2000 LeoN      Destroy dialogs in QuitHelp.
* 18-Mar-2000 LeoN      HELP31 #978: In QuitHelp, send close messages to both
*                       main and secondary windows
* 27-Mar-2000 LeoN      HELP31 #1011: Correct cbextra for secondary window
* 05-Apr-2000 LeoN      Turn off CS_VREDRAW | CS_HREDRAW for the main help
...
* 24-Apr-2000 LeoN      HELP31 #1019: be pen window aware
* 25-Apr-2000 LeoN      HELP31 #1038: Allow assert dialog to be app modal.
* 01-May-2000 LeoN      HELP31 #1081: Add fNoHide.
* 13-May-2000 RussPJ    Removed a -W4.
* 14-May-2000 RussPJ    Fixed 3.1 #976 - Calling DeleteSmallSysFont()
* 06-May-2000 Dann      3.1 COMMDLG Print Setup dialog, need a cleanup routine
* 14-May-2000 Dann      Call GhCheck() on exit to report unfreed memory
* 20-May-2000 Dann      Move GhCheck() to correct location
* 20-May-2000 LeoN      Add DiscardDLLList
* 30-May-2000 Tomsn     win32 build: use MHinstance meta-api-field.
* 10-Jul-2000 t-AlexCh  use XR routines (InitXrs, DisposeXrs)
* 04-Aug-2000 LeoN      HELP31 #1253: Add fViewer flag
* 27-Aug-2000 LeoN      HELP31 #1245: Get and write out ONLY the main win size
* 27-Aug-2000 LeoN      HELP31 #1262: move fViewer to hvar.h
* 27-Aug-2000 LeoN      HELP31 #1268: move fDestroyDialogs call to window
*                       procs
* 27-Aug-2000 LeoN      Remove Miniframe support
* 06-Sep-2000 RussPJ    3.5 #298 - Fixed strange loading behavior.
* 07-Sep-2000 RussPJ    3.5 #352 - Added FCleanupForWindows().
* 08-Sep-2000 RussPJ    3.5 #363 - Added hpalSystemCopy init and cleanup.
* 07-Oct-2000 JahyenC   3.5 #525: Dispose (sdff.c) quick buffer when cleaning
*                       up.  Uses extension to sdff.c>>QvQuickBuffSDFF().
* 07-Oct-2000 JahyenC   3.5 #525,#526: Moved memory leak check to after
*                       FCleanupForWindows() call in hmain.c>>WinMain().
* 06-Nov-2000 BethF     Removed HINS parameter from InitFontLayer().
* 09-Jan-2000 LeoN      HELP31 #1358: give shadow windows a background brush
* 28-Feb-2000 RussPJ    3.5 #677 - Using help icon for history window.
*
*****************************************************************************/
#define publicsw
...
int   wCmdShow;
  ...
  /* to this string. Sigh. 31-Jan-2000 LeoN */
