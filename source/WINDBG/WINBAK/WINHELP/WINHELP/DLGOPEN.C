...
*                     the edit control.
* 29-Jan-2000 RussPJ  Unpackaged the dialog box, using FM layer.
* 08-Feb-2000 RussPJ  Fixed initialization of fmFound;
*  04/02/91  RobertBu Removed CBT support
* 20-Apr-2000 RussPJ    Removed some -W4s
* 30-May-2000 Tomsn   Win32 build: use MDlgDirSelect meta-api.
* 08-Sep-2000 RussPJ  3.5 #88 - Using commdlg file.open dialog box.
* 14-Nov-2000 RussPJ  3.1 #1335 - Using right extension for file name.
*
*****************************************************************************/
