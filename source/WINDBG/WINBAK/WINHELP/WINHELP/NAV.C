...
* 04-Jan-2000 RussPJ    Fixed some scrolling logic for printing.
* 04-Feb-2000 RobertBu  Added a comment to MouseInFrame()
* 04-Feb-2000 Maha      chnaged ints to INT
* 08-Feb-2000 RobertBu  Removed comments to MouseInFrame() (no longer valid).
* 15-Feb-2000 LeoN      Cleanup in prep for Code Review
* 14-Mar-2000 LeoN      Code Review Results.
* 01-Apr-2000 LeoN      Clear up an InvalidateRect issue
* 28-Aug-2000 RussPJ    Fixed 3.5 #83 - Don't scroll glossaries.
* 08-Apr-2000 LeoN      HELP35 #755: only scroll if scrollbars present.
