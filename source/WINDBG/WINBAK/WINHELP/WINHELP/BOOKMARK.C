...
*  BOOKMARK.C                                                                *
*                                                                            *
*  Copyright (C) Microsoft Corporation 2000, 1990, 2000.                     *
*  All Rights reserved.                                                      *
*                                                                            *
******************************************************************************
*                                                                            *
...
*  08-Feb-2000 JohnSc   bug 831: GetBkMkNext() now takes near pointer
*  16-Feb-2000 JohnSc   bug 898: change file size based on disk header size
*  05-Sep-2000 Maha     we append a '\0' at the end of the buffer we pass
*                      to read a bookmark as in the case of max bookmarkname
*                      it misses and the buffer is supoosed to be null 
*                      terminated.	
*  20-Jan-2000 LeoN    Help31 #1390: Correct if statement that would allow
*                      null filehandle to pass in certain cases.
* 02-Mar-2000 RussPJ   3.5 #616 - Truncating long bookmark titles.a
*
*****************************************************************************/
