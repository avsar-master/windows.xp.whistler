...
*   02-Jan-2000 RussPJ  Added fix for color of monochrome bitmaps.
*   14-Jan-2000 RussPJ  Fixed printing of large bitmaps.
*   18-Jan-2000 RussPJ  Checking return value of QbmhFromQbmi
*   21-Jan-2000 RussPJ  Not Deleting random DCs.
*   25-Jan-2000 RussPJ  Stole this from Larry
*   26-Jan-2000 RussPJ  Removed one Discardable allocation, which can
*                       be dangerous.  Note:  hbmh's must be explicitly
*                       made discardable after some time.
*   05-Feb-2000 LeoN    Change bitmap cache to be LRU. NOTE: I've placed
...
*   07-Feb-2000 LeoN    Move hbmCached from the BMA to the BMI
*   08-Feb-2000 RussPJ  Deleting partial cache entry on abortions
*   13-Feb-2000 LeoN    Ensure that deleting a cache entry zero's out the
*                       appropriate fields in the DE.
* 15-Mar-2000 RussPJ    Cleaned up for code review.
* 29-Mar-2000 DavidFe   added a bunch of #ifdefs to stub this file for the
*                       current Mac builds
* 22-Apr-2000 kevynct   Removed platform-specific code: it lives now in
*                       bmp{mac,win}.c
* 12-Jul-2000 RussPJ    Fixed silly SDFF bug in hot spot init of HmgFromHbma.
* 17-Jul-2000 Maha,Tom  MBHS.lbinding needs to be in disk format for
*                       btree lookup to work right.
*  5-Aug-2000 DavidFe   changed the cast in MakeOOMBitmap
* 27-Aug-2000 DavidFe   restructured the way we deal with the bgh so we can
*                       properly SDFF inline images on the Mac.
* 29-Aug-2000 RussPJ    Fixed 3.5 #108 - displaying >50 bitmaps.
* 07-Oct-2000 RussPJ    Implementing discardable metafile & hpict BMHs.
* 22-Oct-2000 RussPJ    Using HmfMakePurgeableHmf for metafiles.
* 23-Oct-2000 RussPJ    Removed some bogus pict code again.
* 28-Oct-2000 RussPJ    More work on efficient use of caching.
*
******************************************************************************
*                                                                            *
