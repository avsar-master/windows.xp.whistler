...
*  29-Jan-2000 LeoN     Changed some of the #ifdef PRINTOUTPUT code
*  08-Feb-2000 JohnSc   bug 858: removed LhAlloc(); added proper file comment
*  11-Feb-2000 LarryPo  bug 870: changed SzPartsFm to QLockGh(fm) in FidCreateFm
*  29-jul-2000 Tomsn    win32: add a stub for WinPrintf().
*
*****************************************************************************/
