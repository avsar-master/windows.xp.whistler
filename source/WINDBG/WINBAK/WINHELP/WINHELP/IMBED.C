...
* 04-Feb-2000 RobertBu  Fixed probelm with messages not getting sent in
*                       HiwDestroy()
* 15-Feb-2000 RussPJ    Fixed Bug #904 - added idVersion to EWDATA.
* 04-Mar-2000 RussPJ    Fixed 3.1 Bug #944 - limit on length of author data.
* 07-Mar-2000 RobertBu  Fixed Bug #922 - HDS getting trashed on reentrancy
* 22-Mar-2000 RussPJ    Using COLOR for colors.
* 20-Apr-2000 RussPJ    Removed some -W4s
* 06-Sep-2000 RussPJ    Fixed 3.5 #322 - Palette problems.
* 24-Sep-2000 JahyenC   Replaced direct SetHds() calls in HiwCreateTopic()
