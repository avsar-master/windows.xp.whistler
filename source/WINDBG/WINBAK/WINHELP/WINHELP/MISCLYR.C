...
* 10-May-2000 RussPJ    Took ownership.
* 13-May-2000 RussPJ    Cleaned up for Code Review
* 14-May-2000 RussPJ    Fixed 3.1 bug #976 - SmallSysFont.
* 17-May-2000 RussPJ    More cleanup for code review.
* 08-Jul-2000 LeoN      HELP31 #1201: handle NULL hwnd in ErrorHwnd
* 05-Sep-2000 RussPJ    3.5 #105 - searching along path, etc for HelpExec()
* 06-Sep-2000 RussPJ    3.5 #309 - Using 'i' for message box icon.
* 06-Sep-2000 RussPJ    3.5 #315 - Made error messages longer.
* 22-Feb-2000 LeoN      HELP35 #744: Add GetWindowsVersion for easier compares
* 22-Feb-2000 LeoN      HELP31 #1401: add wERRA_LINGER for a slow death
*
*****************************************************************************/
