...
*
*  Revision History:
* 04-Feb-2000 RobertBu  Created (from NAVSUP)
* 05-Feb-2000 LeoN      HBMI becomes HTBMI
* 07-Feb-2000 LeoN      Cleanup in prep for Code Review
* 15-Feb-2000 LeoN      Results of code review
* 20-Feb-2000 LeoN      More results of code review
* 20-May-2000 LeoN      GhDupGh takes an additional param
* 21-May-2000 LeoN      HdeCreate takes "ownership" of passed Fm.
* 22-May-2000 LeoN      use VUpdateDefaultColorsHde
* 05-Jun-2000 LeoN      HELP31 #1164: check for FmCopyFm failure.
* 22-Jul-2000 LeoN      HELP31 #1232: disable fts hits in 2nd windows & gloss
* 27-Aug-2000 LeoN      HELP31 #1244: remove fHiliteMatches from DE. It's a
*                       global state.
* 16-Sep-2000 JahyenC   Help3.5 #5: HdeCreate: initialise lock count field
*                       Help3.5 #5: DestroyHde: zero lock count check
* 17-Oct-2000 RussPJ    3.1 #1296 - duping, not copying hEntryMacro
* 22-Nov-2000 DavidFe   Patched a leaky FM in HdeCreate - we had been copying
