...
*
*  Revision History:
* 01-Feb-2000 LeoN      Added this header. Added MoveDS code for real mode
*                       testing.
* 02-Feb-2000 RussPJ    Added LhFromP()
* 05-Feb-2000 LeoN      Added debug layer for PAllocFixed & family
*
*****************************************************************************/
