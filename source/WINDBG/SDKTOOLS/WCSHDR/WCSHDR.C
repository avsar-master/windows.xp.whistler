 ...
 *
 * History:
 *   04-Mar-2000 IanJa Wrote it.
 *   19-Mar-2000 IanJa Not all fgets() implementations append '\0' upon EOF.
 *   29-Mar-2000 IanJa Workaround NT fgets bug ("\r\n" not collapsed to "\n"),
 *                     & Command line, Usage and Version numbers added.
 *   13-May-2000 IanJa All neutrality achieved by #define - no neutral structs
 *   14-May-2000 IanJa Minor improvements to version display, help
 *   21-May-2000 IanJa Realloc() pbs->pStart when required
 *   27-May-2000 GregoryW bug fix, add LPTSTRID, LPTSTRNULL
 *   13-Jun-2000 IanJa Convert #define's too. Eg: #define Fn%(a) FnEx%(0, a)
 *   19-Jun-2000 IanJa improve #define treatment & simplify main loop
 *   12-Aug-2000 IanJa fix multi-line #defines, NEAR & FAR typedefs
 *   12-Aug-2000 IanJa fix braceless typedefs with %s; add LPTSTR2
 *   13-Aug-2000 IanJa add braceless typedefs #defines
 *   21-Aug-2000 IanJa fix string% substitutions for #defines
 *   21-Aug-2000 IanJa add BCHAR% -> BYTE or WCHAR as per BodinD request
 *   26-Aug-2000 IanJa init pbs->iType (NT-mode bug fix)
 *   26-Aug-2000 IanJa workaround NT fgets bug (CR LF not collapsed to NL)
 *   17-Nov-2000 v-griffk map #defines to typedef's on structs
