 ...
 *
 * History:
 * 05-Jan-2000 IanJa obtained from \\toolsvr\contrib\petes\slm\src\TOOLS
 * 05-Jan-2000 IanJa use buffered reads for small efficiency gain
 * 22-Feb-2000 IanJa Unicode strings too if -U used.
 */
