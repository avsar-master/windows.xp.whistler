...
*
*	Copyright (c) 2000-1990, Microsoft Corporation.  All rights reserved.
*
* Purpose:
...
*  04-Dec-2000 SB Removed to unreferenced variables in makeInlineFiles()
*  01-Dec-2000 SB Changed realloc() to REALLOC()
*  22-Nov-2000 SB Changed free() to FREE()
*  07-Nov-2000 SB Length of action word not evaluated correct for multiple
*		  inline files for the same command
*  06-Nov-2000 SB allow macros in action word for inline files
*  24-Sep-2000 SB added processInline(), createInline()
*  20-Sep-2000 SB Created from routines previously scattered in the sources.
*
* Notes:
