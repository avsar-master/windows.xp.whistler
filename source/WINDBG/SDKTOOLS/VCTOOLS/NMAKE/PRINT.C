...
*  16-May-2000 SB Move printDate() here from build.c
*  02-Feb-1990 SB change fopen() to FILEOPEN()
*  22-Nov-2000 SB Changed free() to FREE()
*  07-Nov-2000 SB When TMP ended in '\\' then don't add '\\' at end of path
*		  specification for PWB.SHL
*  19-Oct-2000 SB added searchHandle parameter
*  18-Aug-2000 SB added fclose() error check
*  05-Jul-2000 SB Cleaned up -p output to look neater
*  19-Jun-2000 SB Localized messages with -p option
*  24-Apr-2000 SB added 1.2 filename support, FILEINFO replaced by void *
*  05-Apr-2000 SB made all funcs NEAR; Reqd to make all function calls NEAR
*  10-Mar-2000 SB printReverse() now prints to TMP:PWB.SHL instead of stdout
