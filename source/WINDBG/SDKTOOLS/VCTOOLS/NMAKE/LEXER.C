...
*		  _makepath() functions.
*  04-Aug-2000 SS CAVIAR 2266: expand INCLUDE macro in processIncludeFile()
*  08-Jun-2000 SS Port to DOSX32
*  02-Feb-1990 SB change fopen() to FILEOPEN()
*  01-Dec-2000 SB Changed realloc() to REALLOC()
*  22-Nov-2000 SB Changed free() to FREE()
*  19-Oct-2000 SB searchHandle passed around as extra param
*  08-Oct-2000 SB handle OS/2 1.2 quoted filenames
*  04-Sep-2000 SB temporary filename generated has a trailing '.' for LINK.EXE
*  24-Aug-2000 SB Allow $* and $@ in dependency lines
*  18-Aug-2000 SB Added fclose() return code check
*  31-Jul-2000 SB Added lookahead to the lexer for \ on dependency lines
*  06-Jul-2000 SB Remove escaping abilities of '^' in command lines totally
*  29-Jun-2000 SB Add duplicateInline() to detect duplicate inline filenames
*		  and issue error if duplicates are found
*  26-Jun-2000 SB Modify ParseScriptFileList() and add nextInlineFile() to
*		  handle complex syntax of Inline file command line.
*  15-Jun-2000 SB issue error for usage of inline file in an inference rule
*  18-May-2000 SB Added getPath(), changed processIncludeFile() to have C like
*		  processing of include files
*  16-May-2000 SB expand macros in include file names; handle '\' processing
*		  in same way for macros and dependency lines
*  15-May-2000 SB Changed nameStates to 16x14
*  13-May-2000 SB don't remove ESCH on reading cmd block
*  24-Apr-2000 SB made FILEINFO as void * and corrected regression in parsing
*		  inline file names
*  14-Apr-2000 SB inline file names are correctly expanded now
*  06-Apr-2000 SB ren removeFirstLtLt() as delInlineSymbol().
*  05-Apr-2000 SB made all funcs NEAR; Reqd to make all function calls NEAR
*  22-Mar-2000 SB removed unlinkTmpFiles() function; not needed
*  19-Jan-2000 SB added function removeFirstLtLt() to remove '<<' appearing
*		  in -n output
 ...
 *  Modifications:
 *
 *	06-Jul-2000 SB remove escaping in command lines
