...
*  10-Aug-2000 GBS Change file parsing in execLine to use splitpath
*  19-Aug-2000 SS  Remove Quotes from cd argument.
*  08-Jun-2000 SS  add IDE feedback support
*  08-Jun-2000 SS  Port to DOSX32
*  16-May-2000 SB  Created from routines that existed elsewhere
*
* Notes:
*
* Notes:
