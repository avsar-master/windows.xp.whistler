...
*  26-Mar-2000 HV Rewrite filename() to use _splitpath()
*  06-Oct-2000 GBS Removed extern for _pgmptr
*  08-Jun-2000 SS add IDE feedback support
*  08-Jun-2000 SS Port to DOSX32
...
*  29-Dec-2000 SB ignore /Z when /T also specified
*  29-Dec-2000 SB nmake -? was giving error with TMP directory nonexistent
*  19-Dec-2000 SB nmake /z requests
*  14-Dec-2000 SB Trunc MAKEFLAGS averts GPF;Silently ignore /z in protect mode
*  12-Dec-2000 SB =c, =d for NMAKE /Z
*  08-Dec-2000 SB /NZ causes /N to override /Z; add #define TEST_RUNTIME stuff
*  01-Dec-2000 SB Contains an hack #ifdef'ed for Overlayed version
*  22-Nov-2000 SB Changed free() to FREE()
*  17-Nov-2000 SB defined INCL_NOPM; generate del commands to del temps
*  19-Oct-2000 SB ifdef SLASHK'ed stuff for -k
*  04-Sep-2000 SB echoing and redirection problem for -z fixed
*  17-Aug-2000 SB added #ifdef DEBUG's and error -nz incompatible
*  31-Jul-2000 SB Added check of return value -1 (error in spawning) for -help
*		  remove -z option help message
*  12-Jul-2000 SB readEnvironmentVars() was not using environ variable but an
*		  old pointer (envPtr) to it. In the meantime environ was
*		  getting updated. Safer to use environ directly.
*  29-Jun-2000 SB freeStructures() now deletes inlineFileList also
*  28-Jun-2000 SB changed deletion of inline files to end of mainmain() instead of
*		  doMake() to avoid deletion when a child make quits.
*  19-Jun-2000 SB modified .bas.obj to have ';' at end of cmd line
*  21-May-2000 SB freeRules() gets another parameter to avoid bogus messages
*  18-May-2000 SB change delScriptFiles() to do unlink instead of calling
*		  execLine. Thus, ^C handling is better now. No more hangs
*  15-May-2000 SB Added /make support; inherit /nologo
*  13-May-2000 SB Changed delScriptFiles(); added MAKEDIR; Added BASIC rules
*		  Changed chkPrecious()
*  01-May-2000 SB Changed FILEINFO to void *; OS/2 Version 1.2 support
*  17-Apr-2000 SB on -help spawn 'qh /u nmake' instead. rc = 3 signals error
*  14-Apr-2000 SB no 'del inlinefile' cmd for -n. -z now gives 'goto NmakeExit'
*		  CC and AS allocated of the heap and not from Data Segment
*  05-Apr-2000 SB made all funcs NEAR; Reqd to make all function calls NEAR
*  27-Mar-2000 SB Changed unlinkTmpFiles() to delScriptFiles()
*  10-Mar-2000 SB Removed blank link from PWB.SHL output
*  09-Mar-2000 SB changed param in call to findRule. fBuf is allocated on the
*		  heap in useDefaultMakefile()
*  24-Feb-2000 SB Inherit MAKEFLAGS to Env for XMake Compatibility
*  22-Feb-2000 SB Ignore '-' or '/' in parseCommandLine()
*  16-Feb-2000 SB add delScriptFiles() to delete temp script files at the
*		  end of the make. Also called on ^c and ^break
*  15-Feb-2000 SB Rewrote useDefaultMakefile(); MAKEFLAGS can contain all flags
*		  now
*  13-Feb-2000 SB Rewrote filename() for OS/2 1.2 support, now returns BOOL.
*   3-Feb-2000 SB Renamed freeUnusedRules() to freeRules(); moved prototype to
*		  proto.h
*   9-Jan-2000 SB Improved /help;added -?
*   3-Jan-2000 SB Changes for /help and /nologo
