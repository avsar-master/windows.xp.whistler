...
Author:
    ...
    Mike O'Leary (mikeol) 16-Mar-2000

Revision History:

    30-Sep-2000 AzeemK  changes due to the new sections, groups, modules model
    23-Sep-2000 BrentM  changed tell() to FileTell()
    19-Aug-2000 BrentM  removed BUFFER_SECTION conditionals
    07-Jul-2000 BrentM  new global symbol table, removed recursive binary
