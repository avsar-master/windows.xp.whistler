...
Author:
    ...
    Brent Mills (BrentM) 29-Jun-2000

Revision History:

    03-Sept-2000 BrentM ifdefed debug code, added diagnostic code with DBEXEC,
...
Routine Description:
    ...
    return a pointer to a Cexternal(pst) element table sorted by Macixposh
