...
Author:
    ...
    Brent Mills (BrentM) 17-Aug-2000
    Azeem Khan  (AzeemK) 09-Jun-2000

Revision History:

    21-Oct-2000 BrentM  added a while on GrowMapTable calls, fixed a bug
                        for JimSa in FileChSize()
    20-Oct-2000 BrentM  added FileChSize() to the fileio api
    11-Oct-2000 BrentM  writes of 0 bytes don't do anything, files opened
                        with read, write and !create are now handled
    05-Oct-2000 BrentM  added STATIC #define for profiling
    05-Oct-2000 BrentM  don't round off in GrowMapTable(), now links c++ p1
    05-Oct-2000 BrentM  marked buffers BUF_Dirty on writes spanning >1 buffers
    02-Oct-2000 BrentM  BufferedSeek() adds the offset on SEEK_END
    01-Oct-2000 BrentM  mapped i/o option for reads if on NT
    30-Sep-2000 BrentM  encapsalated BUF_Random setting in if !FI_Write
    28-Sep-2000 BrentM  better summary on DB_BUFVERBOSE
    27-Sep-2000 BrentM  dump logical file descriptor for i/o logging
    25-Sep-2000 BrentM  made the current buffer of cached file handles
                        available for reallocation
    23-Sep-2000 BrentM  added read buffering and logical file handle caching
    10-Sep-2000 BrentM  added [f]open/[f]close logging
    09-Sep-2000 BrentM  added read logging and added separate db switches
    04-Sep-2000 BrentM  removed pragmas to turn off compiler optimizations
    03-Sep-2000 BrentM  put diagnostics under ifdefs and DBEXECs
    20-Aug-2000 BrentM  fixed bogus assert
    19-Aug-2000 BrentM  increased max .exe size to 7000000, links XL nondebug
    03-Aug-2000 BrentM  file mapped buffering
    29-Jul-2000 BrentM  split from shared.c
