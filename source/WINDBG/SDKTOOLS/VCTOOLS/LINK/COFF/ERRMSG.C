...
Revision History:
    ...
    15-Oct-2000 AzeemK  Added new warning for obsolete switches.
    10-Sep-2000 AzeemK  Added new error for bug fix 1060.
    09-Sep-2000 AzeemK  Changed all writes to stdout. Fix 604.
    29-Jul-2000 GeoffS  Added BADSTUBFILE error
