...
Revision History:
    ...
    21-Oct-2000 AzeemK  Detect resource files correctly, removing name
                        restrictions.
    15-Oct-2000 JonM    Zero-terminate list of .def's in COFF symtab.
    15-Oct-2000 AzeemK  Give warning if -strict switch is encountered.
    15-Oct-2000 AzeemK  removed -strict switch from usage message.
    12-Oct-2000 AzeemK  removed -strict switch.
    09-Oct-2000 AzeemK  fixed the -order bug (cuda:1275)
    09-Oct-2000 BrentM  -db20 works in release builds now
    08-Oct-2000 BrentM  -order:undeffile -db24 dumps comdats to undeffile
    08-Oct-2000 JonM    -base:@filename now searches lib path -stub:filename
                        now looks in current dir, then linker dir
    07-Oct-2000 JonM    fixed default -out value (cuda:1068)
    02-Oct-2000 AzeemK  Added new sections model and sorting of archive list.
    01-Oct-2000 BrentM  added mapped i/o support
    28-Sep-2000 BrentM  removed -bufsncs, put -stub in alphabetical order
    27-Sep-2000 BrentM  added section mapping to read logging
    23-Sep-2000 BrentM  added read buffering and logical file descriptor caching
    09-Sep-2000 BrentM  added read logging
    09-Sep-2000 AzeemK  cuda bug 1043 fix. Checks return value from cvpack.
    04-Sep-2000 BrentM & AzeemK fixed comdat problem, cuda bug #1027
    03-Sep-2000 BrentM  added debug diagnostics with DBEXEC
    02-Sep-2000 AzeemK  Fix to get correct reloc count.
    19-Aug-2000 BrentM  removed BUFFER_SECTION conditionals
    19-Aug-2000 GeoffS  Updated all symbol table and line number indexes
    17-Aug-2000 AzeemK  For default/nodefault libs a default .lib extension is
                        added and searched along LIB paths as needed.
    12-Aug-2000 AzeemK  Added -fast switch
    11-Aug-2000 GeoffS  Fixed additional debug format bugs
    06-Aug-2000 AzeemK  Added new lib search algorithm
    05-Aug-2000 GeoffS  Changed to new debug format
    04-Aug-2000 BrentM  i/o logging, /stat, /logio
    03-Aug-2000 AzeemK  Added default lib support
    28-Jul-2000 GeoffS  Added -stub command
    27-Jul-2000 Brentm  removed DumpSymbolTableStatistics, added new global
    ...
    23-Jul-2000 GeoffS  Removed localSection[].Offset addition to External
                        symbol FinalValue in Pass2 calculation.
    21-Jul-2000 GeoffS  Changed IncludeComDat to compare Lib name
    26-Jun-2000 GlennN  negated defined for _NO_CV_LINENUMBERS
    25-Jun-2000 GeoffS  Added _NO_CV_LINENUMBERS
    17-Jun-2000 GeoffS  Added DumpSymbolTableStatistics for _DEBUG build
    15-Jun-2000 AzeemK  Added GlennN's IDE feedback mechanism
    09-Jun-2000 AzeemK  Added buffering support
    28-May-2000 GeoffS  Added param to call ConvertResFile
