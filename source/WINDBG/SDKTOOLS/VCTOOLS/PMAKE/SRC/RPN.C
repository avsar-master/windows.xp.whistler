...
*
* Revision History:
*  04-Dec-2000 SB Add prototype for match() and chkInvokeAndPush()
*  09-Oct-2000 SB Added HACK to handle pointer arithmetic quirks; Done to
*		  avoid rewriting entire module
*  08-Oct-2000 SB '!if' expressions can be decimal, octal or hex now
