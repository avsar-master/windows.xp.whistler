...
#define KTRAP_FRAME_ARGUMENTS (4 * 16)        // defined in xpos\mips.h (404)
...
void SetSymbolSearchPath (void)
{
    ...
    cbSymPath = 18;
    if (GetEnvironmentVariable("_XP_SYMBOL_PATH", SymPath, sizeof(SymPath)))
    {
...
//              Modified directly from NT Source -- xpos\rtl\symbol.c
//  Synopsis:
//
//  Arguments:
//
...
//
// Modified version of xpos\rtl\symbol.c
//
