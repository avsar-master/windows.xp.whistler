...
#include "stdarg.h"
#include "stdio.h"
#include "\xp\neptune\xpos\inc\xpos.h"      // *** USES INTERNAL DEFINES ***
#include "ntexapi.h"
#include "..\..\pstat.h"
#include "p5stat.h"
...
P5StatHookTimer (VOID)
{
    ...
    HalThunkForKeUpdateSystemTime =
        ImportThunkAddress ("hal.dll", 0, "xposkrnl.exe", "KeUpdateSystemTime");

    HalThunkForKeUpdateRunTime =
        ImportThunkAddress ("hal.dll", 0, "xposkrnl.exe", "KeUpdateRunTime");
