    ...
    *pcfiles = 0;
    ...
    for (pcp = pcpPaths; pcp != NULL; pcp = pcp->pcpNext) {
        ...
        for (pcm = pcp->pcmPat; pcm != NULL; pcm = pcm->pcmNext) {
            ...
            // Complete FindPattern: "c:\xp\system32\*.exe"
            ...
            if (hFind == -1) {
                ...
                do {
                    ...
                    // append file name to FindPattern: "c:\xp\driver\foo.sys"
...
RecursiveCheckHeader()
{
    ...
    for (pcp = pcpPaths; pcp != NULL; pcp = pcp->pcpNext) {
        ...
        // Build Initial FindPattern directory path: "c:\xp\"
        ...
        // point past directory in FindPattern: "c:\xp\system32\"
