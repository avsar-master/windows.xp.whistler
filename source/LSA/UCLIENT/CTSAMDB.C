...
Abstract:
    ...
    1.  Build lsasrv.dll with LSA_SAM_ACCOUNTS_DOMAIN_TEST flag
        enabled in file \xp\neptune\lsa\server\dbp.h

    2.  On your test system, replace lsasrv.dll in \xp\system32 and reboot.
...
Author:
    ...
    Scott Birrell       (ScottBi)    October 19, 2000
...

{
    ...
    if (argc != 2) {
        ...
        printf("\n");
        printf("NOTE: \\\\popcorn\\neptune\\scottbi\\runsamdb temporarily\n");
