/******************************************************************************
   ...
   Copyright (C) Microsoft Corporation 1985-2000. All rights reserved.
   ...
   History:
       ...
       21 Feb 2000 - Robin Speed (RobinSp) converted to Windows NT
   ...
   Design :
    ...
    ChangeLog:
           ...
           12 May 2000 - SteveDav   Build 265 Cleanup on DLL unload
