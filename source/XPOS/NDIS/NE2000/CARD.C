...

{
    ...
    // described in the March 2000 8390 addendum), since that
...

{
    ...
    //
    {
        ...
        if (!Adapter->EightBitSlot && ((ULONG)XmitBufAddress & 0x1)) {
            ...
            // 1-144 of the 2000 LAN databook
            //
...

{
    ...
    if (!Adapter->EightBitSlot && ((ULONG)TargetBuffer & 0x1)) {
        ...
        //
        // Do Write errata as described on pages 1-143 and 1-144 of the 2000
        // LAN databook
        //
