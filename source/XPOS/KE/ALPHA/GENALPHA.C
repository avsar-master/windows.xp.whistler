...
Author:
    ...
    Joe Notarangelo 26-Mar-2000

Revision History:

    Thomas Van Baak (tvb) 10-Jul-2000
    ...
    char *argv[];
{
    ...
    outName = (argc >= 2) ? argv[1] : "\\xp\\neptune\\sdk\\inc\\ksalpha.h";
    ...
    outName = (argc >= 3) ? argv[2] : "\\xp\\neptune\\xpos\\inc\\halalpha.h";
