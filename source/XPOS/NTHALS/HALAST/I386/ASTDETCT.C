...
Copyright (c) 2000  AST Research Inc.
...
Revision History:
    ...
    Bob Beard (v-bobb) 19-Aug-2000  detect if MP
    Quang Phan (v-quangp) 27-Aug-2000  modified to work with the NT Setup
    program.
