...
Author:
    ...
    Current Author
        Bob Rinne  (bobri)   10-Jul-2000
    Initial Author
        Mike Glass (mglass)  1-Aug-2000
...
Revision History:
    ...
    10-Jul-2000 bobri - Added page buffer to account for changes in memory
                        management.
     2-Sep-2000 bobri - Added verify support.
