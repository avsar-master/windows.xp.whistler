...
Author:
    ...
    Nigel Thompson (nigelt) 7-March-2000
...
Revision History:
    ...
    Robin Speed (RobinSp) 29-Jan-2000
    - Added new devices, cleanup and support for Soundblaster 1

    Sameer Dekate (sameer@mips.com) 19-Aug-2000
...
Routine Description:
    ...
    A predeclaration for this exists in \xp\neptune\xpos\dd\init\ddpi386.h
