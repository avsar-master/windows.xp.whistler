...
Author:
    ...
    David N. Cutler (davec) 10-May-2000
...

CHAR KernelFileName[8+1+3+1]="xposkrnl.exe";
...

{
    ...
    //
    // Generate the full pathname of xposkrnl.exe
    //      "\winnt\system32\xposkrnl.exe"
    //
    ...
    Status = BlAllocateDataTableEntry("xposkrnl.exe",
                                      KernelDirectoryPath,
                                      SystemBase,
