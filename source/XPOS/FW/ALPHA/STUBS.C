...
//
// This is defined in xpos\rtl\imagedir.c.  This is linked in unnecessarily
...
Routine Description:
    ...
    This is a copy of the same function in \xp\neptune\xpos\rtl\string.c.
