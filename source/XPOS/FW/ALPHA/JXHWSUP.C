...
Abstract:
    ...
    \xp\neptune\xpos\hal\alpha\jxhwsup.c.


Author:

    Jeff Havens (jhavens) 14-Feb-1990
    Miche Baker-Harvey (miche) 22-May-2000
    Jeff McLeman (mcleman) 27-May-2000
...
Revision History:
    ...
    3-August-2000	John DeRosa

    Made this from \xp\neptune\xpos\hal\alpha\jxhwsup.c and
    \xp\neptune\xpos\fw\mips\jxhwsup.c.
