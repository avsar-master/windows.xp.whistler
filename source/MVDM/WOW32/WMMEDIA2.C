...
*
*  History:
*  Created 21-Jan-2000 by Mike Tricker (MikeTri), after jeffpar
*  Changed 15-Jul-2000 by Mike Tricker (MikeTri), fixing GetDevCaps calls
*          26-Jul-2000 by Stephen Estrop (StephenE) thunks for mciSendCommand
*          30-Jul-2000 by Mike Tricker (MikeTri), fixing Wave/Midi/MMIO
*          03-Aug-2000 by Mike Tricker (MikeTri), added proper error handling
*          08-Oct-2000 by StephenE spawned from the original wmmedia.c
*
\***********************************************************************/
...
*
* As of November 2000 we map the 16 bit Wave Format data directly to the
