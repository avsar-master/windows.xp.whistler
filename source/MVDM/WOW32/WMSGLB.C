...
VOID FASTCALL UnThunkLBMsg16(LPMSGPARAMEX lpmpex)
{
    ...
    case LB_ADDSTRING:      // BUGBUG 3-Jul-2000 JeffPar: for owner-draw list boxes, this can just be a 32-bit number
    case LB_DIR:
    case LB_FINDSTRING:     // BUGBUG 3-Jul-2000 JeffPar: for owner-draw list boxes, this can just be a 32-bit number
    case LB_FINDSTRINGEXACT:
    case LB_GETTEXT:
    case LB_INSERTSTRING:
    case LB_SELECTSTRING:
