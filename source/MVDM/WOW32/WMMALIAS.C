 ...
 *
 *  History:
 *  Created Sept-1-2000 by Chandan Chauhan (ChandanC)
 *  Modified 12-May-2000 by Mike Tricker (miketri) to add MultiMedia support
--*/
...
HINFO   hiMMedia;       // MultiMedia handle alias info - MikeTri 12-May-2000
HINFO   hiWinsock;      // Winsock handle alias info - DavidTr 4-Oct-2000
...
/*
 * Added MultiMedia functions - MikeTri 12-May-2000
 */
