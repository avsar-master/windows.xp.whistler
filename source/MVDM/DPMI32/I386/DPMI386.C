...
Author:
    ...
    Dave Hastings (daveh) 27-Jun-2000

Revision History:

    Matt Felton (mattfe) Dec 6 2000 removed unwanted verification
    Dave Hastings (daveh) 24-Nov-2000  Moved to mvdm\dpmi32
    Matt Felton (mattfe) 8 Feb 2000 optimize getvdmpointer for regular protect mode path.
