...
the elements with 32 bytes.                            17 July 2000  ClarkC
*/
 ...
 *           the list.
 *           02-Jun-2000          Clark R. Cyr  [clarkc]
 *           Network aliasing now included.
 *           04-Jun-2000          Clark R. Cyr  [clarkc]
 *--------------------------------------------------------------------------*/
short
 ...
 *           15-Nov-2000          Clark R. Cyr  [clarkc]
 *--------------------------------------------------------------------------*/
...
/* checking, loading is done elsewhere.             3 May 2000   clarkc  */
  if (!bEnable)
    {
 ...
 * HPDRVNUM and beyond should work correctly.  7 Oct 2000  Clark Cyr
 */
 ...
 * problem driver is found in testing.    29 Aug 2000    Clark Cyr
 *--------------------------------------------------------------------------*/
BOOL
...
/* PvGetInst and lpfnHook, and call a bogus value.     18 Jan 2000 clarkc */
  if (lpPD->Flags & PD_ENABLESETUPHOOK)
    {
      if (!lpPD->lpfnSetupHook)
        {
 ...
 * unless we have a 3.10 driver.   26 June 2000      Clark Cyr
 */
...
/* MUST have DIRECTLY asked for Setup Dialog.  If this is coming from
   ...
   hDC or hIC, as it will be overwritten later.  4 May 2000  clarkc  */
 ...
 * driver.  Return FALSE to the calling routine.  20-Feb-2000  clarkc
 */
                          wReturn = FALSE;
                          goto CancelExit;
                        }
...
CancelExit:
     ...
     * was internally created, free the allocated memory.  14 Jun 2000  clarkc
     */
 ...
 * take effect.          22 July 2000     clarkc
 */
