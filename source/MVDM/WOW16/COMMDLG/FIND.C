...

{
	 ...
	 * load it
	 * Use ordinal, not string   27 March 2000    clarkc
	 */
 ...
 * itself or the dialog will NOT be displayed.   26 Mar 2000   clarkc
 */
            if (wRet)
              {
 ...
 */
		...
		case psh2:     /* Replace all text */
			...
			/* IDCANCEL instead of psh1.   17 Jan 2000  clarkc           */
...
LPFINDREPLACE lpfr)
{
    ...
    /*   no difference.    28 February 2000   clarkc                    */
 ...
 * for folks who use them.   7 February 2000  clarkc
 */
 ...
 * will be set.    29 March 2000   clarkc
 */
