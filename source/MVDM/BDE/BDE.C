...
Author:
    ...
    Bob Day      (bobday) 29-Feb-2000 Grabbed standard header
...
SEGENTRY segtable[MAXSEGENTRY] = {
    SEGTYPE_PROT, "c:\\xp\\bin86\\KRNL286.EXE", 0x02FF, 1, 0L,
    SEGTYPE_PROT, "c:\\xp\\bin86\\KRNL286",     0x0307, 2, 0L,
    SEGTYPE_PROT, "c:\\xp\\bin86\\KRNL286",     0x030F, 3, 0L,
    SEGTYPE_PROT, "c:\\xp\\bin86\\GDI.EXE",     0x04BF, 1, 0L,
    SEGTYPE_PROT, "c:\\xp\\bin86\\USER.EXE",    0x0477, 1, 0L
};
