...
Author:
    ...
    David Treadwell (davidtr)    07-Jan-2000
...
Revision History:
    ...
    24-Nov-2000 W-ShankN
        Added Unicode support for several cases.

    05-Dec-2000 W-ShankN
