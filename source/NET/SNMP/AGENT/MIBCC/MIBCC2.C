...
//
//  $Revision:   1.5  $
//  $Date:   06 Aug 2000 22:39:34  $
//  $Author:   unknown  $
//
//  $Log:   N:/agent/mgmtapi/vcs/mibcc2.c_v  $
//
//     Rev 1.5   06 Aug 2000 22:39:34   unknown
   ...
   char *	   argv[];
{
   ...
   if (!fNoLogo) {
      ...
      printf ("Copyright (c) Microsoft Corporation 2000.  All rights reserved.\n");
   }
