...
/*      if (handleerror) { erik chen 3-16-2000 */
// DJC         if (handleerror && !chint_flag) {
        ...
        if( (VALUE_OP(-1) && VALUE(run_batch)) &&
            ...
            interpreter(l_tmpobj) ;
            if (!abort_flag) { /* erik chen 5-8-2000 */
                op_flush() ;
                PUSH_ORIGLEVEL_OBJ(&object) ;
                op_flushfile() ;
            }
...
/*      op_nulldevice() ; */
 ...
 /*     fs_info.attr = F_READ ;
        ...
        ATTRIBUTE_SET(l_stdin, EXECUTABLE) ; erik chen 4-15-2000 */
        l_file = GEIio_stdin ;
...
/*      fs_info.attr = F_WRITE ;
        ...
        open_file(l_stdout) ;
        ATTRIBUTE_SET(l_stdout, LITERAL) ; erik chen 4-15-2000 */
        l_file = GEIio_stdout ;
        ...
        abort_flag = 0 ;      /* erik chen 5-8-2000 */
...
/*          GEIio_setsavelevel((GEIFILE FAR *)VALUE(l_stdin), 0) ;
            ...
            GEIio_close((GEIFILE FAR *)VALUE(l_stdout)) ; erik chen 4-15-2000 */
