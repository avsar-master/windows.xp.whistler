 ...
 *      02-03-2000      update for image enchancement.
 *                      @IMAGE-1, @IMAGE-2
 *      06-07-2000      ImageClear() moved to fillgp.c
 *      07-29-2000      cg - Unix port changes to include files
 ...
 *      01/09/91        update GEIeng_printpage() return value check
 #ifdef WIN
 *  Ada 02-15-2000      change fill_tpzd(), fill_scan_page() to handle op_pfill
 #endif
