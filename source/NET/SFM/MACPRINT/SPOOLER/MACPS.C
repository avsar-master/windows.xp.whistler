...
//		adapted from MacPrint for LAN Manager Services for Macixposh
...
/*
	...
	Each service thread:
		...
		AppleTalk network to allow Macixposh clients to
		see the print queue from the Chooser.

		It posts an ATalkPAPGetNextJob request to service
		a print request.  This allows Macixposh clients to
