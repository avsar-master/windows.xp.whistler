...
Abstract:
	...
	This module contains conversion routines from macixposh ansi to unicode
	and vice versa
...
/***	AfpMacAnsiInit
 *
 *	Initialize the code page for macixposh ANSI.
 */
NTSTATUS
AfpMacAnsiInit(
	VOID
...
/***	AfpMacAnsiDeInit
 *
 *	De-initialize the code page for macixposh ANSI.
 */
VOID
AfpMacAnsiDeInit(
	VOID
...
/*** AfpGetMacCodePage
 *
 *	Open the default macixposh codepage, create a section backed by that file,
