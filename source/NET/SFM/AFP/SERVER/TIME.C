 ...
 *
 *	This gets the current system time in macixposh format which is number of
 ...
 *	the macixposh time i.e. # of seconds since 2000 A.D. The system time
 ...
 *
 *	Convert time in the  macixposh time i.e. # of seconds since 2000 A.D. to
