...
{
	{{2000, 3, 30, 3, 30, 0, 6}, msOutboxComposing, "me", "MS:bullet/dev/ericca", "you", "MS:bullet/dev/danab", "a dog named blue", "travellin' and an livin' off the land"},
	{{2000, 11, 19, 12, 23, 0, 2}, msReceivedUnread, "BillG", "MS:bullet/dev/billg", "Brian Valentine", "MS:bullet/dev/brianv", "David Shulman not using Bullet?", "I hear a Bullet developer, David Shulman, is not using Bullet.  This is not setting a very 
good example, and is not a team-oriented attitude.  If this is true, fire him immediately."},
	...
	{{2000, 4, 5, 13, 52, 1, 5}, msReceivedUnread, "Peter Durham", "MS:bullet/dev/peterdur", "Dave Whitney", "MS:bullet/dev/davewh", "TMNT", "Did you watch them last saturday?"},
	...
	{{2000, 6, 12, 9, 13, 17, 3}, msReceivedRead, "Life", "MS:bullet/dev/ricg", "The Universe", "MS:bullet/dev/billg", "Everything", "42"},
	{{2000, 5, 17, 11, 23, 49, 5}, msReceivedModified, "Ben Kenobi", "MS:bullet/dev/nickh", "Anakin", "MS:bullet/dev/johnkal", "Your training", "You are proceeding very well Mr. Skywalker."},
	...
	{{2000, 7, 9, 15, 4, 51, 2}, msReceivedUnread, "Yahweh", "MS:bullet/dev/davidfu", "Lucifer", "MS:bullet/dev/jeffw", "goodbye", "go to h-e-double hockey sticks"},
	{{2000, 7, 9, 15, 26, 33, 2}, msOutboxReady, "Lucifer", "MS:bullet/dev/jeffw", "Yahweh", "MS:bullet/dev/davidfu", "Re: goodbye", "I'll get you yet.."},
	{{2000, 6, 14, 7, 15, 28, 5}, msReceivedRead, "Rudolph", "MS:bullet/dev/davidsh", "St. Nick", "MS:bullet/dev/nickh", "Contract dispute", "Triple my salary or I'm leaving!"},
	{{2000, 1, 31, 13, 3, 19, 4}, msReceivedModified,	"Music", "MS:bullet/dev/briande", "Sex", "MS:bullet/dev/kelleyt", "Cookies", "...make my world go round"}
};

_hidden static CSRG(MSGINIT) msginitForFill = {{2000, 4, 1, 10, 30, 0, 6}, msOutboxComposing, "Brian Valentine", "MS:WGBU/WGAM/brianv", "Olaf Ian Davidson", "MS:WGBU/WGAM/olaf", "Die WzMail lover!!!", "Crawl back into that hole you came from"};
