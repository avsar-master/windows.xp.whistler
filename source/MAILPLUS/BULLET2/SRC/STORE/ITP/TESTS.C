...
_hidden  CSRG(MSGINIT) bigMessage = 
	{{2000, 1, 31, 13, 3, 19, 4}, msReceivedUnread,	
...
_hidden  CSRG(MSGINIT) attachMessage = 
	{{2000, 1, 31, 13, 3, 19, 4}, msReceivedModified,	
...
_hidden BOOL FSubmission(void)
{
	...
	PELEMDATA pelemdata = (PELEMDATA) rgbScratchXData;
	HCBC hcbc = hcbcNull;
	MSGINIT msginit = {{2000, 3, 30, 3, 30, 0, 6}, msOutboxComposing, "me", "MS:bullet/dev/ericca", "you", "MS:bullet/dev/danab", "a dog named blue", "travellin' and an livin' off the land"};
