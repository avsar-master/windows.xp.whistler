...
*
*	12-Mar-2000 ln	Moved some to mhlook
*	15-Feb-2000 ln	Restore to correct current window on close of a
*			split window.
*	26-Jan-2000 ln	Turn help in dialog back on. (M200 #295)
*	13-Jan-2000 ln	PWIN->PWND
*	09-Jan-2000 ln	Popup boxes only in CW
