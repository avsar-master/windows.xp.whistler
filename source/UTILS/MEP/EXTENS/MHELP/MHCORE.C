...
*
*   16-Apr-2000 ln  Increment ref count for psuedo file.
*   12-Mar-2000 ln  Various modifications for multiple context lookup.
*   21-Feb-2000 ln  Ensure that fPopUp initialized.
*   14-Feb-2000 ln  Enable BOXSTR
*   26-Jan-2000 ln  Correct key assignments
*   13-Jan-2000 ln  PWIN->PWND
