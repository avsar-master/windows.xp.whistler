...
Removed dead code from the multitask -- just for fun.
   ...
   Rev 1.22   29 Dec 2000 13:33:28   DAVEV
unicode fixes (3)

   Rev 1.21   05 Nov 2000 17:10:06   DAVEV
fix ts

   Rev 1.19   07 Oct 2000 14:13:26   DARRYLP
Precompiled header revisions.

   Rev 1.18   04 Oct 2000 19:39:18   DAVEV
Unicode Awk pass

   Rev 1.17   22 Sep 2000 10:33:32   GLENN
Added FULL BACKUP, INCREMENTAL BACKUP, DIFFERENTIAL BACKUP, FM REPLACE, FM APPEND

   Rev 1.16   10 Jun 2000 12:46:00   JOHNWT
removed autojob creation for msoft

   Rev 1.15   14 May 2000 18:00:22   MIKEP
nt pass 2

   Rev 1.14   09 Mar 2000 16:58:58   CHUCKB
Fixed InitDate().

   Rev 1.13   13 Feb 2000 13:35:56   CHUCKB
Fixed am string length constants.

   Rev 1.12   12 Feb 2000 18:03:56   CHUCKB
Got ValidatePath working, then removed it.

   Rev 1.11   10 Feb 2000 10:36:04   CHUCKB
Added InitIntl and moved BuildNumeralWithCommas.

   Rev 1.10   22 Jan 2000 10:26:00   CHUCKB
Fixed make time string functions for 12:00 a.m.

   Rev 1.9   10 Jan 2000 11:20:06   DAVEV
16/32 bit port-2nd pass

   Rev 1.8   03 Jan 2000 17:47:10   CHUCKB
Added UI_MakeShortDateString.

   Rev 1.7   13 Dec 2000 09:44:50   ROBG
Corrected #define LAUNCHER logic in WM_MultiTask.

   Rev 1.6   13 Dec 2000 09:24:42   ROBG
Made multitask to support the launcher as well.

   Rev 1.5   10 Dec 2000 10:05:20   CHUCKB
Put in makeautojobs function.

   Rev 1.4   05 Dec 2000 10:44:12   CHUCKB
Put in LongToDate/Time.

   Rev 1.3   04 Dec 2000 18:41:52   GLENN
...
due to init routines.
   ...
   Rev 1.2   03 Dec 2000 14:52:10   CHUCKB
Fixed IntToDate and IntToTime.

   Rev 1.1   27 Nov 2000 11:15:14   CHUCKB
Put in default international values

   Rev 1.0   20 Nov 2000 19:30:48   SYSTEM
Initial revision.
