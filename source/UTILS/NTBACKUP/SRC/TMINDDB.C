...
added name_size to PopMinDDB call
   ...
   Rev 1.7   10 Nov 2000 08:18:54   STEVEN
removed path and name from dblk now use full_name_ptr

   Rev 1.6   07 Oct 2000 15:54:58   DAVEV
unicode strlen verification

   Rev 1.5   24 Sep 2000 13:43:54   BARRY
Changes for huge file name support.

   Rev 1.4   21 May 2000 13:49:14   STEVEN
more long path support

   Rev 1.3   04 May 2000 09:27:36   LORIB
Changes for variable length paths.

   Rev 1.2   12 Mar 2000 15:50:20   STEVEN
64 bit changes

   Rev 1.1   28 Feb 2000 13:03:46   STEVEN
step one for varible length paths

   Rev 1.0   28 Jan 2000 14:40:46   STEVEN
Initial revision.
