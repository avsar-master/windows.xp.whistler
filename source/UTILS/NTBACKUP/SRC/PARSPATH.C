...
temporary unicode fix
   ...
   Rev 1.12   02 Dec 2000 17:00:16   CHUCKB
Casted to remove a warning.  You might say the warning was cast out...

   Rev 1.11   11 Nov 2000 09:53:50   GREGG
Unicodeized literals.

   Rev 1.10   06 Oct 2000 09:23:14   ChuckS
Got by mistake, but fixed typo anyway

   Rev 1.9   05 Oct 2000 17:05:58   DAVEV
Unicode strlen verification

   Rev 1.8   18 Aug 2000 10:28:38   STEVEN
fix warnings

   Rev 1.7   28 Jul 2000 15:38:14   STEVEN
fix warnings

   Rev 1.6   24 Mar 2000 10:10:58   DON
if *path is '\0' and psize is 0 then psize is 1

   Rev 1.5   13 Jan 2000 18:46:38   STEVEN
changes for WIN32 compile

   Rev 1.4   06 Aug 2000 18:32:20   DON
added NLM File System support

   Rev 1.3   25 Jul 2000 16:32:26   BARRY
Finish #ifdef changes, remove warnings.

   Rev 1.2   04 Jun 2000 11:28:46   BARRY
Starting to make #defines not product specific--more to come.

   Rev 1.1   29 May 2000 13:51:08   CARLS
added valid sregs pointers for intdosx calls for windows

   Rev 1.0   09 May 2000 13:38:46   HUNTER
Initial revision.
