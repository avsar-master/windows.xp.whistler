...
Enable C++ compile.
   ...
   Rev 1.23   18 Sep 2000 15:51:26   STEVEN
fix spelling 

   Rev 1.22   17 Sep 2000 11:11:50   STEVEN
add support for daily backup

   Rev 1.21   09 Jul 2000 14:00:20   STEVEN
BE_Unicode updates

   Rev 1.20   10 Jun 2000 15:51:54   TIMN
Changed drive letter length or UNIC

   Rev 1.19   26 May 2000 11:20:40   TIMN
Cleaned up memory fx calls

   Rev 1.18   21 May 2000 17:05:22   TIMN
Changed maxByteLen to memorycmp calls

   Rev 1.17   19 May 2000 13:18:04   MIKEP
mips changes

   Rev 1.16   19 May 2000 12:58:26   TIMN
Replaced strlen with DeviceNameLeng macro

   Rev 1.15   18 May 2000 16:04:10   TIMN
Changed str functions to mem

   Rev 1.14   08 May 2000 16:24:18   STEVEN
added volume label to BSD

   Rev 1.13   16 Apr 2000 10:54:08   HUNTER
Add new BSDs to tail if not sorting

   Rev 1.12   18 Feb 2000 17:27:06   BARRY
Fixed destruction of comp_val after volume number comparison.

   Rev 1.11   11 Feb 2000 12:42:46   BARRY
Fixed problem sorting Novell mapped drives.

   Rev 1.10   05 Feb 2000 15:31:44   BARRY
Don't sort IMAGE DLEs by drive letters alone.

   Rev 1.9   14 Jan 2000 16:35:18   DON
needed to sort novell/server dle's by volume if sorting

   Rev 1.8   14 Jan 2000 10:23:34   STEVEN
fix warnings for WIN32

   Rev 1.7   13 Jan 2000 18:36:34   STEVEN
added config switch for BSD sort

   Rev 1.6   27 Aug 2000 17:30:28   STEVEN
added BSD target dir support

   Rev 1.5   23 Aug 2000 17:00:14   STEVEN
added support for NORMAL/COPY/DIFERENTIAL/INCREMENTAL

   Rev 1.4   21 Jun 2000 08:41:14   STEVEN
new config unit

   Rev 1.3   12 Jun 2000 16:03:02   STEVEN
BSDU code review

   Rev 1.2   29 May 2000 17:20:56   STEVEN
Re-Design of BSDU for New Fast File Restore

   Rev 1.1   13 May 2000 13:21:16   STEVEN
If the DLE was NULL the Insert sort would cause a protection exception.


   Rev 1.0   09 May 2000 13:41:10   HUNTER
Initial revision.
