...
Replace old PromptForBindery with new feature bits.
   ...
   Rev 1.7   07 Dec 2000 14:17:02   STEVEN
updates from msoft

   Rev 1.6   10 Nov 2000 08:20:50   STEVEN
removed path and name from dblk now use full_name_ptr

   Rev 1.5   28 Oct 2000 10:30:42   STEVEN
add registry support

   Rev 1.4   24 Jul 2000 15:55:24   STEVEN
fix warnings

   Rev 1.2   27 May 2000 18:50:16   STEVEN
registry api is not implemented

   Rev 1.1   21 May 2000 16:45:18   STEVEN
added support for special files

   Rev 1.0   21 May 2000 13:51:22   STEVEN
Initial revision.
