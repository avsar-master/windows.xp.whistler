...
NT requires this.
   ...
   Rev 1.24   14 Dec 2000 12:23:54   DAVEV
Enabled for Unicode compile

   Rev 1.23   18 Nov 2000 11:39:16   GLENN
Removed warnings.

   Rev 1.22   11 Nov 2000 16:34:30   DAVEV
UNICODE: remove compile warnings

   Rev 1.21   01 Nov 2000 16:06:16   DAVEV
Unicode changes

   Rev 1.20   07 Oct 2000 15:10:58   DARRYLP
Precompiled header revisions.

   Rev 1.19   04 Oct 2000 19:40:12   DAVEV
Unicode Awk pass

   Rev 1.18   09 Sep 2000 17:00:12   GLENN
Updated NEW LOOK toolbar bitmap stuff for BIMINI.

   Rev 1.17   08 Sep 2000 15:41:22   GLENN
Added more room for new bitmaps.

   Rev 1.16   20 Aug 2000 09:05:32   GLENN
ifdef'd NT bitmaps just a little bit further.

   Rev 1.15   03 Jun 2000 13:31:42   JOHNWT
added empty dir bitmaps

   Rev 1.14   18 May 2000 09:00:52   MIKEP
header

   Rev 1.13   14 May 2000 18:36:16   STEVEN
40Format changes

   Rev 1.12   22 Apr 2000 17:34:12   GLENN
Added shark and diver bitmap stuff.

   Rev 1.11   21 Apr 2000 16:48:06   chrish
NT changes

   Rev 1.10   30 Mar 2000 18:01:42   GLENN
Added support for pulling resources from .DLL

   Rev 1.9   27 Mar 2000 17:34:08   GLENN
Changed cursor and icon load macros to functions.

   Rev 1.8   09 Mar 2000 09:18:20   GLENN
Added logo bitmap support.

   Rev 1.7   25 Feb 2000 21:34:24   GLENN
Created RSM_Sprintf().

   Rev 1.6   05 Feb 2000 17:53:12   GLENN
In Process - adding logic to calc bitmap string width.

   Rev 1.5   24 Jan 2000 14:48:34   GLENN
Removed the msassert calls, should not kill the app.

   Rev 1.4   07 Jan 2000 17:41:58   GLENN
Preloading some more bitmaps.

   Rev 1.3   15 Dec 2000 10:28:20   MIKEP
hidden files

   Rev 1.2   12 Dec 2000 17:09:06   DAVEV
16/32 bit port -2nd pass

   Rev 1.1   10 Dec 2000 13:54:16   GLENN
Added functions for get bitmap, font, font string sizes

   Rev 1.0   20 Nov 2000 19:31:16   SYSTEM
Initial revision.
