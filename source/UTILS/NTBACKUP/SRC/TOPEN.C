...
added support for new error messages and backup priviladge
   ...
   Rev 1.36   29 Dec 2000 13:32:56   DAVEV
unicode fixes (3)

   Rev 1.35   14 Dec 2000 16:36:48   STEVEN
directories not in use just access denied

   Rev 1.34   07 Dec 2000 14:18:38   STEVEN
updates from msoft

   Rev 1.33   25 Nov 2000 16:42:28   BARRY
Fix MakeTempFile and restore over active files.

   Rev 1.32   25 Nov 2000 09:09:12   STEVEN
OpenEventLog returns NULL if file cannot be opened

   Rev 1.31   24 Nov 2000 11:01:56   BARRY
Changes to make LINK streams null-impregnated.

   Rev 1.30   23 Nov 2000 09:32:12   STEVEN
fix support for event log

   Rev 1.29   17 Nov 2000 16:13:58   BARRY
Null-out link path on each new object.

   Rev 1.28   11 Nov 2000 09:53:34   GREGG
Unicodeized literals.

   Rev 1.27   10 Nov 2000 13:59:44   STEVEN
fix open change dir problem

   Rev 1.26   10 Nov 2000 10:12:52   BARRY
Initialize new structure members for verify changes.

   Rev 1.25   10 Nov 2000 08:19:00   STEVEN
removed path and name from dblk now use full_name_ptr

   Rev 1.24   30 Oct 2000 14:02:40   BARRY
Fixed a syntactical mistake.

   Rev 1.23   29 Oct 2000 16:53:00   BARRY
Do nothing for linked files.

   Rev 1.22   28 Oct 2000 12:13:20   STEVEN
add support for EventLogs

   Rev 1.21   23 Oct 2000 14:59:56   BARRY
add init for needStreamHeader

   Rev 1.20   20 Oct 2000 14:22:26   STEVEN
temp names should not have .TMP extension

   Rev 1.16   12 Oct 2000 17:46:00   STEVEN
now processes ACL

   Rev 1.15   08 Oct 2000 12:25:00   STEVEN
initialize the hand

   Rev 1.14   07 Oct 2000 15:40:38   STEVEN
added stdmath.h

   Rev 1.13   07 Oct 2000 14:22:08   STEVEN
fix typos

   Rev 1.12   07 Oct 2000 13:50:34   DAVEV
unicode strlen verification

   Rev 1.11   01 Oct 2000 13:27:12   STEVEN
lets open us some directories

   Rev 1.10   24 Sep 2000 13:24:02   BARRY
Changes for huge file name support.

   Rev 1.9   20 Aug 2000 14:02:44   BURT
fix warnings

   Rev 1.8   17 Aug 2000 16:17:24   STEVEN
fix warnings

   Rev 1.7   12 Aug 2000 17:48:16   STEVEN
fixed bugs at microsoft

   Rev 1.6   29 May 2000 13:45:26   STEVEN
fixes

   Rev 1.5   22 May 2000 16:05:18   STEVEN


   Rev 1.4   21 May 2000 13:50:58   STEVEN
more long path stuff

   Rev 1.3   04 May 2000 09:25:16   LORIB
Changes for variable length paths.

   Rev 1.2   12 Mar 2000 15:50:14   STEVEN
64 bit changes

   Rev 1.1   28 Feb 2000 13:03:36   STEVEN
step one for varible length paths

   Rev 1.0   07 Feb 2000 16:41:12   STEVEN
Initial revision.
