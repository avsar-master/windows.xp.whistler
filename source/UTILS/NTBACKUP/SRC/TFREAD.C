...
Added MOVE_ESA macro(s)
   ...
   Rev 1.48   08 Dec 2000 21:02:50   GREGG
Clear CH_DATA_PHASE bit after skipping data in GetData.

   Rev 1.47   20 Nov 2000 13:05:42   HUNTER
Added handling for TF_SKIP_CURRENT_STREAM

   Rev 1.46   11 Nov 2000 22:27:04   GREGG
Unicodeized literals.

   Rev 1.45   04 Nov 2000 09:12:52   HUNTER
Moved the processing of the reqrep's "filter_to_use" field

   Rev 1.43   22 Oct 2000 10:24:50   HUNTER
New data stream handling

   Rev 1.42   22 Sep 2000 09:03:20   GREGG
Initial changes to handle physical block sizes greater than 1K.

   Rev 1.41   17 Aug 2000 08:42:02   GREGG
Changes to deal with block sizeing scheme.

   Rev 1.40   23 Jul 2000 10:11:32   GREGG
Fixed warnings.

   Rev 1.39   09 Jun 2000 15:35:54   GREGG
Changed call to check for continuation block.

   Rev 1.38   21 May 2000 12:52:02   GREGG
Changes for OTC read.

   Rev 1.37   13 May 2000 12:00:16   STEVEN
40 format changes

   Rev 1.36   25 Mar 2000 17:56:08   GREGG
...
properly handle exceptions.
   ...
   Rev 1.8   17 Jun 2000 12:00:08   GREGG
...
from PosAtSet before continuing.
   ...
   Rev 1.3   23 May 2000 16:23:52   NED
Fixed handling of end-of-set when last read ended just prior
to filemark at end.

   Rev 1.2   14 May 2000 16:37:30   NED
...
TFLE_NO_ERR for OK (got data), and FMT_EXC_xxx for exceptions.
   ...
   Rev 1.1   10 May 2000 16:07:36   GREGG
Ned's new stuff

   Rev 1.0   10 May 2000 10:12:20   GREGG
Initial revision.
