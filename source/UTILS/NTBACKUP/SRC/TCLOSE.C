...
added support for new error messages and backup priviladge
   ...
   Rev 1.19   25 Nov 2000 16:42:20   BARRY
Fix MakeTempFile and restore over active files.

   Rev 1.18   17 Nov 2000 22:17:32   DAVEV
unicode fixes

   Rev 1.17   17 Nov 2000 16:13:10   BARRY
Fixes for linked files.

   Rev 1.16   11 Nov 2000 09:54:16   GREGG
Unicodeized literals.

   Rev 1.15   10 Nov 2000 08:19:50   STEVEN
removed path and name from dblk now use full_name_ptr

   Rev 1.14   21 Oct 2000 19:42:00   BARRY
Upon close, we enqueue information about linked files.

   Rev 1.13   20 Oct 2000 14:22:30   STEVEN
temp names should not have .TMP extension

   Rev 1.11   07 Oct 2000 14:23:14   STEVEN
added CloseDir function

   Rev 1.10   21 Sep 2000 13:50:40   BARRY
Turn off archive bit when backing up directories.

   Rev 1.9   12 Aug 2000 17:48:08   STEVEN
fixed bugs at microsoft

   Rev 1.8   25 Jun 2000 11:27:14   STEVEN
logical instead of bitwize NOT for clearing attribute

   Rev 1.7   09 Jun 2000 15:35:32   BURT
Sync with NT stuff

   Rev 1.6   27 May 2000 18:50:28   STEVEN
registry api is not implemented

   Rev 1.5   22 May 2000 16:05:54   STEVEN
 

   Rev 1.4   21 May 2000 13:51:04   STEVEN
more long path stuff

   Rev 1.3   04 May 2000 09:26:52   LORIB
Fixes for structure member names.

   Rev 1.2   28 Feb 2000 13:03:38   STEVEN
step one for varible length paths

   Rev 1.1   12 Feb 2000 10:44:38   STEVEN
remove warning

   Rev 1.0   07 Feb 2000 16:41:14   STEVEN
Initial revision.
