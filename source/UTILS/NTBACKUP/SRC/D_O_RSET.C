...
updates from msoft
   ...
   Rev 1.57   15 Dec 2000 11:22:10   chrish
Corrected logic to handle possible NULL returned from
GetCurrentMachineNameUserName routine.

   Rev 1.56   14 Dec 2000 12:17:22   DAVEV
Enabled for Unicode compile

   Rev 1.55   07 Dec 2000 15:06:26   STEVEN
updates from msoft

   Rev 1.54   20 Nov 2000 16:54:20   GLENN
Completely overhauled so that this code could be readable, also added drive and volume name.

   Rev 1.53   16 Nov 2000 12:21:42   chrish
Minor changes to clean-up warining messages on building.

   Rev 1.52   13 Nov 2000 17:19:06   chrish
Changes for restoring Secured Tapes - NT

   Rev 1.51   11 Nov 2000 16:32:28   DAVEV
UNICODE: remove compile warnings

   Rev 1.50   01 Nov 2000 15:55:50   DAVEV
Unicode changes

   Rev 1.49   07 Oct 2000 13:40:00   DARRYLP
Precompiled header revisions.

   Rev 1.48   04 Oct 2000 19:36:46   DAVEV
Unicode Awk pass

   Rev 1.47   17 Sep 2000 15:50:30   DAVEV
UNICODE modifications: strlen usage check

   Rev 1.46   10 Sep 2000 17:45:14   DAVEV
Integrate MikeP's changes from Microsoft

   Rev 1.45   03 Sep 2000 10:44:18   CHUCKB
Took out some unreferenced locals.

   Rev 1.44   19 Aug 2000 14:28:54   CHUCKB
Added new stuff for NT.

   Rev 1.43   28 Jul 2000 15:05:08   CHUCKB
Fixed warnings for NT.

   Rev 1.42   26 Jun 2000 15:51:58   DAVEV


   Rev 1.41   24 Jun 2000 09:20:06   DAVEV
Browse to path is no longer just an OEM_MSOFT feature

   Rev 1.40   18 Jun 2000 11:25:18   DAVEV
OEM_MSOFT:fixed logging bug

   Rev 1.39   11 Jun 2000 15:22:28   DAVEV
do not display status message 'Examine <log file> for more info' if not logging

   Rev 1.38   05 Jun 2000 12:43:04   DAVEV
OEM_MSOFT: Init log file name to default

   Rev 1.37   14 May 2000 16:37:36   MIKEP
NT pass 2

   Rev 1.36   24 Apr 2000 08:28:00   CARLS
