...
Changed HM_EnterIdle() return type.
   ...
   Rev 1.28   01 Nov 2000 15:58:54   DAVEV
Unicode changes

   Rev 1.27   07 Oct 2000 14:07:34   DARRYLP
Precompiled header revisions.

   Rev 1.26   04 Oct 2000 19:37:46   DAVEV
Unicode Awk pass

   Rev 1.25   08 Sep 2000 16:43:36   DARRYLP

   Rev 1.24   17 Aug 2000 13:18:48   DAVEV
MikeP's changes at Microsoft

   Rev 1.23   11 Jun 2000 10:59:24   GLENN
Now pulling in omhelpid.h.  Fixed unresolved helpids.

   Rev 1.22   29 May 2000 15:58:54   JOHNWT
PCH updates

   Rev 1.21   23 Apr 2000 14:35:12   ROBG
Fixed problem with hitting F1 on a grayed out item.

   Rev 1.20   22 Apr 2000 14:30:12   ROBG
changed

   Rev 1.19   23 Mar 2000 10:06:04   DAVEV
changes for OEM_MSOFT

   Rev 1.18   17 Mar 2000 13:12:02   ROBG
changed

   Rev 1.17   17 Mar 2000 11:55:20   ROBG
changed

   Rev 1.16   16 Mar 2000 16:35:36   ROBG
changed

   Rev 1.15   09 Mar 2000 16:19:44   ROBG
changed

   Rev 1.14   02 Mar 2000 17:09:36   DAVEV
Added case for IDM_HELPSEARCH for Nostradamus

   Rev 1.13   02 Mar 2000 14:56:12   DAVEV
Changes for Nostradamus unique features

   Rev 1.12   18 Feb 2000 20:40:38   GLENN
Updated variables.

   Rev 1.11   11 Feb 2000 17:24:54   GLENN
Removed unnecessary menu related code.

   Rev 1.10   05 Feb 2000 17:54:16   GLENN
Replaced dialog string lookup table and supporting code with IDHELP call to specific dialog.

   Rev 1.9   27 Jan 2000 00:32:26   CHUCKB
Updated dialog id's.

   Rev 1.8   24 Jan 2000 10:09:42   GLENN
Matched the deinit call with it's prototype.

   Rev 1.7   14 Jan 2000 11:39:52   ROBG
Added "Job Status -       " strings.

   Rev 1.6   13 Jan 2000 15:29:44   ROBG
Added HELPID_DIALOGTRANSFER.

   Rev 1.5   09 Jan 2000 11:47:04   ROBG
Updated IDs.

   Rev 1.3   18 Dec 2000 15:52:12   DAVEV
16/32 bit port - 2nd pass

   Rev 1.2   05 Dec 2000 11:02:04   GLENN
Changed WM_GetActive to WM_GetActiveDoc

   Rev 1.1   04 Dec 2000 15:20:14   DAVEV
Modifications for 16/32-bit Windows port - 1st pass.


   Rev 1.0   20 Nov 2000 19:32:54   SYSTEM
Initial revision.
