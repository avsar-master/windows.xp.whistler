...
Added tape security for full catalog.
   ...
   Rev 1.22   13 Nov 2000 17:10:24   chrish
Minor change for Tape Security stuff inside VerifyTapePassword routine

   Rev 1.21   01 Nov 2000 16:04:40   DAVEV
Unicode changes

   Rev 1.20   07 Oct 2000 14:54:34   DARRYLP
Precompiled header revisions.

   Rev 1.19   05 Oct 2000 14:22:10   DAVEV
cbPasswordSize

   Rev 1.18   05 Oct 2000 14:02:12   DAVEV
fix password struct names

   Rev 1.17   04 Oct 2000 19:39:40   DAVEV
Unicode Awk pass

   Rev 1.16   30 Sep 2000 10:45:14   DAVEV
Unicode strlen verification, MikeP's chgs from MS

   Rev 1.15   10 Sep 2000 17:45:32   DAVEV
Integrate MikeP's changes from Microsoft

   Rev 1.14   06 Aug 2000 13:17:18   CHUCKB
Changes for NT.

   Rev 1.13   28 Jul 2000 15:05:18   CHUCKB
Fixed warnings for NT.

   Rev 1.12   07 Jul 2000 15:50:38   MIKEP
unicode changes

   Rev 1.11   14 May 2000 17:23:54   MIKEP
nt pass 2

   Rev 1.10   02 Mar 2000 16:26:22   CHUCKB
Fixed length of password in CollectTapePassword.

   Rev 1.9   08 Feb 2000 16:48:14   MIKEP
fix mac passwords

   Rev 1.8   03 Feb 2000 16:52:46   CHUCKB
In function VerifyTapePassword, changed size of array password to MAX_..._SIZE instead of ..._LEN.

   Rev 1.7   23 Jan 2000 13:10:34   CARLS
fixed password problems

   Rev 1.6   13 Jan 2000 17:22:16   CARLS
added call to JobStatusBackupRestore for Tape
password cancel

   Rev 1.5   20 Dec 2000 09:34:12   DAVEV
16/32 bit port - 2nd pass

   Rev 1.4   06 Dec 2000 15:38:38   CHUCKB
No change.

   Rev 1.3   04 Dec 2000 14:54:08   CARLS
changed return value from TRUE to FALSE if prompting id disabled

   Rev 1.2   03 Dec 2000 20:49:04   MIKEP
macros & headers

   Rev 1.1   22 Nov 2000 08:47:00   MIKEP
structure changes in tape_object

   Rev 1.0   20 Nov 2000 19:34:08   SYSTEM
Initial revision.
