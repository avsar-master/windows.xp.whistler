...
updates from msoft
   ...
   Rev 1.15   09 Dec 2000 14:11:14   STEVEN
getinfo for files was not using correct path

   Rev 1.14   07 Dec 2000 14:17:10   STEVEN
updates from msoft

   Rev 1.13   24 Nov 2000 16:39:44   STEVEN
fix loose name structures

   Rev 1.12   11 Nov 2000 09:52:44   GREGG
Unicodeized literals.

   Rev 1.11   10 Nov 2000 08:19:46   STEVEN
removed path and name from dblk now use full_name_ptr

   Rev 1.10   06 Nov 2000 15:48:54   STEVEN
test write of path in stream

   Rev 1.9   23 Oct 2000 13:33:22   STEVEN
Fixed problem referencing f.name with DDB; path-in-stream fixes for DDBs.

   Rev 1.8   08 Oct 2000 14:21:40   DAVEV
Unicode strlen verfication

   Rev 1.7   24 Sep 2000 13:43:28   BARRY
Changes for huge file name support.

   Rev 1.6   21 Sep 2000 16:51:54   BARRY
Change over from path_complete to name_complete.

   Rev 1.5   27 May 2000 18:48:38   STEVEN
need to set field in DDB correctly

   Rev 1.4   21 May 2000 13:51:02   STEVEN
more long path stuff

   Rev 1.3   04 May 2000 09:28:38   LORIB
Changes for variable length paths and fixes for structure member names.

   Rev 1.2   12 Mar 2000 15:50:12   STEVEN
64 bit changes

   Rev 1.1   28 Feb 2000 13:03:32   STEVEN
