...
Try something new with horiz ext.
   ...
   Rev 1.59   23 Dec 2000 15:37:56   GLENN
Worked on horizontal SB - now using DlgUnits.  Added ability to save RTD location.

   Rev 1.58   17 Nov 2000 08:45:18   chrish
Minor change to aborting a backup on a large file.  Size done maybe greater
than the file size.

   Rev 1.57   11 Nov 2000 16:34:50   DAVEV
UNICODE: remove compile warnings

   Rev 1.56   05 Nov 2000 17:20:56   DAVEV
fix ts

   Rev 1.55   03 Nov 2000 08:27:48   MIKEP
save otc changes

   Rev 1.54   01 Nov 2000 16:07:02   DAVEV
Unicode changes

   Rev 1.53   31 Oct 2000 14:56:06   MIKEP
continue adding small catalog dialog

   Rev 1.52   30 Oct 2000 17:55:56   MIKEP
started small catalog window

   Rev 1.51   28 Oct 2000 16:44:26   chrish
Control Break Handling For Backup

   Rev 1.50   07 Oct 2000 13:44:48   DARRYLP
Precompiled header revisions.

   Rev 1.49   04 Oct 2000 19:40:28   DAVEV
Unicode Awk pass

   Rev 1.48   02 Oct 2000 16:49:06   GLENN
Fixed focus change stuff on verify when app is not active.

   Rev 1.47   10 Sep 2000 17:17:44   GLENN
Fixed bitmap display for BIMINI.

   Rev 1.46   08 Sep 2000 17:29:44   GLENN
Same as last but added to DM_Tension.

   Rev 1.45   08 Sep 2000 15:42:16   GLENN
Added MUI_EnableOperations() call in DESTROY message.

   Rev 1.44   19 Aug 2000 14:29:38   CHUCKB
Added new stuff for NT.

   Rev 1.43   20 Jul 2000 09:59:46   JOHNWT
gas gauge display work

   Rev 1.42   07 Jul 2000 15:42:06   MIKEP
unicode changes

   Rev 1.41   19 May 2000 11:58:56   MIKEP
mips changes

   Rev 1.40   14 May 2000 18:10:18   MIKEP
nt pass 2

   Rev 1.39   11 May 2000 16:14:40   GLENN
