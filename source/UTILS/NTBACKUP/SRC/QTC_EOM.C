...
fix unicode bug
   ...
   Rev 1.7   14 Dec 2000 12:29:00   DAVEV
Enabled for Unicode compile

   Rev 1.6   07 Dec 2000 13:47:06   CHARLIE
Fixed warning

   Rev 1.5   02 Dec 2000 10:14:14   MIKEP
fix warnings

   Rev 1.4   20 Nov 2000 13:53:46   CHARLIE
JAGUAR: Move to SRM based QTC code - no changes from previous version

   Rev 1.3   06 Nov 2000 15:30:12   DON
Change debug.h to be_debug.h and zprintf to BE_Zprintf

   Rev 1.2   15 Oct 2000 10:27:26   MIKEP
add fdd fields

   Rev 1.1   09 Oct 2000 11:53:50   MIKEP
unicode pass
