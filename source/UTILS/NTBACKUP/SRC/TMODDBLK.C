...
Steve's registry fixes to EnumSpecialFiles.
   ...
   Rev 1.30   17 Dec 2000 13:26:56   STEVEN
we need to backup the short names

   Rev 1.29   11 Nov 2000 09:52:12   GREGG
Unicodeized literals.

   Rev 1.28   10 Nov 2000 08:20:36   STEVEN
removed path and name from dblk now use full_name_ptr

   Rev 1.27   06 Nov 2000 16:28:06   STEVEN
test unlimited file sizes

   Rev 1.26   06 Nov 2000 15:49:10   STEVEN
test write of path in stream

   Rev 1.25   04 Nov 2000 18:00:36   BARRY
Moved the temporary MSOFT stream id definitions elsewhere.

   Rev 1.24   29 Oct 2000 16:50:24   BARRY
Translate ULNK IDs; add linkOnly to osinfo.

   Rev 1.23   21 Oct 2000 11:52:54   STEVEN
added SpecialExclude

   Rev 1.22   14 Oct 2000 14:38:52   BARRY
Added MSoft stream IDs (until they are public.).

   Rev 1.21   09 Oct 2000 15:18:10   BARRY
Name-in-stream changes.

   Rev 1.20   07 Oct 2000 16:15:34   STEVEN
forgot the structure

   Rev 1.19   07 Oct 2000 16:10:54   STEVEN
added MsofttoMayn

   Rev 1.18   07 Oct 2000 15:54:30   DAVEV
unicode strlen verification

   Rev 1.17   01 Oct 2000 13:26:46   STEVEN
fixes from Msoft

   Rev 1.16   01 Oct 2000 13:03:48   BARRY
Huge path/file name changes.

   Rev 1.15   22 Sep 2000 15:36:18   BARRY
Got rid of GetTotalSizeDBLK.

   Rev 1.14   21 Sep 2000 16:51:58   BARRY
Change over from path_complete to name_complete.

   Rev 1.13   17 Aug 2000 16:09:20   STEVEN
fix warnings

   Rev 1.12   12 Aug 2000 17:47:44   STEVEN
fixed bugs at microsoft

   Rev 1.11   20 Jul 2000 10:43:32   STEVEN
backup short file name

   Rev 1.10   25 Jun 2000 11:21:52   STEVEN
need to properly initialize the attribute structure

   Rev 1.8   09 Jun 2000 15:14:04   BURT
Sync with NT stuff

   Rev 1.7   01 Jun 2000 10:30:56   STEVEN
specify the file size for now

   Rev 1.6   27 May 2000 18:49:30   STEVEN
getting wrong os path

   Rev 1.5   22 May 2000 16:05:38   STEVEN
 

   Rev 1.4   21 May 2000 13:49:12   STEVEN
more long path support

   Rev 1.3   04 May 2000 09:22:20   LORIB
Fixes to structure member names.

   Rev 1.2   12 Mar 2000 15:50:10   STEVEN
64 bit changes

   Rev 1.1   23 Jan 2000 13:54:14   STEVEN
fix typo of NTTS instead of NTFS

   Rev 1.0   17 Jan 2000 17:50:02   STEVEN
Initial revision.
