...
Minor change to UI_GetCurrentStatus routine for OPERATION_RESTORE case.
   ...
   Rev 1.19   15 Dec 2000 11:23:16   chrish
Modified IsUserValid routine, added another parameter passed to it.

   Rev 1.18   14 Dec 2000 12:18:04   DAVEV
Enabled for Unicode compile

   Rev 1.17   18 Nov 2000 11:22:06   chrish
Added IFDEF OS_WIN32 for NT specific stuff.

   Rev 1.17   18 Nov 2000 10:27:34   chrish
IFDEF functions used only for NT app.

   Rev 1.16   16 Nov 2000 12:20:58   chrish
Minor changes to clean-up warning messages on building.

   Rev 1.15   13 Nov 2000 17:25:46   chrish
Added some routine used for Tape Security for NT

   Rev 1.14   01 Nov 2000 15:49:30   DAVEV
Unicode changes

   Rev 1.13   20 Oct 2000 17:18:14   MIKEP
abort at eof

   Rev 1.12   20 Oct 2000 15:44:30   MIKEP
gbCurrentOperation

   Rev 1.11   07 Oct 2000 14:53:38   DARRYLP
Precompiled header revisions.

   Rev 1.10   04 Oct 2000 19:34:14   DAVEV
Unicode Awk pass

   Rev 1.9   27 Jul 2000 14:49:06   JOHNWT
ChuckB fixed references for NT.

   Rev 1.8   11 Jun 2000 15:20:50   DAVEV
do not display status message 'Examine <log file> for more info' if not logging

   Rev 1.7   14 May 2000 17:24:08   MIKEP
nt pass 2

   Rev 1.6   28 Jan 2000 12:08:48   CARLS


   Rev 1.5   28 Jan 2000 12:04:36   CARLS
coding error on comment

   Rev 1.4   28 Jan 2000 11:59:10   CARLS
fixed password problem

   Rev 1.3   16 Dec 2000 11:45:04   CARLS
added <windows.h>

   Rev 1.2   12 Dec 2000 11:03:36   JOHNWT
removed UI_GetPasswordsAndLabels

   Rev 1.1   25 Nov 2000 15:32:50   JOHNWT
removed mresprintf

   Rev 1.0   20 Nov 2000 19:32:24   SYSTEM
Initial revision.
