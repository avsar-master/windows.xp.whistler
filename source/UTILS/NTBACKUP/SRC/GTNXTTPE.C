...
Copyright(c) Maynard Electronics, Inc. 1984-89
	...
	Date Updated:	5/22/2000   16:32:44
...
Update for setting target ddb to allow redirected single file restore
   ...
   Rev 1.37   14 Dec 2000 13:06:12   STEVEN
failing on empty dirs

   Rev 1.36   07 Dec 2000 14:18:12   STEVEN
updates from msoft

   Rev 1.35   24 Nov 2000 16:39:38   STEVEN
fix loose name structures

   Rev 1.34   04 Nov 2000 09:28:58   STEVEN
fix initial receive

   Rev 1.33   03 Nov 2000 10:09:10   STEVEN
change the way we skip data

   Rev 1.32   06 Oct 2000 13:23:52   DAVEV
Unicode strlen verification

   Rev 1.31   17 Sep 2000 09:26:42   STEVEN
update for stream info

   Rev 1.30   10 Sep 2000 09:30:18   STEVEN
fix bugs in restore

   Rev 1.29   23 Jul 2000 16:43:58   STEVEN
fix warnings

   Rev 1.28   23 Jul 2000 12:02:04   STEVEN
fix warnings

   Rev 1.27   09 Jul 2000 13:59:34   STEVEN
BE_Unicode updates

   Rev 1.26   09 Jun 2000 16:47:02   STEVEN
was comparing aginst wrong block

   Rev 1.25   27 May 2000 15:08:18   TIMN
Fixed FFR_SUBS path compare

   Rev 1.24   21 May 2000 17:18:06   TIMN
Converted CHARs to INT8, str to mem

   Rev 1.23   13 May 2000 11:54:12   TIMN
Added TEXT() macro to literals, but not msassert literals

   Rev 1.22   05 May 2000 17:19:12   STEVEN
fixed typos and misc bugs

   Rev 1.21   30 Apr 2000 16:32:16   BARRY
Fixed setting of path in FDB.

   Rev 1.20   16 Mar 2000 16:20:26   STEVEN
added support to release DBLK for 40 format

   Rev 1.19   13 Mar 2000 09:09:56   STEVEN
40 tape format

   Rev 1.18   11 Mar 2000 14:39:08   STEVEN
was not properly restoring empty directories

   Rev 1.17   16 Jan 2000 15:11:36   STEVEN
fix warnings for WIN32

   Rev 1.16   22 Oct 2000 15:44:02   STEVEN
skip data for empty dir if process elements only

   Rev 1.15   14 Oct 2000 11:31:08   STEVEN
was trying to set path in FDB ?!?!

   Rev 1.14   25 Sep 2000 20:42:54   GREGG
Steve fixed read problem when last dir processed is empty.

   Rev 1.13   04 Sep 2000 17:06:22   CARLS
was appending root to path - bad idea

   Rev 1.12   03 Sep 2000 15:36:12   CARLS
ffr_last_fse was set to NULL before the end of operation

   Rev 1.11   27 Aug 2000 17:28:34   STEVEN
added BSD target dir support

   Rev 1.10   27 Aug 2000 13:35:54   STEVEN
would stop after one DDB

   Rev 1.9   23 Aug 2000 16:17:44   STEVEN
FFR error TRAP D ffr_last_fse uninitialized

   Rev 1.8   27 Jun 2000 08:44:10   STEVEN
fix return when LP_Finished called

   Rev 1.7   21 Jun 2000 13:50:40   STEVEN
new config unit

   Rev 1.6   13 Jun 2000 15:23:24   STEVEN
added support for ALL versions

   Rev 1.5   11 Jun 2000 12:56:24   STEVEN
LBAs now in virtual memory

   Rev 1.4   30 May 2000 09:13:46   STEVEN
bsdu_err.h no longer exists

   Rev 1.3   24 May 2000 14:55:38   STEVEN
complete changes for new getnext

   Rev 1.2   23 May 2000 13:07:42   STEVEN
Added New function headers

   Rev 1.1   23 May 2000 12:52:18   STEVEN
ReDesigned Target object processing

   Rev 1.0   09 May 2000 13:39:48   HUNTER
Initial revision.
