...
auto call erase if foreign tape
   ...
   Rev 1.28   18 Nov 2000 13:24:32   GLENN
Improved speed by increasing polling during dynamic/unstable states.

   Rev 1.27   01 Nov 2000 16:04:56   DAVEV
Unicode changes

   Rev 1.26   07 Oct 2000 14:09:18   DARRYLP
Precompiled header revisions.

   Rev 1.25   04 Oct 2000 19:39:44   DAVEV
Unicode Awk pass

   Rev 1.24   02 Oct 2000 16:33:26   STEVEN
Changed to report drive failure for NT only.

   Rev 1.22   02 Sep 2000 16:32:24   GLENN
MikeP changes for NT.

   Rev 1.21   28 Jul 2000 14:41:58   CHUCKB
Fixed warnings for NT.

   Rev 1.20   24 Jul 2000 10:37:00   STEVEN
do not start polldrive if no drive exists

   Rev 1.19   31 May 2000 11:13:20   MIKEP
auto catalog changes

   Rev 1.18   14 May 2000 18:00:10   MIKEP
nt pass 2

   Rev 1.17   23 Mar 2000 15:53:08   GLENN
Added success message box when hardware retests successful.

   Rev 1.16   19 Mar 2000 15:58:02   GLENN
Fixed eject bug.

   Rev 1.15   17 Mar 2000 15:39:26   GLENN
Changed major and minor hardware error processing.

   Rev 1.14   31 Jan 2000 15:02:10   GLENN
Added restart logic messaging and major error messaging.

   Rev 1.13   21 Jan 2000 16:57:04   JOHNWT
removed checkyy flag

   Rev 1.12   14 Jan 2000 08:17:08   GLENN
Updated error processor.

   Rev 1.11   11 Jan 2000 09:22:02   CARLS
remove strings

   Rev 1.10   07 Jan 2000 17:31:42   GLENN
Added support for polldrive retry after hwinit failure

   Rev 1.9   26 Dec 2000 13:37:00   GLENN
Added yy flag check to message boxes

   Rev 1.8   20 Dec 2000 09:34:48   DAVEV
16/32 bit port - 2nd pass

   Rev 1.7   18 Dec 2000 14:06:42   GLENN
Added windows.h

   Rev 1.6   18 Dec 2000 13:13:12   GLENN
Put backin poll drive init check in the start function

   Rev 1.5   11 Dec 2000 13:05:10   JOHNWT
changed assert in StopPolling to return

   Rev 1.4   04 Dec 2000 18:19:22   GLENN
Added TF_NO_TAPE_PRESENT to eject error processing.

   Rev 1.3   04 Dec 2000 12:55:24   DAVEV
Modifications for 16/32-bit Windows port - 1st pass.


   Rev 1.2   27 Nov 2000 12:12:52   GLENN
Clean-up.

   Rev 1.1   21 Nov 2000 10:42:18   GLENN
Added headers and eject/polldrive re-entrancy protection.

   Rev 1.0   20 Nov 2000 19:19:54   SYSTEM
Initial revision.
