...
Made the minimum value for string_type BEC_ANSI_STR
   ...
   Rev 1.17   08 Dec 2000 14:24:10   DON
Integrated Move/Copy into tips

   Rev 1.16   08 Dec 2000 11:45:34   DOUG
Added new GRFS and NRL parameters

   Rev 1.15   14 Oct 2000 16:33:24   STEVEN
fix typos

   Rev 1.14   13 Oct 2000 12:34:14   STEVEN
added otc level

   Rev 1.13   04 May 2000 12:25:42   STEVEN
NT_STUFF added string types

   Rev 1.12   02 Feb 2000 15:52:32   GREGG
Removed utf_supported boolean from config, and added UINT16 initial_buff_alloc.

   Rev 1.11   27 Jan 2000 18:14:32   GREGG
Changes for new config element: utf_supported.

   Rev 1.10   13 Jan 2000 18:36:28   STEVEN
added config switch for BSD sort

   Rev 1.9   19 Nov 2000 13:10:06   STEVEN
allow a value of 2 for skip_open_files

   Rev 1.8   14 Nov 2000 10:19:06   BARRY
TRICYCLE: Added restore_security.

   Rev 1.7   06 Nov 2000 18:52:54   GREGG
BIGWHEEL - 8200sx - Added catalog_level to BE config.

   Rev 1.6   24 Oct 2000 11:19:32   BARRY
Free memory after dequeue.

   Rev 1.5   16 Oct 2000 14:12:24   STEVEN
need to allow for 2 in exist flag

   Rev 1.4   19 Sep 2000 13:03:46   STEVEN
added Machine type to config

   Rev 1.3   12 Aug 2000 15:57:34   BARRY
DisplayNetwareServers no longer in config.

   Rev 1.2   01 Jul 2000 17:34:56   STEVEN
added min and max

   Rev 1.1   19 Jun 2000 17:27:52   BARRY
Forgot to include (of all things) stdlib.h.

   Rev 1.0   19 Jun 2000 10:38:06   BARRY
Initial revision.
