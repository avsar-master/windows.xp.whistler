...
C++ enable
   ...
   Rev 1.9   26 May 2000 13:41:50   TIMN
Added target filename size

   Rev 1.8   19 May 2000 12:57:36   TIMN
Removed strlen call

   Rev 1.7   14 May 2000 11:56:04   TIMN
Changed CHARs to INT8
Changed strcpy to memcpy
Added file name size to formal parameter lists

   Rev 1.6   14 Jan 2000 10:24:34   STEVEN
fix warnings for WIN32

   Rev 1.5   18 Dec 2000 11:50:00   DON
changed mallocs to callocs to avoid using invalid memory...

   Rev 1.4   19 Sep 2000 17:02:28   STEVEN
fix warning for alloc_size unused

   Rev 1.3   27 Aug 2000 17:30:10   STEVEN
added BSD target dir support

   Rev 1.2   08 Jul 2000 08:37:16   STEVEN
did not initialize return value

   Rev 1.1   29 May 2000 17:21:16   STEVEN
Re-Design of BSDU for New Fast File Restore

   Rev 1.0   09 May 2000 13:36:16   HUNTER
Initial revision.
