...
Initial changes for new stream and EOM processing.
   ...
   Rev 1.13   26 Feb 2000 08:58:36   STEVEN
added include for buffnt.h

   Rev 1.12   04 Feb 2000 19:53:40   GREGG
Changes for dealing with new config parameters.

   Rev 1.11   16 Jan 2000 21:02:40   GREGG
Changed InitList to return INT16 not UINT16.

   Rev 1.10   14 Jan 2000 19:43:34   NED
Added call to BM_OS_CleanupListTuesday, January 28, 2000

   Rev 1.9   14 Jan 2000 02:03:44   GREGG
InitList and OS_InitList now return TFLEs.

   Rev 1.8   13 Jan 2000 19:42:56   NED
Changed vcb requirements to a uw_ variable

   Rev 1.7   13 Jan 2000 13:44:52   GREGG
Skateboard - Bug fixes.

   Rev 1.6   03 Jan 2000 11:39:50   GREGG
Modifications to allow for a special VCB buffer.

   Rev 1.5   05 Dec 2000 13:50:06   GREGG
SKATEBOARD - New Buff Mgt - Initial Integration.

   Rev 1.4   07 Jun 2000 16:20:20   NED
removed static attribute from definition of uw_bpool

   Rev 1.3   04 Jun 2000 11:21:08   BARRY
Fix OS-specific memory allocation problems by relocating BM_Alloc() and
BM_Free() to separate source files. Tuesday, December 17, 2000

   Rev 1.2   03 Jun 2000 15:22:18   CARLS
added changes for Windows

   Rev 1.1   10 May 2000 16:17:36   GREGG
Ned's new stuff.

   Rev 1.0   10 May 2000 10:12:14   GREGG
Initial revision.
 ...
 *  Name:         BM_InitList
 *
 *  Modified:     Tuesday, January 28, 2000
 *
 ...
 *  Name:         BM_InitBuf
 *
 *  Modified:     Monday, October 7, 2000
 *
 ...
 *
 *  Modified:     Friday, December 20, 2000
 *
 ...
 *
 *  Modified:     Friday, October 18, 2000
 *
