...
Added access_date to fix read page fault
   ...
   Rev 1.11   11 Nov 2000 09:52:30   GREGG
Unicodeized literals.

   Rev 1.10   18 Aug 2000 10:12:00   STEVEN
fix warnings

   Rev 1.9   12 Mar 2000 15:51:08   STEVEN
64 bit changes

   Rev 1.8   24 Feb 2000 17:37:16   STEVEN
added support for NTFS

   Rev 1.7   05 Dec 2000 15:30:06   BARRY
Added SMS object to FS_CreateDefaultDBLK().

   Rev 1.6   30 Oct 2000 10:26:22   LORIB
Changes for ACL. Changed the OS version for OS/2 to FS_PC_OS2_ACL_VER.

   Rev 1.5   01 Oct 2000 11:14:42   BARRY
Include standard headers.

   Rev 1.4   12 Aug 2000 13:40:18   DON
fixes for NLM

   Rev 1.3   24 Jul 2000 09:11:46   DAVIDH
Corrected warning found by Watcom.

   Rev 1.2   27 Jun 2000 09:42:16   STEVEN
fix typeo

   Rev 1.1   24 Jun 2000 09:19:10   STEVEN
need to initialize version

   Rev 1.0   09 May 2000 13:39:56   HUNTER
Initial revision.
