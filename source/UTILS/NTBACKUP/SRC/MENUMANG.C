...
Disabled the VIEW split selection if active doc is minimized.
   ...
   Rev 1.33   11 Dec 2000 18:22:36   GLENN
Now handling state of hardware option under NT.

   Rev 1.32   18 Nov 2000 11:38:42   GLENN
Removed warnings.

   Rev 1.31   01 Nov 2000 16:02:14   DAVEV
Unicode changes

   Rev 1.30   07 Oct 2000 15:11:18   DARRYLP
Precompiled header revisions.

   Rev 1.29   04 Oct 2000 19:38:50   DAVEV
Unicode Awk pass

   Rev 1.28   22 Sep 2000 10:23:28   GLENN
Removed the WNet calls and headers.  They are now in the VLM_UTIL.C file.

   Rev 1.27   10 Sep 2000 17:18:58   GLENN
Resolved outstanding state issues for toolbar and menubar.

   Rev 1.26   09 Sep 2000 14:39:12   DARRYLP
Added WFW net functionality - net connect and disconnect.

   Rev 1.25   08 Sep 2000 16:43:00   DARRYLP

   Rev 1.24   20 Aug 2000 09:32:46   GLENN
Added catalog operation support for NT.

   Rev 1.23   10 Jul 2000 10:27:30   GLENN
Enabled font selection support NT.

   Rev 1.22   23 Jun 2000 17:59:50   DAVEV
correctly fixed IDM_VIEWMENU problem this time!

   Rev 1.21   23 Jun 2000 17:34:56   DAVEV
IDM_VIEWFONT only for OEM_MSOFT

   Rev 1.20   10 Jun 2000 16:15:14   GLENN
Updated according to NT SPEC.

   Rev 1.19   15 May 2000 13:32:16   MIKEP
nt pass 2

   Rev 1.18   20 Apr 2000 14:03:46   GLENN
Changed send to post message when requested to close the app.

   Rev 1.17   15 Apr 2000 16:44:54   GLENN
Added MM_ShowMenuStatusHelp() call to show status help only for valid menu IDs.

   Rev 1.16   17 Mar 2000 18:26:46   GLENN
Allowing spaces at the begining of a job name in quick pick.

   Rev 1.15   03 Mar 2000 19:01:02   GLENN
Added && double ampersand support to quick pick.

   Rev 1.14   25 Feb 2000 21:33:22   GLENN
Changed close all call.

   Rev 1.13   23 Feb 2000 13:42:50   GLENN
Fixed exit case.

   Rev 1.12   11 Feb 2000 17:19:08   GLENN
Enabling view-split for tapes and servers.

   Rev 1.11   10 Feb 2000 09:14:10   GLENN
Changed Settings - Options to Settings - General.

   Rev 1.10   29 Jan 2000 18:04:32   GLENN
Grayed out delete sel when no selections exist.

   Rev 1.9   27 Jan 2000 12:45:58   GLENN
Changed dialog support calls.

   Rev 1.8   22 Jan 2000 12:31:42   GLENN
Clean-up.

   Rev 1.7   13 Jan 2000 16:50:42   CHUCKB
Fixed string variables that hold job names.

   Rev 1.6   07 Jan 2000 17:25:26   GLENN
Added MDI split/slider support

   Rev 1.5   26 Dec 2000 13:46:10   GLENN
Changed show flags to use CDS calls

   Rev 1.4   12 Dec 2000 17:06:42   DAVEV
16/32 bit port -2nd pass

   Rev 1.3   10 Dec 2000 13:47:54   GLENN
Replaced ghWndActiveDoc with WM_GetActiveDoc().

   Rev 1.2   04 Dec 2000 15:21:12   DAVEV
Modifications for 16/32-bit Windows port - 1st pass.


   Rev 1.1   03 Dec 2000 16:24:34   GLENN
Added code to set limit on jobs in menu to 9.  Added VLM_Refresh call.

   Rev 1.0   20 Nov 2000 19:30:40   SYSTEM
Initial revision.
