...
added stream_id to error message
   ...
   Rev 1.29   20 Nov 2000 12:57:00   STEVEN
added support for skip stream filter

   Rev 1.28   20 Nov 2000 10:38:24   STEVEN
added suport for continue VCB message

   Rev 1.27   04 Nov 2000 17:29:48   STEVEN
fix typo

   Rev 1.26   04 Nov 2000 13:23:54   STEVEN
fix various bugs with read

   Rev 1.25   27 Oct 2000 12:10:48   STEVEN
if we send new stream then return

   Rev 1.24   21 Oct 2000 16:23:02   STEVEN
forgot the case statement

   Rev 1.23   15 Oct 2000 10:01:46   STEVEN
added new stream message

   Rev 1.22   13 Oct 2000 17:26:22   STEVEN
oops I forgot the TRR_END message

   Rev 1.21   13 Oct 2000 17:20:24   STEVEN
save old tf message

   Rev 1.20   23 Jul 2000 16:44:48   STEVEN
fix warnings

   Rev 1.19   23 Jul 2000 12:10:12   STEVEN
fix warnings

   Rev 1.18   06 Jul 2000 09:39:10   STEVEN
fix typo

   Rev 1.17   21 May 2000 17:20:30   TIMN
Converted CHARs to INT8

   Rev 1.16   13 May 2000 12:35:36   TIMN
Added TEXT() macro to literals, but not msassert literals

   Rev 1.15   13 May 2000 12:00:34   STEVEN
40 format changes

   Rev 1.14   04 Feb 2000 22:22:00   GREGG
Don't restart clock in ProcessEOM until after tape request returns.

   Rev 1.13   25 Jan 2000 15:04:02   GREGG
...
once, and leaves it up to the caller to decide what to do with the response.
   ...
   Rev 1.12   16 Jan 2000 15:11:00   STEVEN
fix warnings for WIN32

   Rev 1.11   19 Dec 2000 16:32:08   BARRY
Clear buffer used when sending END_DATA message.

   Rev 1.10   25 Oct 2000 15:58:06   GREGG
TRICYCLE - Re-switch after calls to ProcessEOM.

   Rev 1.9   18 Oct 2000 14:06:36   STEVEN
TRICYCLE-added function for end of varible length file

   Rev 1.8   18 Oct 2000 14:02:42   STEVEN
BIGWHEEL-fixed bug where we asserted

   Rev 1.7   18 Oct 2000 11:34:12   STEVEN
BIGWHEEL-add parameter to message prompt

   Rev 1.6   16 Aug 2000 17:11:26   STEVEN
Could not Verify or Restore multiple sets

   Rev 1.5   27 Jun 2000 13:06:20   STEVEN
removed unused parm to ReceiveData

   Rev 1.4   21 Jun 2000 08:45:40   STEVEN
new config unit

   Rev 1.3   17 Jun 2000 16:28:14   STEVEN
LP_PadData is called from lptools.c so it was moved to there

   Rev 1.2   30 May 2000 09:10:52   STEVEN
bsdu_err.h no longer exists

   Rev 1.1   24 May 2000 13:12:10   STEVEN
changed to ANSI prototypes

   Rev 1.0   09 May 2000 13:37:56   HUNTER
Initial revision.
