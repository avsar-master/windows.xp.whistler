...
Change for Cayman
   ...
   Rev 1.46   16 Dec 2000 10:25:38   STEVEN
fix mips bugs

   Rev 1.45   14 Dec 2000 12:25:52   DAVEV
Enabled for Unicode compile

   Rev 1.44   18 Nov 2000 11:39:14   GLENN
Release the cursor capture if the cursor point is outside of the frame.

   Rev 1.43   01 Nov 2000 16:15:02   DAVEV
Unicode changes

   Rev 1.42   30 Oct 2000 15:47:24   GLENN
Added Frame and MDI Doc window size and position saving and restoring.

   Rev 1.41   14 Oct 2000 15:53:50   GLENN
Added Font selection to Config and INI.

   Rev 1.40   04 Oct 2000 19:44:08   DAVEV
Unicode Awk pass

   Rev 1.39   02 Oct 2000 16:52:26   GLENN
Added WM_SetCursor() to help fix NT WM_ShowWaitCursor problems when leaving app.

   Rev 1.38   28 Sep 2000 17:03:02   GLENN
MikeP changes (strcpy to memcpy).

   Rev 1.37   17 Sep 2000 15:54:14   DAVEV
UNICODE modifications: strlen usage check

   Rev 1.36   10 Sep 2000 17:05:54   GLENN
Set the tool bar background color to be like FM.

   Rev 1.35   09 Sep 2000 17:00:54   GLENN
Updated NEW LOOK font stuff for BIMINI.

   Rev 1.34   02 Sep 2000 15:13:14   GLENN
Created a highlight brush and color.  Moved the font stuff to font.c

   Rev 1.33   29 Jul 2000 14:23:18   GLENN
ChuckB checked in after NT fixes.

   Rev 1.32   10 Jul 2000 10:13:52   GLENN
In process of adding font selection support.

   Rev 1.31   07 Jul 2000 15:32:24   MIKEP
unicode changes

   Rev 1.30   10 Jun 2000 16:14:54   GLENN
Updated according to NT SPEC.

   Rev 1.29   15 May 2000 13:32:26   MIKEP
nt pass 2

   Rev 1.28   05 May 2000 15:59:04   JOHNWT
changed ternary thing

   Rev 1.27   22 Apr 2000 17:50:36   GLENN
Put in auto log to debug file when /z is used.

   Rev 1.26   20 Apr 2000 13:48:22   GLENN
Added status line get/set capability.

   Rev 1.25   07 Apr 2000 15:39:22   GLENN
Fixed WM_MakeAppActive() to bring up frame.

   Rev 1.24   02 Apr 2000 15:44:18   GLENN
NT font and class changes - TESTED in WP and NT.

   Rev 1.23   31 Mar 2000 11:23:28   DAVEV
OEM_MSOFT: no icon animation allowed

   Rev 1.22   24 Mar 2000 10:34:28   ROBG
Added logic to use system colors when creating a log file view.

   Rev 1.21   19 Mar 2000 14:29:02   STEVEN
do not subclass MDI client if getlong fails - NTKLUG

   Rev 1.20   19 Mar 2000 11:44:54   JOHNWT
added WM_MakeAppActive

   Rev 1.19   10 Mar 2000 16:28:16   GLENN
Added WM_MoveWindow().

   Rev 1.18   03 Mar 2000 18:24:46   GLENN
Updated animate icon.  Added new log view window support.

   Rev 1.17   23 Feb 2000 13:44:54   GLENN
Added valid window check to ResoreDocs().

   Rev 1.16   20 Feb 2000 11:16:58   GLENN
Changed the MDI create maximized code for NT compatibility.

   Rev 1.15   18 Feb 2000 21:02:28   GLENN
Added support for min/max/restore docs before/after operations.

   Rev 1.14   11 Feb 2000 17:30:18   GLENN
Added support for MDI client subclassing.

   Rev 1.13   05 Feb 2000 17:56:38   GLENN
Yanked out win32 redundant code.

   Rev 1.12   29 Jan 2000 18:02:30   GLENN
Increased animate icon rect.

   Rev 1.11   24 Jan 2000 14:54:00   GLENN
Changed HM_Deinit call to match it's prototype.

   Rev 1.10   23 Jan 2000 12:30:58   GLENN
Added defs for array sizes.

   Rev 1.9   23 Jan 2000 09:04:44   MIKEP
fix title size

   Rev 1.8   21 Jan 2000 13:32:26   GLENN
Added WM_AnimateAppIcon() function.

   Rev 1.7   10 Jan 2000 16:39:04   JOHNWT
moved set idle text from GUI_Init to WM_Init

   Rev 1.6   07 Jan 2000 17:40:32   GLENN
Changed debug stuff

   Rev 1.5   26 Dec 2000 13:46:28   GLENN
Changed show flags to use CDS calls

   Rev 1.4   11 Dec 2000 13:03:34   DAVEV
16/32 bit port -2nd pass

   Rev 1.3   10 Dec 2000 13:56:44   GLENN
Added feature to WM_Create function to create single column FLAT list boxes

   Rev 1.2   04 Dec 2000 15:20:42   DAVEV
Modifications for 16/32-bit Windows port - 1st pass.


   Rev 1.1   03 Dec 2000 15:58:58   GLENN
Updated as per code review.

   Rev 1.0   20 Nov 2000 19:25:44   SYSTEM
Initial revision.
