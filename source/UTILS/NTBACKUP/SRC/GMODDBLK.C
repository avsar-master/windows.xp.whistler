...
GEN_ProcessDDB should return TRUE (process DDBs always) not FALSE
   ...
   Rev 1.13   07 Dec 2000 14:55:40   STEVEN
Microsoft updates

   Rev 1.12   01 Dec 2000 10:38:34   DON
needed to use strNcpy instead of strcpy

   Rev 1.11   11 Nov 2000 10:43:34   STEVEN
fix os_name for gen_fs

   Rev 1.10   06 Oct 2000 13:24:46   DAVEV
Unicode strlen verification

   Rev 1.9   22 Sep 2000 17:29:40   CHUCKB
Took out references to GetTotalSizeDBLK().

   Rev 1.8   10 Sep 2000 09:45:52   STEVEN
fix warnings

   Rev 1.7   18 Aug 2000 10:20:26   STEVEN
fix warnings

   Rev 1.6   17 Mar 2000 09:05:32   STEVEN
format 40 - added 64 bit support

   Rev 1.5   21 Jan 2000 14:20:34   BARRY
Added GEN_GetGenSizeDBLK().

   Rev 1.4   27 Nov 2000 10:34:28   BARRY
Fixed GEN_GetOSPath parameters.

   Rev 1.3   01 Oct 2000 11:19:36   BARRY
Include standard headers.

   Rev 1.2   14 Aug 2000 13:06:58   STEVEN
added FindClose

   Rev 1.1   24 Jul 2000 11:37:54   DAVIDH
Corrected compiler warnings under Watcom.

   Rev 1.0   09 May 2000 13:39:36   HUNTER
Initial revision.
