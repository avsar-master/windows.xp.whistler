...
added stream_id to error message
   ...
   Rev 1.22   23 Jul 2000 16:45:02   STEVEN
fix warnings

   Rev 1.21   23 Jul 2000 12:08:02   STEVEN
fix warnings

   Rev 1.20   21 May 2000 17:22:34   TIMN
Added corrupt block filename length

   Rev 1.19   14 May 2000 16:11:38   STEVEN
corrupt -> corrupt_bit

   Rev 1.18   13 May 2000 12:27:20   TIMN
Removed used references to tapename and backup_set_name for TPOS structs.

   Rev 1.17   13 May 2000 11:59:58   STEVEN
40 format changes

   Rev 1.16   24 Feb 2000 10:03:10   GREGG
Call TF_OpenTape at beginning of loop, Open/Close Set in loop, CloseTape at end.

   Rev 1.15   19 Feb 2000 16:01:28   GREGG
Added vcb_only parameter to call to TF_OpenSet.

   Rev 1.14   04 Feb 2000 21:42:02   GREGG
Changed parameters in calls to TF_AllocateTapeBuffers and TF_FreeTapeBuffers.

   Rev 1.13   22 Jan 2000 10:20:28   STEVEN
fix warnings for WIN32

   Rev 1.0   22 Jan 2000 10:17:40   STEVEN
fix warnings for WIN32

   Rev 1.12   13 Dec 2000 15:21:48   GREGG
SKATEBOARD - Initial Integration.

   Rev 1.11   06 Nov 2000 19:24:50   GREGG
BIGWHEEL - 8200sx - Get cat_enabled from the BE config.

   Rev 1.10   28 Oct 2000 13:07:16   GREGG
BIGWHEEL - Re-switch after calls to ProcessEOM.

   Rev 1.9   18 Oct 2000 16:25:12   STEVEN
added parm for restore over exist prompt

   Rev 1.8   17 Oct 2000 01:53:58   ED
BIGWHEEL - 8200sx - Initial integration.

   Rev 1.7   24 Jul 2000 17:42:30   STEVEN
lp was not set up

   Rev 1.6   22 Jul 2000 10:57:14   DAVIDH
Corrected type mismatch warnings.

   Rev 1.5   21 Jun 2000 09:33:12   STEVEN
new config unit

   Rev 1.4   30 May 2000 09:10:16   STEVEN
bsdu_err.h no longer exists

   Rev 1.3   28 May 2000 10:49:06   STEVEN
use MAYN_MEM instead of MAYN_OS2

   Rev 1.2   24 May 2000 13:15:18   STEVEN
updates from BSDU redesign

   Rev 1.1   15 May 2000 09:35:08   DAVIDH
Cleared up Watcom compiler warnings for NLM.

   Rev 1.0   09 May 2000 13:38:02   HUNTER
Initial revision.
