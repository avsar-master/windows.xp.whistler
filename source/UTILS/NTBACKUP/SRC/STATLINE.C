...
add nt memory display
   ...
   Rev 1.15   01 Nov 2000 16:08:10   DAVEV
Unicode changes

   Rev 1.14   07 Oct 2000 15:10:38   DARRYLP
Precompiled header revisions.

   Rev 1.13   04 Oct 2000 19:40:46   DAVEV
Unicode Awk pass

   Rev 1.12   10 Jul 2000 10:29:10   GLENN
Changed the status line to be identical to the new file manager.

   Rev 1.11   10 Jun 2000 16:14:38   GLENN
Updated according to NT SPEC.

   Rev 1.10   29 May 2000 16:00:42   JOHNWT
PCH updates

   Rev 1.9   22 Apr 2000 17:53:32   GLENN
Using MAX_STATUS_LINE_LEN for status line text length.

   Rev 1.8   20 Apr 2000 13:48:38   GLENN
Added status line get/set capability.

   Rev 1.7   26 Mar 2000 08:44:48   JOHNWT
don't display mem line unless app is up

   Rev 1.6   03 Mar 2000 18:18:38   GLENN
Updated draw text call.

   Rev 1.5   23 Feb 2000 13:56:54   GLENN
Removed right status box - not used at this time.

   Rev 1.4   20 Jan 2000 13:09:56   MIKEP
changes

   Rev 1.3   26 Dec 2000 13:41:12   GLENN
Changed show flags to use CDS calls

   Rev 1.2   19 Dec 2000 15:25:14   GLENN
Added windows.h

   Rev 1.1   02 Dec 2000 17:51:36   DAVEV
16/32 bit Windows port changes

   Rev 1.0   20 Nov 2000 19:32:46   SYSTEM
Initial revision.
