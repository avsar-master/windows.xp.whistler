...
added stream_id to error message
   ...
   Rev 1.20   04 Nov 2000 13:23:44   STEVEN
fix various bugs with read

   Rev 1.19   04 Nov 2000 09:29:08   STEVEN
fix initial receive

   Rev 1.18   03 Nov 2000 10:09:20   STEVEN
change the way we skip data

   Rev 1.17   28 Oct 2000 15:05:30   STEVEN
very buffer is buffer size

   Rev 1.16   05 Oct 2000 10:29:34   STEVEN
remove TotalSize

   Rev 1.15   16 Sep 2000 16:55:34   STEVEN
added support for stream info struct for Tpfmt

   Rev 1.14   01 Sep 2000 16:11:42   STEVEN
added stream headers to fsys API

   Rev 1.13   23 Jul 2000 13:16:52   STEVEN
fix warnings

   Rev 1.12   14 May 2000 12:40:48   TIMN
Changed CHAR to INT8

   Rev 1.11   05 May 2000 17:19:08   STEVEN
fixed typos and misc bugs

   Rev 1.10   16 Mar 2000 16:34:56   STEVEN
more 64 bit support for format 40

   Rev 1.9   13 Mar 2000 09:23:16   STEVEN
4.0 tape format 64 bit

   Rev 1.8   04 Feb 2000 10:35:56   DON
if NOT defined FS_IMAGE then Images should be ignored

   Rev 1.7   17 Jan 2000 17:42:18   STEVEN
fix warnings for WIN32

   Rev 1.6   11 Dec 2000 14:09:28   STEVEN
read converted to FS_READ

   Rev 1.5   27 Jun 2000 13:07:06   STEVEN
removed unused parm to ReceiveData

   Rev 1.4   21 Jun 2000 08:48:52   STEVEN
new config unit

   Rev 1.3   30 May 2000 09:11:40   STEVEN
bsdu_err.h no longer exists

   Rev 1.2   24 May 2000 13:19:16   STEVEN
updates from BSDU redesign

   Rev 1.1   15 May 2000 11:01:36   DAVIDH
Initialized blk_size to clear Watcom compiler warning.


   Rev 1.0   09 May 2000 13:38:54   HUNTER
Initial revision.
