...
directory names
   ...
   Rev 1.16   01 Nov 2000 15:58:04   DAVEV
Unicode changes

   Rev 1.15   07 Oct 2000 13:44:02   DARRYLP
Precompiled header revisions.

   Rev 1.14   04 Oct 2000 19:37:30   DAVEV
Unicode Awk pass

   Rev 1.13   28 Jul 2000 14:52:32   CHUCKB
Fixed warnings for NT.

   Rev 1.12   14 May 2000 16:42:30   MIKEP
nt pass 2

   Rev 1.11   05 Feb 2000 17:05:42   CARLS
fix for displaying driectory path

   Rev 1.10   27 Jan 2000 12:48:06   GLENN
Changed dialog support calls.

   Rev 1.9   24 Jan 2000 10:08:50   GLENN
Changed DM_Filereplace() to DM_FileReplace() to make it consistant with it's prototype.

   Rev 1.8   20 Jan 2000 10:00:10   CARLS
added a call to DM_CenterDialog

   Rev 1.7   16 Jan 2000 14:39:58   CHUCKB
Added help.

   Rev 1.6   09 Jan 2000 18:24:58   DAVEV
16/32 bit port 2nd pass

   Rev 1.5   20 Dec 2000 16:53:56   JOHNWT
return ghModelessDialog

   Rev 1.4   18 Dec 2000 11:33:00   JOHNWT
changed ghModelessDialog to ghRuntimeDialog

   Rev 1.3   25 Nov 2000 15:56:04   CARLS
fixed DisplayDirectory problem - wrong handle used with ReleaseDC call

   Rev 1.2   25 Nov 2000 15:26:20   JOHNWT
add title to msgbox

   Rev 1.1   25 Nov 2000 15:07:52   DAVEV
Changes for 32-16 bit Windows port

   Rev 1.0   11 Nov 2000 09:38:48   CARLS
Initial revision.
