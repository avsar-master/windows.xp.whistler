...
added support for new error messages and backup priviladge
   ...
   Rev 1.5   24 Nov 2000 11:01:48   BARRY
Changes to make LINK streams null-impregnated.

   Rev 1.4   17 Nov 2000 22:19:06   DAVEV
unicode fixes

   Rev 1.3   17 Nov 2000 15:22:58   BARRY
Updates after testing with Backup APIs.

   Rev 1.2   10 Nov 2000 08:33:14   STEVEN
fix path name to full_name_ptr

   Rev 1.1   29 Oct 2000 16:49:02   BARRY
Restore links coded (need Unicode support, though.

   Rev 1.0   21 Oct 2000 19:57:22   BARRY
Initial revision.
