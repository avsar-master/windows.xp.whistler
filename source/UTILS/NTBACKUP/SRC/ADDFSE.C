...
enable c++ build
   ...
   Rev 1.15   09 Oct 2000 11:44:02   DAVEV
Unicode (CHAR_PTR) pointer cast validation

   Rev 1.14   10 Jun 2000 15:49:18   TIMN
changed header name

   Rev 1.13   26 May 2000 11:19:24   TIMN
Cleaned up memory fx calls

   Rev 1.12   21 May 2000 17:03:26   TIMN
Changed maxByteLen to memoryCMP

   Rev 1.11   19 May 2000 15:18:56   TIMN
Changed asterisks to define's

   Rev 1.10   18 May 2000 16:03:00   TIMN
Changed str functions to mem

   Rev 1.9   14 May 2000 12:13:06   TIMN
Changed CHARs to INT8, strcpy to memcpy

   Rev 1.8   13 May 2000 11:41:12   TIMN
Added TEXT() macro to literals, but not msassert literals

   Rev 1.7   28 Feb 2000 09:22:40   STEVEN
partial excludes being full excludes

   Rev 1.6   14 Jan 2000 10:23:48   STEVEN
fix warnings for WIN32

   Rev 1.5   02 Oct 2000 15:32:06   STEVEN
selection type ENTIRE DIR when should be PARTIAL

   Rev 1.4   30 Sep 2000 09:36:38   STEVEN
Needed to update status when removing an FSE

   Rev 1.3   23 Aug 2000 16:58:56   STEVEN
now checks to see if in queue before it removes it

   Rev 1.2   12 Jun 2000 16:02:14   STEVEN
BSDU code review

   Rev 1.1   29 May 2000 17:21:34   STEVEN
Re-Design of BSDU for New Fast File Restore

   Rev 1.0   09 May 2000 13:41:12   HUNTER
Initial revision.
