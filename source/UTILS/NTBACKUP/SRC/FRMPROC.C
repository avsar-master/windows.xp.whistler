...
Clean up.
   ...
   Rev 1.27   18 Nov 2000 11:40:02   GLENN
Added ability to move the modeless dialog when the frame is moved.

   Rev 1.26   14 Oct 2000 15:57:36   GLENN
Added some.h

   Rev 1.25   04 Oct 2000 19:37:34   DAVEV
Unicode Awk pass

   Rev 1.24   02 Oct 2000 16:46:58   GLENN
Got rid of goto's and fixed wait cursor - set cursor stuff.

   Rev 1.23   03 Aug 2000 16:41:32   CHUCKB
Ifdef call to schedule function.

   Rev 1.22   15 May 2000 13:32:08   MIKEP
nt pass 2

   Rev 1.21   23 Apr 2000 14:37:10   ROBG
Added last menu ID and state in call to HM_EnterIdle.

   Rev 1.20   22 Apr 2000 17:22:30   GLENN
Added mwwLastMenuID for Menu Help.

   Rev 1.19   20 Apr 2000 13:55:32   GLENN
Removed register declarations.

   Rev 1.18   15 Apr 2000 16:45:08   GLENN
Added MM_ShowMenuStatusHelp() call to show status help only for valid menu IDs.

   Rev 1.17   07 Apr 2000 10:38:00   GLENN
Added a call back to the MUI when there is a system change. (future)

   Rev 1.16   03 Apr 2000 15:04:08   JOHNWT
removed YY set in query close

   Rev 1.15   19 Mar 2000 11:43:38   JOHNWT
fixed QUERYENDSESSION

   Rev 1.14   17 Mar 2000 18:25:40   GLENN
Took out changes put in for the runtime focus problem.

   Rev 1.13   10 Mar 2000 17:01:46   GLENN
Changed paint.

   Rev 1.12   03 Mar 2000 09:44:10   DAVEV
Changes for Nostradamus unique features (OEM_MSOFT)

   Rev 1.11   23 Feb 2000 14:09:42   GLENN
Fixed abort/cancel case of QueryCloseApp.

   Rev 1.10   18 Feb 2000 18:34:32   GLENN
Reset YY flag if user cancelled the abort.

   Rev 1.9   11 Feb 2000 17:30:02   GLENN
Added support for MDI client subclassing.

   Rev 1.8   05 Feb 2000 17:41:14   GLENN
Fixed deinit problem for runtime jobs.

   Rev 1.7   27 Jan 2000 12:46:08   GLENN
Changed dialog support calls.

   Rev 1.6   16 Jan 2000 09:47:26   ROBG
Added SCH_PublishRunningJob call to the message WM_QUERYRUNNINGJOB.

   Rev 1.5   26 Dec 2000 13:46:46   GLENN
Changed show flags to use CDS calls

   Rev 1.4   11 Dec 2000 14:53:56   DAVEV
16/32 bit port - 2nd pass

   Rev 1.3   10 Dec 2000 13:39:08   GLENN
Added dynamic ribbon height support

   Rev 1.2   04 Dec 2000 18:35:34   GLENN
Updated for ALT-F4 termination

   Rev 1.1   02 Dec 2000 17:49:56   DAVEV
16/32 bit Windows port changes

   Rev 1.0   20 Nov 2000 19:33:44   SYSTEM
Initial revision.
