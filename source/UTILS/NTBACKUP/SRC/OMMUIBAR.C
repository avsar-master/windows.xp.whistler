...
Don't allow backup or restore if we're running with the 'NOPOLL' option.
   ...
   Rev 1.11   11 Dec 2000 18:21:32   GLENN
Added dynamic text region sizing based on the length of a text string in a button.

   Rev 1.10   18 Nov 2000 13:01:36   GLENN
Added microsoft 3D button enhancement.

   Rev 1.9   07 Oct 2000 14:11:30   DARRYLP
Precompiled header revisions.

   Rev 1.8   04 Oct 2000 19:39:34   DAVEV
Unicode Awk pass

   Rev 1.7   10 Sep 2000 17:19:04   GLENN
Resolved outstanding state issues for toolbar and menubar.

   Rev 1.6   20 Aug 2000 09:07:54   GLENN
Added catalog button support.

   Rev 1.5   10 Jun 2000 16:14:30   GLENN
Updated according to NT SPEC.

   Rev 1.4   29 May 2000 16:01:18   JOHNWT
PCH updates

   Rev 1.3   15 May 2000 14:55:30   MIKEP
changes

   Rev 1.2   21 Apr 2000 16:53:06   chrish
NT stuff

   Rev 1.1   21 Apr 2000 16:19:46   DAVEV
Added conditionals to include/exclude all code based on definition of OEM_MSOFT

   Rev 1.0   02 Apr 2000 16:22:52   GLENN
Initial revision.
