...
remove /T? kludge for NT
   ...
   Rev 1.33   23 Dec 2000 14:30:42   GLENN
Added /NOSERVERS option.

   Rev 1.32   05 Nov 2000 17:07:40   DAVEV
fix ts

   Rev 1.30   14 Oct 2000 15:50:44   GLENN
Added /ZL debug logging command line support.

   Rev 1.29   07 Oct 2000 15:09:46   DARRYLP
Precompiled header revisions.

   Rev 1.28   06 Oct 2000 15:55:28   DARRYLP
Added new WFW definition.

   Rev 1.27   04 Oct 2000 19:37:42   DAVEV
Unicode Awk pass

   Rev 1.26   28 Sep 2000 16:26:08   GLENN
ifdef's email includes.

   Rev 1.25   22 Sep 2000 15:05:52   DARRYLP
Add calls to determine the validity of WFW Email option.

   Rev 1.24   08 Sep 2000 17:30:50   DARRYLP

   Rev 1.23   08 Sep 2000 17:00:32   DARRYLP

   Rev 1.22   04 Sep 2000 10:35:54   MIKEP
ifdef last change

   Rev 1.21   04 Sep 2000 10:33:16   MIKEP
add support for picking tape drive to command line.

   Rev 1.20   04 Aug 2000 10:04:52   MIKEP
no cats flag

   Rev 1.19   26 Jun 2000 15:52:38   DAVEV


   Rev 1.18   29 May 2000 16:00:20   JOHNWT
PCH updates

   Rev 1.17   09 Apr 2000 11:34:34   GLENN
Added support for exe/resource version stamping.

   Rev 1.16   07 Apr 2000 15:40:30   GLENN
Specified complete resource library path.

   Rev 1.15   07 Apr 2000 10:20:06   GLENN
Change to exe dir before loading library.

   Rev 1.14   02 Apr 2000 15:25:52   GLENN
NT doesn't want to pull resources from .DLL

   Rev 1.13   30 Mar 2000 18:02:56   GLENN
Added support for pulling resources from .DLL

   Rev 1.12   26 Mar 2000 08:51:40   GLENN
Updated.

   Rev 1.11   24 Mar 2000 14:41:36   DAVEV
OEM_MSOFT: Removed Servers windows and associated code

   Rev 1.10   10 Mar 2000 16:48:12   GLENN
Update.

   Rev 1.9   09 Mar 2000 09:36:08   GLENN
Added Easter Egg - red checkmark command line support.

   Rev 1.8   03 Mar 2000 18:45:46   GLENN
Removed setup exe path function and changed the three UI_Init calls to a single UI_InitIntl call.

   Rev 1.7   08 Feb 2000 11:57:02   CARLS
added call to UI_InitThousandChar

   Rev 1.6   04 Feb 2000 13:36:26   GLENN
Changed gb_exe_path to CDS_GetExePath().

   Rev 1.5   10 Jan 2000 16:37:42   JOHNWT
moved set idle text into WM_Init

   Rev 1.4   07 Jan 2000 17:41:32   GLENN
Moved debug command line checking to here

   Rev 1.3   19 Dec 2000 15:25:52   GLENN
Added windows.h

   Rev 1.2   04 Dec 2000 18:44:36   GLENN
Added UI_InitDate and time calls

   Rev 1.1   27 Nov 2000 12:14:32   GLENN
Clean-up.

   Rev 1.0   20 Nov 2000 19:29:54   SYSTEM
Initial revision.
