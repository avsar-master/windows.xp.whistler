...
Allocate a default security descriptor that will be used in CreateObj.
   ...
   Rev 1.11   17 Nov 2000 22:18:22   DAVEV
unicode fixes

   Rev 1.10   11 Nov 2000 09:52:38   GREGG
Unicodeized literals.

   Rev 1.9   10 Nov 2000 08:19:56   STEVEN
removed path and name from dblk now use full_name_ptr

   Rev 1.8   21 Oct 2000 19:41:14   BARRY
Added create/destroy of linked-file queue.

   Rev 1.7   06 Oct 2000 13:25:14   DAVEV
Unicode strlen verification

   Rev 1.6   24 Sep 2000 13:42:00   BARRY
Changes for huge file name support.

   Rev 1.5   12 Aug 2000 17:47:36   STEVEN
fixed bugs at microsoft

   Rev 1.4   25 Jun 2000 11:25:56   STEVEN
assert is backwards

   Rev 1.3   21 May 2000 13:49:20   STEVEN
more long path support

   Rev 1.2   04 May 2000 09:31:26   LORIB
Changes for variable length paths.

   Rev 1.1   05 Feb 2000 15:47:38   STEVEN
added support for FindHandle Queue

   Rev 1.0   17 Jan 2000 17:50:06   STEVEN
Initial revision.
