...
updates from msoft
   ...
   Rev 1.20   07 Dec 2000 14:18:46   STEVEN
updates from msoft

   Rev 1.19   11 Nov 2000 09:52:24   GREGG
Unicodeized literals.

   Rev 1.18   10 Nov 2000 08:20:54   STEVEN
removed path and name from dblk now use full_name_ptr

   Rev 1.17   06 Nov 2000 16:27:44   STEVEN
test unlimited file sizes

   Rev 1.16   19 Oct 2000 17:53:32   BARRY
Was testing directory bit in wrong attribute word.

   Rev 1.15   08 Oct 2000 14:21:34   DAVEV
Unicode strlen verfication

   Rev 1.14   07 Oct 2000 18:00:44   BARRY
Use common function for FindFirst/FindNext to fill out DBLK.

   Rev 1.13   05 Oct 2000 11:57:26   BARRY
Forgot to init huge fname pointer.

   Rev 1.12   24 Sep 2000 13:43:30   BARRY
Changes for huge file name support.

   Rev 1.11   21 Sep 2000 16:51:56   BARRY
Change over from path_complete to name_complete.

   Rev 1.10   17 Aug 2000 15:42:34   STEVEN
fix warnings

   Rev 1.9   20 Jul 2000 10:43:02   STEVEN
backup short file name

   Rev 1.8   09 Jun 2000 15:10:24   BURT
Sync with NT stuff

   Rev 1.6   21 May 2000 13:49:24   STEVEN
more long path support

   Rev 1.5   04 May 2000 09:32:12   LORIB
Changes for variable length paths.

   Rev 1.4   12 Mar 2000 15:50:16   STEVEN
64 bit changes

   Rev 1.3   28 Feb 2000 13:03:42   STEVEN
step one for varible length paths

   Rev 1.2   12 Feb 2000 10:46:52   STEVEN
fix warning

   Rev 1.1   05 Feb 2000 15:47:40   STEVEN
added support for FindHandle Queue

   Rev 1.0   17 Jan 2000 17:50:08   STEVEN
Initial revision.
