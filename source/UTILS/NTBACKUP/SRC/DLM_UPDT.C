...
the file. I just checked it in.
   ...
   Rev 1.25   11 Dec 2000 18:28:46   GLENN
Added selection frame rectangle support based on horizontal extent of a list box.

   Rev 1.24   11 Nov 2000 16:30:00   DAVEV
UNICODE: remove compile warnings

   Rev 1.23   01 Nov 2000 15:47:14   DAVEV
Unicode changes

   Rev 1.22   14 Oct 2000 15:48:28   GLENN
Added Selection Framing Support for List Boxes without the FOCUS.

   Rev 1.21   07 Oct 2000 13:48:34   DARRYLP
Precompiled header revisions.

   Rev 1.20   04 Oct 2000 19:33:18   DAVEV
Unicode Awk pass

   Rev 1.19   29 Jul 2000 14:14:14   GLENN
ChuckB checked in after NT fixes.

   Rev 1.18   11 Jun 2000 10:19:52   JOHNWT
fixed syntax error

   Rev 1.17   10 Jun 2000 11:05:10   STEVEN
NULL would not compile for mips

   Rev 1.16   15 May 2000 13:32:12   MIKEP
nt pass 2

   Rev 1.15   19 Mar 2000 11:08:56   ROBG
Added logic when adding an item to call DLM_SetHorizontalExt.

   Rev 1.14   19 Mar 2000 10:44:00   ROBG
Corrected problem with dhListItem to be initialized to NULL.

   Rev 1.13   17 Mar 2000 16:19:42   ROBG
Added logic to send out a HORIZONTALEXTENT

   Rev 1.12   03 Mar 2000 18:21:44   GLENN
Put in error handling.

   Rev 1.11   07 Feb 2000 16:09:58   STEVEN
fix casting of errors from sendmessage to WORD

   Rev 1.10   06 Feb 2000 18:34:28   STEVEN
wStatus should be INT not WORD

   Rev 1.9   06 Feb 2000 11:00:50   ROBG
Changed DLM_UPDATELIST to use RectVisible call to find the bottom
item displayed in the listbox.

   Rev 1.8   04 Feb 2000 16:08:08   STEVEN
various bug fixes for NT

   Rev 1.7   22 Jan 2000 12:29:56   GLENN
Clean up.

   Rev 1.6   15 Jan 2000 15:15:44   DAVEV
16/32 bit port-2nd pass

   Rev 1.5   07 Jan 2000 10:11:24   ROBG
Changes to support variable-width multicolumn listboxes.

   Rev 1.4   26 Dec 2000 17:23:48   ROBG
New and Improved.

   Rev 1.3   06 Dec 2000 17:31:02   GLENN
Added code to allow adding a list item with a NULL dhStartItem passed

   Rev 1.2   02 Dec 2000 10:40:38   ROBG
Added logic to clear out a flat listbox in a DLM_WMUPDATELIST message.

   Rev 1.1   26 Nov 2000 16:26:32   ROBG
Added validity checks for the window handles, info structure, and the
dlm display header.

   Rev 1.0   20 Nov 2000 19:24:04   SYSTEM
Initial revision.
