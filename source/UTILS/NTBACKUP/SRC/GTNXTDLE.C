...
added stream_id to error message
   ...
   Rev 1.25   24 Nov 2000 16:39:42   STEVEN
fix loose name structures

   Rev 1.24   13 Nov 2000 10:06:44   STEVEN
UNICODE   !

   Rev 1.23   11 Nov 2000 22:49:02   STEVEN
This is Gregg checking files in for Steve.  I don't know what he did!

   Rev 1.22   02 Oct 2000 16:28:54   BARRY
Fixes so we don't stop processing a directory when a GetInfo fails.

   Rev 1.21   23 Jul 2000 16:44:12   STEVEN
fix warnings

   Rev 1.20   23 Jul 2000 11:58:16   STEVEN
fix warnings

   Rev 1.19   09 Jul 2000 13:59:46   STEVEN
BE_Unicode updates

   Rev 1.18   26 May 2000 15:37:14   TIMN
LP_InitPDL hard coded for ANSI data

   Rev 1.17   21 May 2000 17:16:58   TIMN
Convert CHARs to INT8

   Rev 1.16   13 May 2000 12:39:10   TIMN
Added TEXT() macro to literals, but not msassert literals

   Rev 1.15   13 May 2000 12:01:12   STEVEN
40 format changes

   Rev 1.14   16 Mar 2000 16:20:24   STEVEN
added support to release DBLK for 40 format

   Rev 1.13   10 Mar 2000 16:04:38   STEVEN
make lp_add_a_dir faster

   Rev 1.12   28 Feb 2000 10:37:10   GREGG
Steve fixed bug involving backing up Image and nonimage sets from one BSD list.

   Rev 1.11   16 Jan 2000 15:11:48   STEVEN
fix warnings for WIN32

   Rev 1.10   14 Nov 2000 17:18:50   STEVEN
was incorrectly adding parent dirs

   Rev 1.9   03 Sep 2000 15:46:08   STEVEN
LP_PathComp() was returning >0 & <0 not +1 & -1

   Rev 1.8   27 Aug 2000 10:18:32   STEVEN
was only backing up bindery

   Rev 1.7   23 Aug 2000 16:23:08   DON
was never calling get info

   Rev 1.6   15 Aug 2000 13:46:18   STEVEN
special blocks returned as NULL

   Rev 1.5   01 Aug 2000 17:07:56   STEVEN
We backed up directories multiple times

   Rev 1.4   21 Jun 2000 13:51:38   STEVEN
new config unit

   Rev 1.3   30 May 2000 09:13:26   STEVEN
bsdu_err.h no longer exists

   Rev 1.2   23 May 2000 12:50:58   STEVEN
Changes due to changes from new BSDU

   Rev 1.1   14 May 2000 14:28:04   DAVIDH
Initialized 'pid' -- also cleared up Watcom compiler warning.

   Rev 1.0   09 May 2000 13:39:46   HUNTER
Initial revision.
