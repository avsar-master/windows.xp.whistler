...
unicode fix LPSTR->BYTE_PTR
   ...
   Rev 1.33   11 Dec 2000 18:25:36   GLENN
Added selection frame rectangle support based on horizontal extent of a list box.

   Rev 1.32   18 Nov 2000 13:19:42   GLENN
Fixed highlight and emply list focus problems.

   Rev 1.31   01 Nov 2000 15:46:02   DAVEV
Unicode changes

   Rev 1.30   14 Oct 2000 15:48:40   GLENN
Added Selection Framing Support for List Boxes without the FOCUS.

   Rev 1.29   07 Oct 2000 13:48:54   DARRYLP
Precompiled header revisions.

   Rev 1.28   04 Oct 2000 19:32:52   DAVEV
Unicode Awk pass

   Rev 1.27   08 Sep 2000 10:12:30   ROBG
