...
Added pshhelp to handle the help button.
   ...
   Rev 1.8   23 Dec 2000 13:37:54   GLENN
Added FAT lower case font support.

   Rev 1.7   22 Dec 2000 13:19:54   GLENN
Placed size limits on font and now using ANSI fonts only.

   Rev 1.6   14 Oct 2000 15:53:28   GLENN
Added Font selection to Config and INI.

   Rev 1.5   07 Oct 2000 15:12:12   DARRYLP
Precompiled header revisions.

   Rev 1.4   04 Oct 2000 19:37:28   DAVEV
Unicode Awk pass

   Rev 1.3   29 Sep 2000 15:12:50   GLENN
Changed and ifdef from OEM_MSOFT to OS_WIN32.

   Rev 1.2   09 Sep 2000 17:01:22   GLENN
Updated NEW LOOK font stuff for BIMINI and NT.

   Rev 1.1   04 Sep 2000 17:45:32   GLENN
Working on changing to support the lower case box.

   Rev 1.0   02 Sep 2000 16:12:54   GLENN
Initial revision.
