...
added stream_id to error message
   ...
   Rev 1.7   13 May 2000 12:29:00   TIMN
Removed used references to tapename and backup_set_name for TPOS structs.

   Rev 1.6   18 Sep 2000 09:59:52   GREGG
TF_RetensionChannel now called for reten and erase.

   Rev 1.5   24 Jul 2000 15:53:42   DAVIDH
Cleared up warnings for Watcom.

   Rev 1.4   21 Jun 2000 09:42:32   STEVEN
new config unit

   Rev 1.3   30 May 2000 09:10:34   STEVEN
bsdu_err.h no longer exists

   Rev 1.2   24 May 2000 13:16:46   STEVEN
updates from BSDU redesign

   Rev 1.1   15 May 2000 09:50:10   DAVIDH
Cleared up type mismatch warning found by Watcom compiler.


   Rev 1.0   09 May 2000 13:38:06   HUNTER
Initial revision.
