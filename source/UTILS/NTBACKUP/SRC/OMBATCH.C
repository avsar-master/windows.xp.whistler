...
fix batch logfile and path
   ...
   Rev 1.13   30 Nov 2000 15:41:16   DAVEV
Changed /D to backup set description and use default tape label text

   Rev 1.12   01 Nov 2000 16:03:56   DAVEV
Unicode changes

   Rev 1.11   15 Oct 2000 13:02:32   DAVEV
fix problem with batch mode /T option

   Rev 1.10   07 Oct 2000 14:13:46   DARRYLP
Precompiled header revisions.

   Rev 1.9   04 Oct 2000 19:39:28   DAVEV
Unicode Awk pass

   Rev 1.8   30 Sep 2000 10:41:44   DAVEV
Unicode strlen verification, MikeP's chgs from MS

   Rev 1.7   17 Sep 2000 17:39:46   DAVEV
minor fix (strsiz->strsize)

   Rev 1.6   17 Sep 2000 15:51:30   DAVEV
UNICODE modifications: strlen usage check

   Rev 1.5   24 Jul 2000 13:31:34   davev
Removed warnings when building for NT

   Rev 1.4   08 Jul 2000 15:32:42   STEVEN
Unicode BE changes

   Rev 1.3   29 May 2000 16:00:58   JOHNWT
PCH updates

   Rev 1.2   18 May 2000 15:28:08   DAVEV
Created OEM_StrDup and replaced all calls to strdup() wiht it

   Rev 1.1   18 May 2000 13:47:58   MIKEP
i don't know

   Rev 1.0   11 May 2000 14:28:42   DAVEV
Initial revision.
