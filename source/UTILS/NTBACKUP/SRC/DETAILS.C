...
infinite loop problem.
   ...
   Rev 1.32   31 Dec 2000 12:15:42   MIKEP
use resources for strings

   Rev 1.31   23 Dec 2000 12:42:18   MIKEP
half done fix

   Rev 1.30   14 Dec 2000 12:17:48   DAVEV
Enabled for Unicode compile

   Rev 1.29   17 Nov 2000 21:21:26   DAVEV
unicode fixes

   Rev 1.28   05 Nov 2000 16:59:48   DAVEV
fix ts

   Rev 1.26   07 Oct 2000 14:52:06   DARRYLP
Precompiled header revisions.

   Rev 1.25   04 Oct 2000 19:32:40   DAVEV
Unicode Awk pass

   Rev 1.24   17 Aug 2000 13:04:44   DAVEV
MikeP's changes at Microsoft

   Rev 1.23   28 Jul 2000 14:50:32   CHUCKB
Fixed warnings for NT.

   Rev 1.22   29 May 2000 10:14:28   MIKEP
total to display change

   Rev 1.21   21 May 2000 19:25:10   MIKEP
fixes

   Rev 1.20   19 May 2000 09:26:20   MIKEP
mo changes

   Rev 1.19   14 May 2000 17:23:58   MIKEP
nt pass 2

   Rev 1.18   11 May 2000 19:45:02   STEVEN
...
CHAR      delim)            /* Path delimiter character */
{
     ...
     if( (INT16)strlen( path_ptr ) >= len ) {
          ...
          // quick kludge for macixposh paths.
