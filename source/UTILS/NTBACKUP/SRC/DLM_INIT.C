...
of a font for a listbox.
   ...
   Rev 1.23   01 Nov 2000 15:46:38   DAVEV
Unicode changes

   Rev 1.21   16 Oct 2000 15:53:44   GLENN
Changed default small bitmap back to IDRBM_EXE - closer to the text now.  Also naming cleanup.

   Rev 1.20   07 Oct 2000 13:47:32   DARRYLP
Precompiled header revisions.

   Rev 1.19   04 Oct 2000 19:32:58   DAVEV
Unicode Awk pass

   Rev 1.18   28 Sep 2000 17:02:32   GLENN
MikeP changes - casting stuff.

   Rev 1.17   09 Sep 2000 10:28:10   GLENN
Updated the max size of the folder bitmap.

   Rev 1.16   08 Sep 2000 11:46:52   ROBG
Changed cxPos from USHORT to short.

   Rev 1.15   08 Sep 2000 10:08:18   ROBG
Modified to solve the clipping bitmap problem.

   Rev 1.14   04 Sep 2000 17:48:16   GLENN
Fixed bitmap display clipping.

   Rev 1.13   03 Sep 2000 15:30:48   ROBG
Added conditionals for OS_WIN32.

   Rev 1.12   21 Aug 2000 16:00:36   ROBG
Changes to support change of font.

   Rev 1.11   19 Aug 2000 14:32:34   ROBG
Make modifications to use actual bitmap sizes and for the listboxes
to be shorter and more compact.

   Rev 1.10   21 May 2000 10:53:42   MIKEP
fix my typo

   Rev 1.9   19 May 2000 13:01:50   MIKEP
mips changes

   Rev 1.8   15 May 2000 13:35:28   MIKEP
nt pass 2

   Rev 1.7   14 May 2000 18:37:02   STEVEN
40Format changes

   Rev 1.6   29 Jan 2000 18:01:14   DAVEV


 * No changes

   Rev 1.5   10 Jan 2000 13:58:40   DAVEV
16/32 bit port-2nd pass

   Rev 1.4   26 Dec 2000 17:24:22   ROBG
New and Improved.

   Rev 1.3   27 Nov 2000 12:09:54   ROBG
Modified parameters to DLM_DispListTerm and logic as well.

   Rev 1.2   27 Nov 2000 09:27:46   ROBG
Modified DLM_DispListTerm to support validity checks and
deallocating the memory in the display list header and buffer.

   Rev 1.1   26 Nov 2000 13:31:36   ROBG
Added validity checks for the window handle, info structure, and the
dlm display header.

   Rev 1.0   20 Nov 2000 19:16:34   SYSTEM
Initial revision.
