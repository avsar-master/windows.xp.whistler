...
bug fixes
   ...
   Rev 1.17   07 Dec 2000 14:16:28   STEVEN
updates from msoft

   Rev 1.16   25 Nov 2000 16:42:16   BARRY
Fix MakeTempFile and restore over active files.

   Rev 1.15   11 Nov 2000 09:54:08   GREGG
Unicodeized literals.

   Rev 1.14   10 Nov 2000 08:19:52   STEVEN
removed path and name from dblk now use full_name_ptr

   Rev 1.13   29 Oct 2000 16:51:08   BARRY
Do nothing for linked files.

   Rev 1.12   20 Oct 2000 14:22:34   STEVEN
temp names should not have .TMP extension

   Rev 1.10   07 Oct 2000 15:54:50   DAVEV
unicode strlen verification

   Rev 1.9   23 Sep 2000 15:06:06   BARRY
Changes for huge file names.

   Rev 1.8   18 Sep 2000 14:13:38   BARRY
Added suport for restore over existing files.

   Rev 1.7   16 Sep 2000 08:54:36   STEVEN
fix restore to redirected dir

   Rev 1.5   09 Jun 2000 15:37:16   BURT
Sync with NT stuff fix Dir exist bug

   Rev 1.4   22 May 2000 16:05:48   STEVEN
 

   Rev 1.3   21 May 2000 13:49:20   STEVEN
more long path support

   Rev 1.2   04 May 2000 09:29:32   LORIB
Changes for variable length paths.

   Rev 1.1   28 Feb 2000 13:03:40   STEVEN
step one for varible length paths

   Rev 1.0   10 Feb 2000 16:27:08   STEVEN
Initial revision.
