...
enable C++
   ...
   Rev 1.8   11 Nov 2000 09:52:26   GREGG
Unicodeized literals.

   Rev 1.7   10 Nov 2000 08:17:48   STEVEN
move os path and os name into common part of dblk

   Rev 1.6   16 Mar 2000 10:07:28   LORIB
Added InitQueue() for path_q.

   Rev 1.5   09 Jan 2000 09:27:38   STEVEN
remove detnet.h from header list -- NOT USED

   Rev 1.4   18 Aug 2000 15:55:40   BARRY
ret_val not initialized in FS_DetachDLE().

   Rev 1.3   06 Aug 2000 18:26:36   DON
added NLM File System support

   Rev 1.2   21 Jun 2000 13:34:04   BARRY
Changes for new config.

   Rev 1.1   03 Jun 2000 13:26:22   BARRY
Remove product defines from conditional compilation.

   Rev 1.0   09 May 2000 13:41:44   HUNTER
Initial revision.
