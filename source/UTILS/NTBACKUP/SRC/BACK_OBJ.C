...
added stream_id to error message
   ...
   Rev 1.22   28 Oct 2000 16:41:10   STEVEN
send end for CFDB

   Rev 1.21   26 Oct 2000 10:53:40   STEVEN
allways read even if buffer size= 0

   Rev 1.20   05 Oct 2000 10:29:18   STEVEN
remove TotalSize

   Rev 1.19   16 Sep 2000 16:55:02   STEVEN
added support for stream info struct for Tpfmt

   Rev 1.18   01 Sep 2000 16:11:56   STEVEN
added stream headers to fsys API

   Rev 1.17   23 Jul 2000 09:06:24   STEVEN
fix warnings

   Rev 1.16   29 May 2000 13:57:40   STEVEN
if EOF on var length then SUCCESS

   Rev 1.15   28 May 2000 16:36:06   TIMN
Changed CHAR to INT8

   Rev 1.14   05 May 2000 17:19:18   STEVEN
fixed typos and misc bugs

   Rev 1.13   16 Mar 2000 16:48:08   STEVEN
more 64 bit support for format 40

   Rev 1.12   13 Mar 2000 09:23:34   STEVEN
4.0 tape format 64 bit

   Rev 1.11   16 Jan 2000 15:45:18   STEVEN
fix warnings for WIN32

   Rev 1.10   12 Dec 2000 10:00:42   STEVEN
change read to FS_READ

   Rev 1.9   21 Nov 2000 19:17:14   BARRY
Got rid of Steve's temporary FS_OBJECT_CORRUPT #define.

   Rev 1.8   07 Nov 2000 12:42:30   STEVEN
TRYCYCLE - added support for varible length files

   Rev 1.7   21 Jun 2000 09:28:10   STEVEN
new config unit

   Rev 1.6   17 Jun 2000 16:28:08   STEVEN
LP_PadData is called from lptools.c so it was moved to there

   Rev 1.5   30 May 2000 09:11:58   STEVEN
bsdu_err.h no longer exists

   Rev 1.4   29 May 2000 14:55:04   DAVIDH
Corrected assignment statement using '==' instead of '='.

   Rev 1.3   24 May 2000 14:42:18   STEVEN
complete changes for new getnext

   Rev 1.2   23 May 2000 16:19:14   STEVEN
update for BSD redesign

   Rev 1.1   23 May 2000 16:03:02   BARRY
Cleaned up code per first LOOPS code review.

   Rev 1.0   09 May 2000 13:39:16   HUNTER
Initial revision.
