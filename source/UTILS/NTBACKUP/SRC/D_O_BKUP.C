...
defined out InitiallyActivateRegistryBox for non NT
   ...
   Rev 1.70   15 Dec 2000 11:19:50   chrish
Corrected logic to handle possible NULL returned from
GetCurrentMachineNameUserName routine.

   Rev 1.69   14 Dec 2000 12:17:00   DAVEV
Enabled for Unicode compile

   Rev 1.68   16 Nov 2000 15:15:06   chrish
Minor changes to clean-up warning messages on build.

   Rev 1.68   16 Nov 2000 12:23:46   chrish
Minor changes to clean-up warning messages on buildin.

   Rev 1.67   13 Nov 2000 17:24:10   chrish
Added backup for Secure Tape and change for registry check box - NT.

   Rev 1.66   11 Nov 2000 16:32:00   DAVEV
UNICODE: remove compile warnings

   Rev 1.65   01 Nov 2000 15:55:02   DAVEV
Unicode changes

   Rev 1.64   29 Oct 2000 16:41:30   STEVEN
added rules for default on registry

   Rev 1.63   27 Oct 2000 17:42:14   STEVEN
enable registry support

   Rev 1.62   21 Oct 2000 17:12:44   MIKEP
last time

   Rev 1.61   21 Oct 2000 13:42:16   MIKEP
fix steve changes

   Rev 1.60   21 Oct 2000 13:39:46   MIKEP
fix steve changes

   Rev 1.59   21 Oct 2000 12:46:38   STEVEN
added support for registry

   Rev 1.58   07 Oct 2000 13:37:38   DARRYLP
Precompiled header revisions.

   Rev 1.57   04 Oct 2000 19:36:18   DAVEV
Unicode Awk pass

   Rev 1.56   30 Sep 2000 10:38:58   DAVEV
Unicode strlen verification, MikeP's chgs from MS

   Rev 1.55   17 Sep 2000 16:54:38   STEVEN
added support for daily backup

   Rev 1.54   17 Sep 2000 15:49:54   DAVEV
UNICODE modifications: strlen usage check

   Rev 1.53   09 Sep 2000 10:08:58   CHUCKB
Changed ifdef's to include browse features used only in Nostrodamus.

   Rev 1.51   03 Sep 2000 10:43:38   CHUCKB
Took out some unreferenced locals.

   Rev 1.50   19 Aug 2000 14:29:18   CHUCKB
Added new stuff for NT.

   Rev 1.49   28 Jul 2000 15:04:52   CHUCKB
Fixed warnings for NT.

   Rev 1.48   08 Jul 2000 15:35:46   STEVEN
Unicode BE changes

   Rev 1.47   29 Jun 2000 09:05:48   CARLS
added changes for TDEMO

   Rev 1.46   26 Jun 2000 15:52:52   DAVEV


   Rev 1.45   18 Jun 2000 11:25:36   DAVEV
OEM_MSOFT:fixed logging bug

   Rev 1.44   11 Jun 2000 15:22:08   DAVEV
do not display status message 'Examine <log file> for more info' if not logging

   Rev 1.43   05 Jun 2000 12:42:42   DAVEV
OEM_MSOFT: Init log file name to default

   Rev 1.42   04 Jun 2000 14:56:56   davev
OEM_MSOFT: Kludge-disable 'Restrict Access..' checkbox in dialog

   Rev 1.41   14 May 2000 16:37:22   MIKEP
NT pass 2

   Rev 1.40   12 May 2000 15:52:58   DAVEV
