...
added stream_id to error message
   ...
   Rev 1.11   10 Nov 2000 17:28:32   STEVEN
verify buffer off by factor of 1K

   Rev 1.10   28 Oct 2000 15:05:42   STEVEN
very buffer is buffer size

   Rev 1.9   24 Feb 2000 10:00:52   GREGG
Call TF_OpenTape at beginning of loop, Open/Close Set in loop, CloseTape at end.

   Rev 1.8   04 Feb 2000 21:41:14   GREGG
Changed parameters in calls to TF_AllocateTapeBuffers and TF_FreeTapeBuffers.

   Rev 1.7   16 Jan 2000 15:52:54   STEVEN
fix warnings for WIN32

   Rev 1.6   13 Dec 2000 15:26:06   GREGG
SKATEBOARD - Initial Integration.

   Rev 1.5   06 Nov 2000 19:14:00   GREGG
BIGWHEEL - 8200sx - Get cat_enabled from the BE config.

   Rev 1.4   21 Jun 2000 08:49:28   STEVEN
new config unit

   Rev 1.3   30 May 2000 09:11:24   STEVEN
bsdu_err.h no longer exists

   Rev 1.2   28 May 2000 10:13:48   STEVEN
use MAYN_MEM instead of MAYN_OS2

   Rev 1.1   24 May 2000 13:18:48   STEVEN
updates from BSDU redesign

   Rev 1.0   09 May 2000 13:38:00   HUNTER
Initial revision.
