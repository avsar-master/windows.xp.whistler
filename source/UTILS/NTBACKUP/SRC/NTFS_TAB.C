...
For NTBACKUP use real EnumSpecial files; for others, don't enum reg files.
   ...
   Rev 1.7   21 Oct 2000 11:53:04   STEVEN
added SpecialExclude

   Rev 1.6   14 Oct 2000 16:33:22   STEVEN
fix typos

   Rev 1.5   22 Sep 2000 15:36:20   BARRY
Got rid of GetTotalSizeDBLK.

   Rev 1.4   03 Sep 2000 17:06:32   STEVEN
add support for volume name

   Rev 1.3   22 May 2000 16:05:16   STEVEN
 

   Rev 1.2   12 Mar 2000 15:50:08   STEVEN
64 bit changes

   Rev 1.1   13 Feb 2000 10:44:34   STEVEN
fix stuff

   Rev 1.0   20 Jan 2000 14:48:20   STEVEN
Initial revision.
**/
/* begin include list */
#include <windows.h>
