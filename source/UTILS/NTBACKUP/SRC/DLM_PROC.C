...
fixes from mikep and MSOFT
   ...
   Rev 1.21   11 Dec 2000 18:25:00   GLENN
Added selection frame rectangle support based on horizontal extent of a list box.

   Rev 1.20   07 Oct 2000 13:47:10   DARRYLP
Precompiled header revisions.

   Rev 1.19   04 Oct 2000 19:33:08   DAVEV
Unicode Awk pass

   Rev 1.18   09 Sep 2000 16:13:26   GLENN
Updated castings for MikeP (NT).

   Rev 1.17   08 Sep 2000 11:52:28   ROBG
Changed cxPos, cyPos from USHORT to short.

   Rev 1.16   29 Jul 2000 14:14:00   GLENN
ChuckB checked in after NT fixes.

   Rev 1.15   10 Jun 2000 11:02:16   STEVEN
NULL would not compile for mips

   Rev 1.14   15 May 2000 13:32:44   MIKEP
nt pass 2

   Rev 1.13   20 Mar 2000 09:30:34   ROBG
Added logic in DLM_SetHorizontalExtent to set maximum extent value in
DLM header area.

   Rev 1.12   19 Mar 2000 09:21:32   ROBG
Added DLM_SetHorizontalExt to set Horz scroll bar

   Rev 1.11   03 Mar 2000 18:21:16   GLENN
Put in error handling.

   Rev 1.10   07 Feb 2000 16:09:36   STEVEN
fix casting of errors from sendmessage to WORD

   Rev 1.9   06 Feb 2000 12:53:16   STEVEN
fix typo in NT ifdef"

   Rev 1.8   04 Feb 2000 16:07:36   STEVEN
various bug fixes for NT

   Rev 1.7   15 Jan 2000 15:16:10   DAVEV
16/32 bit port-2nd pass

   Rev 1.6   26 Dec 2000 17:21:04   ROBG
New and Improved.

   Rev 1.5   10 Dec 2000 12:58:24   GLENN
