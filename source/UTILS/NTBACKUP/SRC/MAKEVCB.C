...
Added Unicode header to resolve link errors
   ...
   Rev 1.11   26 Oct 2000 18:10:06   STEVEN
added continue bit

   Rev 1.10   21 Oct 2000 10:39:46   GREGG
Changed 'set_catalog_level' to 'on_tape_cat_level'.

   Rev 1.9   20 Oct 2000 15:51:22   STEVEN
added support for otc / catalog interface through DBLK

   Rev 1.8   14 Oct 2000 14:20:42   STEVEN
fix typos

   Rev 1.7   14 Oct 2000 11:56:22   STEVEN
add translations for unicode strings

   Rev 1.6   05 Oct 2000 17:05:56   DAVEV
Unicode strlen verification

   Rev 1.5   18 Aug 2000 10:25:12   STEVEN
fix warnings

   Rev 1.4   13 Jan 2000 18:46:02   STEVEN
changes for WIN32 compile

   Rev 1.3   07 Jan 2000 11:59:32   STEVEN
move common functions to tables

   Rev 1.2   06 Aug 2000 18:29:48   DON
added NLM File System support

   Rev 1.1   03 Jun 2000 13:26:56   BARRY
Remove product defines from conditional compilation.

   Rev 1.0   09 May 2000 13:33:46   HUNTER
Initial revision.
