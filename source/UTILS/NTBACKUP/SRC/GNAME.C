...
Added header to resolve linking errors
   ...
   Rev 1.15   29 Dec 2000 13:32:32   DAVEV
unicode fixes (3)

   Rev 1.14   07 Dec 2000 14:55:18   STEVEN
Microsoft updates

   Rev 1.13   02 Dec 2000 10:47:10   CHUCKB
Took out unreferenced local.

   Rev 1.12   11 Nov 2000 22:49:06   STEVEN
This is Gregg checking files in for Steve.  I don't know what he did!

   Rev 1.10   11 Nov 2000 10:43:40   STEVEN
fix os_name for gen_fs

   Rev 1.9   06 Oct 2000 13:24:38   DAVEV
Unicode strlen verification

   Rev 1.8   25 Sep 2000 10:24:28   CHUCKB
Added sinfo to GEN_CompleteBLK().

   Rev 1.7   01 Sep 2000 11:25:00   TIMN
Changed os_id and os_ver back

   Rev 1.6   12 Aug 2000 14:57:26   BARRY
Changed default os_id and os_ver.

   Rev 1.5   05 Aug 2000 11:01:30   DON
removed warnings

   Rev 1.4   15 May 2000 16:39:04   STEVEN
temp add block complete functions

   Rev 1.3   05 May 2000 17:19:20   STEVEN
fixed typos and misc bugs

   Rev 1.2   03 Mar 2000 16:16:42   STEVEN
added function for initializeing defalut make block

   Rev 1.1   16 Dec 2000 17:26:48   STEVEN
move common functions to tables

   Rev 1.0   10 Dec 2000 09:06:54   STEVEN
Initial revision.
