/** Copyright (C) Maynard Electronics, An Archive Company. 2000
...
fix read of unicode tape with ansi app
   ...
   Rev 1.5   12 Nov 2000 11:00:34   DAVEV
transparent unicode support fixes, comment out strlwr, strupr

   Rev 1.4   12 Nov 2000 10:44:54   BARRY
Change mapAnsiToUnic to work on strings in place.

   Rev 1.3   23 Jul 2000 08:32:44   STEVEN
fix warnings

   Rev 1.2   17 Jul 2000 14:58:56   STEVEN
fix NT bugs

   Rev 1.0   10 Jun 2000 16:11:10   TIMN
