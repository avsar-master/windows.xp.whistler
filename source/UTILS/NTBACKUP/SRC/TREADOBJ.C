...
added support for new error messages and backup priviladge
   ...
   Rev 1.27   07 Dec 2000 14:18:00   STEVEN
updates from msoft

   Rev 1.26   24 Nov 2000 11:02:02   BARRY
Changes to make LINK streams null-impregnated.

   Rev 1.25   17 Nov 2000 22:19:24   DAVEV
unicode fixes

   Rev 1.24   11 Nov 2000 09:57:08   GREGG
Changed INT8_PTR to CHAR_PTR for unicode compliance.

   Rev 1.23   10 Nov 2000 08:18:50   STEVEN
removed path and name from dblk now use full_name_ptr

   Rev 1.22   06 Nov 2000 15:49:42   STEVEN
test write of path in stream

   Rev 1.21   02 Nov 2000 11:18:04   BARRY
Don't back up path streams with leading null.

   Rev 1.20   21 Oct 2000 19:44:06   BARRY
Backup references to original on linked files.

   Rev 1.19   19 Oct 2000 17:54:04   BARRY
Made changes for latest incarnation of stream header functionality.

   Rev 1.18   16 Oct 2000 16:42:08   STEVEN
fix streams to UINT64

   Rev 1.17   14 Oct 2000 14:37:06   BARRY
Fixes for alternate data streams.

   Rev 1.16   09 Oct 2000 14:31:26   BARRY
Path-in-stream changes.

   Rev 1.14   06 Oct 2000 11:12:30   BARRY
BackupRead stream size corrections; bug fixes in stream header redesign.

   Rev 1.13   24 Sep 2000 13:24:04   BARRY
Changes for huge file name support.

   Rev 1.12   18 Sep 2000 15:37:32   BARRY
Changes for Stream Header redesign.

   Rev 1.11   04 Sep 2000 17:14:58   STEVEN
fix warnings

   Rev 1.10   02 Sep 2000 07:48:32   STEVEN
fix typo

   Rev 1.9   01 Sep 2000 16:10:48   STEVEN
added stream headers to fsys API

   Rev 1.8   17 Aug 2000 16:21:06   STEVEN
fix warnings

   Rev 1.7   12 Aug 2000 17:47:52   STEVEN
fixed bugs at microsoft

   Rev 1.6   23 Jul 2000 13:13:12   STEVEN
fix warnings

   Rev 1.5   29 May 2000 13:45:22   STEVEN
fixes

   Rev 1.4   22 May 2000 16:05:44   STEVEN
 

   Rev 1.3   21 May 2000 13:49:16   STEVEN
more long path support

   Rev 1.2   26 Feb 2000 12:35:08   STEVEN
retval not initialized

   Rev 1.1   12 Feb 2000 13:00:38   STEVEN
fix buffer size passed in

   Rev 1.0   10 Feb 2000 16:57:46   STEVEN
Initial revision.
