...
Copyright(c) Maynard Electronics, Inc. 1984-89
   ...
   Rev 1.8   23 Mar 2000 14:27:14   GREGG
Set rewind_sdrv in open info struct from same in getvcb struct.

   Rev 1.7   28 Feb 2000 18:08:44   GREGG
Added calls to TF_OpenTape and TF_CloseTape.

   Rev 1.6   19 Feb 2000 16:02:28   GREGG
Added vcb_only parameter to call to TF_OpenSet.

   Rev 1.5   17 Oct 2000 01:57:52   ED
BIGWHEEL - 8200sx - Initial integration.

   Rev 1.4   22 Jul 2000 10:20:32   DAVIDH
Corrected type mismatch warnings.

   Rev 1.3   21 Jun 2000 13:51:16   STEVEN
new config unit

   Rev 1.2   23 May 2000 12:51:42   STEVEN
Conversion to ansii prototypes

   Rev 1.1   14 May 2000 14:13:42   DAVIDH
Resolved pointer mismatch warning for Watcom compiler

   Rev 1.0   09 May 2000 13:39:26   HUNTER
Initial revision.
