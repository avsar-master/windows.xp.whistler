...
Added RIB_UpPosition to support WIN32 applications.
   ...
   Rev 1.22   18 Nov 2000 11:42:02   GLENN
Added new feature to emulate Microsoft's 3D highlighting.

   Rev 1.21   10 Nov 2000 07:50:36   GLENN
Now clearing the current item in the right place. (found under NT)

   Rev 1.20   01 Nov 2000 16:06:38   DAVEV
Unicode changes

   Rev 1.19   07 Oct 2000 15:10:10   DARRYLP
Precompiled header revisions.

   Rev 1.18   04 Oct 2000 19:40:18   DAVEV
Unicode Awk pass

   Rev 1.17   10 Jun 2000 16:21:08   GLENN
Took out the extra line at the top of the ribbon.

   Rev 1.16   29 May 2000 16:00:32   JOHNWT
PCH updates

   Rev 1.15   20 Apr 2000 14:00:04   GLENN
Fixed status line help problem.  Renamed global variables to module wides.

   Rev 1.14   07 Apr 2000 10:39:38   GLENN
Using global ribbon font instead of font passed in rib item structure due to sys change problems.

   Rev 1.13   02 Apr 2000 16:18:54   GLENN
Put the new changes into the spinner.

   Rev 1.12   02 Apr 2000 15:29:02   GLENN
Added bitmap and text rectangles for buttons - drawing is faster.  Supports NT better now.

   Rev 1.11   23 Feb 2000 13:49:32   GLENN
Added IsWindow calls to keyboard functions.

   Rev 1.10   11 Feb 2000 17:27:46   GLENN
Fixed point stuff.

   Rev 1.9   04 Feb 2000 16:37:36   STEVEN
now use macro to convert MP2 to POINT

   Rev 1.8   04 Feb 2000 16:21:20   GLENN
Working on auto calc size for ribbon.

   Rev 1.7   29 Jan 2000 18:05:06   DAVEV


 * No changes

   Rev 1.6   19 Dec 2000 15:25:34   GLENN
Added windows.h

   Rev 1.5   12 Dec 2000 17:10:30   DAVEV
16/32 bit port -2nd pass

   Rev 1.4   10 Dec 2000 14:37:44   GLENN
Added RIB_AutoCalcSize() stuff

   Rev 1.3   05 Dec 2000 17:51:46   GLENN
Changed active window handle to macro

   Rev 1.2   02 Dec 2000 17:50:44   DAVEV
16/32 bit Windows port changes

   Rev 1.1   27 Nov 2000 12:07:52   GLENN
Added code to prevent messages if the button is already down and it is
a positional button.

   Rev 1.0   20 Nov 2000 19:28:36   SYSTEM
Initial revision.
