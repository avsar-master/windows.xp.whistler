...
Changed FS_RMFS to FS_GRFS
   ...
   Rev 1.22   11 Nov 2000 22:26:52   GREGG
Unicodeized literals.

   Rev 1.21   18 Aug 2000 10:22:30   STEVEN
fix warnings

   Rev 1.20   05 Aug 2000 10:54:58   DON
removed warning's

   Rev 1.19   01 Mar 2000 12:34:42   DOUG
Added support for RMFS.

   Rev 1.18   13 Jan 2000 18:45:48   STEVEN
changes for WIN32 compile

   Rev 1.17   20 Dec 2000 10:41:46   STEVEN
redesign function for common functions into tables

   Rev 1.16   06 Dec 2000 11:31:36   BARRY
Fixed default device problems 

   Rev 1.15   14 Nov 2000 10:07:46   BARRY
Use new defines for initialization bits (to reflect the move from
be_init.h to fsys_str.h).

   Rev 1.14   13 Nov 2000 14:56:44   BARRY
Misspelled some of the BE_FS macros.

   Rev 1.13   31 Oct 2000 19:03:22   BARRY
Forgot to include be_init.h.

   Rev 1.12   24 Oct 2000 14:57:18   BARRY
TRICYCLE: Added new bit-mask parameter to FS_InitFileSys() to select
file systems at run-time.

   Rev 1.11   01 Oct 2000 11:15:26   BARRY
Include standard headers.

   Rev 1.10   10 Sep 2000 17:32:24   STEVEN
need to determine net before add servers

   Rev 1.9   09 Sep 2000 10:17:06   BARRY
Added support for SMS.

   Rev 1.8   12 Aug 2000 15:47:00   BARRY
BEC_DisplayNetwareServers( ) should not be referenced. We always add
all kinds of Novell DLEs.

   Rev 1.7   06 Aug 2000 18:31:34   DON
added NLM File System support

   Rev 1.6   25 Jul 2000 16:24:02   BARRY
Config changes, fix up #ifdef code, NLM warning removal.

   Rev 1.5   04 Jun 2000 18:46:46   BARRY
...
OS-specific modules.)
   ...
   Rev 1.4   03 Jun 2000 13:26:40   BARRY
Remove product defines from conditional compilation.

   Rev 1.3   29 May 2000 11:07:44   STEVEN
fix bugs in DLE insertsion sort

   Rev 1.2   28 May 2000 12:05:26   STEVEN
fix typo

   Rev 1.1   23 May 2000 16:40:06   BARRY
Changed FSYSs to be conditional on FS_XXX defines instead of product defines.

   Rev 1.0   09 May 2000 13:35:40   HUNTER
Initial revision.
