...
Changed FocusItem to be UINT for both NT and WINDOWS.
   ...
   Rev 1.23   01 Nov 2000 15:46:56   DAVEV
Unicode changes

   Rev 1.22   07 Oct 2000 13:48:00   DARRYLP
Precompiled header revisions.

   Rev 1.21   04 Oct 2000 19:33:14   DAVEV
Unicode Awk pass

   Rev 1.20   08 Sep 2000 10:39:02   ROBG

   Rev 1.19   21 Aug 2000 16:01:18   ROBG
Change to support change of font.

   Rev 1.18   29 Jul 2000 14:23:44   GLENN
ChuckB checked in after NT fixes.

   Rev 1.17   07 Jul 2000 15:52:32   MIKEP
unicode changes

   Rev 1.16   15 May 2000 13:35:50   MIKEP
nt pass 2

   Rev 1.15   20 Mar 2000 17:22:54   GLENN
Fixed VK_RETURN to work on key down instead of key up.

   Rev 1.14   19 Mar 2000 15:50:30   GLENN
Removed tabs.

   Rev 1.13   09 Mar 2000 09:39:48   GLENN
Fixed single click turning into a double click after a CR in list boxes.

   Rev 1.12   03 Mar 2000 18:21:30   GLENN
Put in error handling.

   Rev 1.11   23 Feb 2000 13:50:30   GLENN
Added check for valid list item to key char processing function.

   Rev 1.10   11 Feb 2000 17:29:04   GLENN
Changed return cast from SendMessage() from WORD to INT for NT.

   Rev 1.9   06 Feb 2000 15:15:16   ROBG
Added logic in DLM_GetWidth to add 3* average width to any
column character count less than 5.

   Rev 1.8   04 Feb 2000 16:07:46   STEVEN
various bug fixes for NT

   Rev 1.7   15 Jan 2000 15:15:16   DAVEV
16/32 bit port-2nd pass

   Rev 1.6   07 Jan 2000 17:27:46   GLENN
Updated DLM_KeyDown().

   Rev 1.5   26 Dec 2000 17:22:42   ROBG
New and Improved.

   Rev 1.4   05 Dec 2000 17:58:54   GLENN
Changed stuff in the default case of key down.

   Rev 1.3   04 Dec 2000 15:13:44   DAVEV
Modifications for 16/32-bit Windows port - 1st pass.


   Rev 1.2   03 Dec 2000 16:21:22   GLENN
Added DLM_CharToItem function.

   Rev 1.1   26 Nov 2000 16:12:12   ROBG
Added validity checks for the window handles, info structure, and the
dlm display header.

   Rev 1.0   20 Nov 2000 19:31:56   SYSTEM
Initial revision.
