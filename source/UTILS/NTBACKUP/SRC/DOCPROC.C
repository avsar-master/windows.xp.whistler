...
Added file SORT option support.
   ...
   Rev 1.37   16 Oct 2000 15:48:18   GLENN
Added pdsHdr stuff to list box proc kill focus.

   Rev 1.36   14 Oct 2000 15:48:18   GLENN
Added Selection Framing Support for List Boxes without the FOCUS.

   Rev 1.35   04 Oct 2000 19:33:24   DAVEV
Unicode Awk pass

   Rev 1.34   02 Oct 2000 16:45:44   GLENN
Fixed left hand side of slider for NT.

   Rev 1.33   28 Sep 2000 17:05:10   GLENN
Casted the MIN_LISTBOX_WIDTH define.

   Rev 1.32   17 Aug 2000 13:05:24   DAVEV
MikeP's changes at Microsoft

   Rev 1.31   28 Jul 2000 14:53:04   CHUCKB
Fixed warnings for NT.

   Rev 1.30   10 Jun 2000 16:20:16   GLENN
Took out ClipCursor() for NT.

   Rev 1.29   15 May 2000 13:32:36   MIKEP
nt pass 2

   Rev 1.28   30 Apr 2000 14:40:06   DAVEV
OEM_MSOFT: Fix View-All File Details

   Rev 1.27   20 Apr 2000 13:57:50   GLENN
Fixed dlm/list box problem.  Renamed global variables to module wides.

   Rev 1.26   08 Apr 2000 13:41:52   ROBG
Exclude border when calculating the region of the listbox to capture mouse.

   Rev 1.25   02 Apr 2000 14:52:54   JOHNWT
fixed mouse trap

   Rev 1.24   31 Mar 2000 11:53:20   GLENN
NT change: do not change cursor to pen for NT only.

   Rev 1.23   25 Mar 2000 08:37:24   ROBG
Fixed the problem about UAEs when dragging the mouse outside a listbox.

   Rev 1.22   19 Mar 2000 15:49:10   GLENN
Removed temporary multi task.

   Rev 1.21   17 Mar 2000 19:09:00   GLENN
Still working on list proc and doc proc.

   Rev 1.20   10 Mar 2000 16:45:08   GLENN
Put some switch points in for debugging.

   Rev 1.19   09 Mar 2000 16:59:20   ROBG
changed

   Rev 1.18   09 Mar 2000 09:45:44   GLENN
Fixed bug in maximize.

   Rev 1.17   03 Mar 2000 18:20:02   GLENN
Overhauled the proc functions.

   Rev 1.16   18 Feb 2000 20:43:36   GLENN
Changed SetWindowText() to WM_SetTitle().

   Rev 1.15   11 Feb 2000 17:25:52   GLENN
Changed DLM_KeyUp() parameter for new prototype.

   Rev 1.14   06 Feb 2000 18:35:00   STEVEN
fix typeo in NTKLUG

   Rev 1.13   04 Feb 2000 16:08:30   STEVEN
various bug fixes for NT

   Rev 1.12   02 Feb 2000 16:34:04   GLENN
Fixed slider/keyboard focus problem.

   Rev 1.11   29 Jan 2000 18:07:02   GLENN
Checked tree list box type before processing keys.

   Rev 1.10   22 Jan 2000 12:37:44   GLENN
Updated KEYDOWN and FOCUS areas.

   Rev 1.9   07 Jan 2000 17:25:50   GLENN
Added MDI split/slider support

   Rev 1.8   26 Dec 2000 13:48:54   GLENN
Added ability to block a doc restore/maximize during an operation

   Rev 1.7   17 Dec 2000 15:29:02   ROBG
Added handling of unwanted double clicks in hierarchical list boxes.

   Rev 1.6   12 Dec 2000 17:07:42   DAVEV
16/32 bit port -2nd pass

   Rev 1.5   10 Dec 2000 13:45:24   GLENN
Added feature to create a single-column list box

   Rev 1.4   05 Dec 2000 17:53:50   GLENN
Changed Close/Destroy sequencing.

   Rev 1.3   04 Dec 2000 15:16:20   DAVEV
Modifications for 16/32-bit Windows port - 1st pass.


   Rev 1.2   03 Dec 2000 16:16:18   GLENN
Added WM_DocKeyDown() call.

   Rev 1.1   27 Nov 2000 12:09:30   GLENN
Added parameter to DLM_DispListTerm().

   Rev 1.0   20 Nov 2000 19:18:44   SYSTEM
Initial revision.
