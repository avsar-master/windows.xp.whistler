...
Added support for the NT dummy device driver.
   ...
   Rev 1.22   23 Dec 2000 15:39:46   GLENN
Now displaying no config warning during unattended jobs.

   Rev 1.21   07 Oct 2000 14:50:56   DARRYLP
Precompiled header revisions.

   Rev 1.20   04 Oct 2000 19:41:26   DAVEV
Unicode Awk pass

   Rev 1.19   30 Sep 2000 10:44:56   DAVEV
Unicode strlen verification, MikeP's chgs from MS

   Rev 1.18   08 Aug 2000 09:39:54   MIKEP
start changes for nt hw config

   Rev 1.17   25 Jun 2000 14:06:56   DAVEV
mwDil is specific to OS_WIN32, not OEM_MSOFT

   Rev 1.16   10 Jun 2000 10:25:50   STEVEN
would not compile for mips

   Rev 1.15   27 May 2000 18:44:48   STEVEN
switch should be WIN32 not MSOFT

   Rev 1.14   14 May 2000 17:23:52   MIKEP
nt pass 2

   Rev 1.13   11 May 2000 14:25:56   DAVEV
OS_WIN32: chgd STEVE's OEM_MSOFT changes to OS_WIN32, 'cause they's NT specific

   Rev 1.12   27 Apr 2000 14:30:30   CARLS
changed tdemo number of tapes from 1 to 3

   Rev 1.11   22 Apr 2000 17:48:54   GLENN
Added TdemoInit() call for TDEMO version only.

   Rev 1.10   30 Mar 2000 18:12:18   GLENN
Changed return code when no driver string is found.

   Rev 1.9   26 Mar 2000 16:55:02   STEVEN
update for OEM_MSOFT

   Rev 1.8   03 Mar 2000 18:26:44   GLENN
Added a change to exe dir call just before reiniting the TF layer for reading .DLLs

   Rev 1.7   11 Feb 2000 17:29:30   GLENN
Put hardware warning message in string table.

   Rev 1.6   27 Jan 2000 12:48:16   GLENN
Changed dialog support calls.

   Rev 1.5   17 Jan 2000 16:48:40   JOHNWT
changed data to cat path

   Rev 1.4   10 Jan 2000 15:46:46   CARLS
removed strings

   Rev 1.3   07 Jan 2000 17:31:58   GLENN
Added support for polldrive retry after hwinit failure

   Rev 1.2   19 Dec 2000 17:41:30   DAVEV
16/32 bit port - 2nd pass

   Rev 1.1   18 Dec 2000 14:07:02   GLENN
Added windows.h

   Rev 1.0   20 Nov 2000 19:18:54   SYSTEM
Initial revision.
