...
Added pad stream to skip the pad data.
   ...
   Rev 1.36   18 Dec 2000 08:46:16   HUNTER
Fixes for "streamizing"

   Rev 1.35   18 Nov 2000 10:41:14   HUNTER
Bug fixes

   Rev 1.34   11 Nov 2000 14:17:34   GREGG
Moved F31_CalculatePad from Write.

   Rev 1.33   11 Nov 2000 09:47:38   HUNTER
Added support for the New Stream methods. Deleted both the VARIABLE block 
code, and SUPPORT FOR IMAGE DBs.

   Rev 1.32   12 Aug 2000 13:04:56   BARRY
Removed translation of Turtle tapes to GOS (old SMS).

   Rev 1.31   24 Jul 2000 16:49:40   NED
...
2.5 tapes.  Removed product specific compiler directive.
   ...
   Rev 1.4   23 May 2000 16:07:18   GREGG
Handle EOM like FMK in exception handler.

   Rev 1.3   20 May 2000 15:37:38   DAVIDH
Cleared up Watcom warnings for "defined, but not referenced" parameters.

   Rev 1.2   14 May 2000 11:22:54   GREGG
Changed order of includes.

   Rev 1.1   10 May 2000 11:56:02   GREGG
Ned's new stuff.

   Rev 1.0   10 May 2000 10:18:44   GREGG
Initial revision.
...
/**
        ...
        Modified:       August 17, 2000     (3:00pm)
