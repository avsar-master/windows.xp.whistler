...
When we close down the file system, added a call to free the os path or name queue!
   ...
   Rev 1.14   11 Nov 2000 09:52:34   GREGG
Unicodeized literals.

   Rev 1.13   10 Nov 2000 08:17:46   STEVEN
move os path and os name into common part of dblk

   Rev 1.12   25 Sep 2000 16:22:22   CARLS
Fixed error in last edit. [Barry]

   Rev 1.11   25 Sep 2000 13:18:26   BARRY
Removed references to FS_SIZEOF_NAMELESS_STREAM_HEAD.

   Rev 1.10   01 Sep 2000 11:44:20   TIMN
Fixed typo for BINT16

   Rev 1.9   18 Aug 2000 10:26:48   STEVEN
fix warnings

   Rev 1.8   23 Jul 2000 12:41:06   STEVEN
fix warning

   Rev 1.7   09 Jul 2000 13:58:30   STEVEN
BE_Unicode updates

   Rev 1.6   21 May 2000 13:58:10   STEVEN
added more long path stuff

   Rev 1.5   16 Mar 2000 10:06:56   LORIB
Added InitQueue() for path_q.

   Rev 1.4   01 Oct 2000 11:15:48   BARRY
Include standard headers.

   Rev 1.3   06 Aug 2000 18:30:24   DON
added NLM File System support

   Rev 1.2   25 Jun 2000 09:34:54   BARRY
Changes for new config.

   Rev 1.1   03 Jun 2000 13:27:04   BARRY
Remove product defines from conditional compilation.

   Rev 1.0   09 May 2000 13:38:26   HUNTER
Initial revision.
