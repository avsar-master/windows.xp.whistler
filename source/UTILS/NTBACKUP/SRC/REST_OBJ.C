...
added stream_id to error message
   ...
   Rev 1.28   04 Nov 2000 13:23:34   STEVEN
fix various bugs with read

   Rev 1.27   04 Nov 2000 09:29:18   STEVEN
fix initial receive

   Rev 1.26   03 Nov 2000 10:09:30   STEVEN
change the way we skip data

   Rev 1.25   19 Oct 2000 15:55:36   STEVEN
remaining size is gone

   Rev 1.24   05 Oct 2000 10:29:54   STEVEN
remove TotalSize

   Rev 1.23   16 Sep 2000 16:55:18   STEVEN
added support for stream info struct for Tpfmt

   Rev 1.22   01 Sep 2000 16:12:10   STEVEN
added stream headers to fsys API

   Rev 1.21   23 Jul 2000 16:45:50   STEVEN
fix warnings

   Rev 1.19   23 Jul 2000 12:13:46   STEVEN
fix warnings

   Rev 1.18   27 May 2000 17:39:24   TIMN
Changed CHARs to INT8s

   Rev 1.17   05 May 2000 17:19:24   STEVEN
fixed typos and misc bugs

   Rev 1.16   27 Apr 2000 16:41:54   STEVEN
fix typo in include

   Rev 1.15   20 Mar 2000 13:43:32   STEVEN
do not prompt for special files

   Rev 1.14   16 Mar 2000 16:40:34   STEVEN
more 64 bit support for format 40

   Rev 1.13   13 Mar 2000 09:23:28   STEVEN
4.0 tape format 64 bit

   Rev 1.12   04 Feb 2000 10:35:56   DON
if NOT defined FS_IMAGE then Images should be ignored

   Rev 1.11   11 Dec 2000 14:09:34   STEVEN
read converted to FS_READ

   Rev 1.10   18 Oct 2000 14:11:28   STEVEN
BIGWHEEL-add support for prompt before restore over exist

   Rev 1.9   02 Oct 2000 15:34:58   STEVEN
BIGWEEL - Added support for Prompt before restore over existing

   Rev 1.8   19 Sep 2000 17:00:22   STEVEN
fix warning for UNSIGNED SIGNED mismatch

   Rev 1.7   10 Sep 2000 18:19:40   DON
got rid of pointer type mismatches

   Rev 1.6   25 Jul 2000 10:39:14   STEVEN
remove 0 length files if disk is full

   Rev 1.5   27 Jun 2000 13:05:46   STEVEN
removed unused parm to ReceiveData

   Rev 1.4   21 Jun 2000 09:22:42   STEVEN
new config unit

   Rev 1.3   30 May 2000 09:14:06   STEVEN
bsdu_err.h no longer exists

   Rev 1.2   24 May 2000 14:45:18   STEVEN
complete changes for new getnext

   Rev 1.1   14 May 2000 14:52:08   DAVIDH
Initialized blk_size to 0 -- resolved Watcom compiler warning


   Rev 1.0   09 May 2000 13:34:28   HUNTER
Initial revision.
