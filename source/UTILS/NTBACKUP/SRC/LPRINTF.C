...
detail as well as summary logging selected.
   ...
   Rev 1.21   05 Nov 2000 17:09:18   DAVEV
fix ts

   Rev 1.19   07 Oct 2000 14:50:38   DARRYLP
Precompiled header revisions.

   Rev 1.18   04 Oct 2000 19:38:42   DAVEV
Unicode Awk pass

   Rev 1.17   28 Jul 2000 14:48:08   CHUCKB
Fixed warnings for NT.

   Rev 1.16   10 Jun 2000 12:40:54   JOHNWT
bug out if verify/skipped for msoft

   Rev 1.15   19 May 2000 13:01:20   MIKEP
mips changes

   Rev 1.14   14 May 2000 16:51:10   MIKEP
nt pass 2

   Rev 1.13   28 Apr 2000 08:32:58   ROBG
Took tab out of the logging of multiple file names on a single line.

   Rev 1.12   06 Apr 2000 13:28:26   GLENN
Fixed new-line problem for all log files.

   Rev 1.11   31 Mar 2000 11:32:34   DAVEV
OEM_MSOFT:do not attempt to open log file if none specified

   Rev 1.10   20 Mar 2000 12:38:42   DAVEV
Changes for OEM_MSOFT product alternate functionality

   Rev 1.9   18 Mar 2000 11:58:00   ROBG
Fixed problem when more than one log file is opened and
the names are misused.

   Rev 1.8   18 Mar 2000 09:38:24   ROBG
Modified the New Page after closing of a log file to New Line.

   Rev 1.7   18 Mar 2000 09:33:18   DAVEV
changes for OEM_MSOFT log files

   Rev 1.6   25 Feb 2000 21:32:04   GLENN
Changed log file name to be created only if not prev created.

   Rev 1.5   18 Feb 2000 15:43:08   ROBG
Modified UI_TruncateString call Not to set blanks to 0xFF.

   Rev 1.4   03 Feb 2000 16:57:38   ROBG
Added debug line when closing the log file.

   Rev 1.3   20 Jan 2000 12:58:36   MIKEP
disk full error

   Rev 1.2   16 Jan 2000 11:23:48   DAVEV
16/32 bit port-2nd pass

   Rev 1.1   10 Jan 2000 16:24:54   CARLS
removed strings

   Rev 1.0   20 Nov 2000 19:30:02   SYSTEM
Initial revision.
