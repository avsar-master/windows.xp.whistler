...
Changes to allow format command passed to driver through TpErase.
   ...
   Rev 1.17   11 Nov 2000 22:16:56   GREGG
Changed call to EraseDrive (only security boolean needed).

   Rev 1.16   19 Feb 2000 17:00:12   GREGG
Put the buffer back after user abort.

   Rev 1.15   08 Feb 2000 14:27:24   GREGG
...
and add ability to Tension tape without pre-read.
   ...
   Rev 1.1   10 May 2000 16:08:18   GREGG
Ned's new stuff

   Rev 1.0   10 May 2000 10:12:00   GREGG
Initial revision.
