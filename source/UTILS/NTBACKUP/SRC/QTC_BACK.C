...
fix crossing tape bug
   ...
   Rev 1.13   14 Dec 2000 12:28:52   DAVEV
Enabled for Unicode compile

   Rev 1.12   08 Dec 2000 09:40:54   DON
Graceful Red: changed VCB_CONT_BIT to MTF_DB_CONT_BIT

   Rev 1.11   01 Dec 2000 13:24:22   MIKEP
otc fix for setting status bits

   Rev 1.10   23 Nov 2000 14:20:40   MIKEP
fix continuation vcb for MTF only

   Rev 1.9   20 Nov 2000 13:28:44   CHARLIE
...
ENDEAVOR: We needed to clean up the QTC_TEMP files after an abort
   ...
   Rev 1.8   15 Nov 2000 16:05:36   MIKEP
fix warnings

   Rev 1.7   06 Nov 2000 15:30:06   DON
Change debug.h to be_debug.h and zprintf to BE_Zprintf

   Rev 1.6   28 Oct 2000 11:32:30   MIKEP
fix PBA of FDD stuff

   Rev 1.5   23 Oct 2000 13:26:20   MIKEP
change otc call

   Rev 1.4   22 Oct 2000 16:51:42   MIKEP
otc fixes

   Rev 1.3   22 Oct 2000 09:27:34   MIKEP
second pass otc changes

   Rev 1.2   15 Oct 2000 10:31:38   MIKEP
add fdd fields

   Rev 1.1   09 Oct 2000 11:53:40   MIKEP
unicode pass

   Rev 1.0   03 Sep 2000 16:56:14   STEVEN
Initial revision.
