...
Added File Details and Search Limit items.
   ...
   Rev 1.33   23 Dec 2000 15:41:58   GLENN
Added all file details, runtime dlg pos saving, search limit, FAT drive lower case display.

   Rev 1.32   18 Nov 2000 13:05:38   GLENN
Added initialization states for frame and disk windows.

   Rev 1.31   11 Nov 2000 16:33:28   DAVEV
UNICODE: remove compile warnings

   Rev 1.30   05 Nov 2000 17:09:42   DAVEV
fix ts

   Rev 1.28   30 Oct 2000 15:47:12   GLENN
Added Frame and MDI Doc window size and position saving and restoring.

   Rev 1.27   14 Oct 2000 15:53:36   GLENN
Added Font selection to Config and INI.

   Rev 1.26   07 Oct 2000 14:11:52   DARRYLP
Precompiled header revisions.

   Rev 1.25   04 Oct 2000 19:39:14   DAVEV
Unicode Awk pass

   Rev 1.24   17 Sep 2000 17:40:36   DAVEV
minor fix (strsiz->strsize)

   Rev 1.23   17 Sep 2000 15:51:10   DAVEV
UNICODE modifications: strlen usage check

   Rev 1.22   08 Sep 2000 14:06:10   STEVEN
fix warnings for NT

   Rev 1.21   19 Aug 2000 14:31:42   CHUCKB
Changed for NT.

   Rev 1.20   06 Aug 2000 22:01:00   MIKEP
add support for tape drive name for nt

   Rev 1.19   29 Jul 2000 14:14:26   GLENN
ChuckB checked in after NT fixes.

   Rev 1.18   30 Jun 2000 13:16:12   JOHNWT
added enable stats flag

   Rev 1.17   10 Jun 2000 16:53:32   DAVEV
OEM_MSOFT: force Prompt before overwite existing files

   Rev 1.16   10 Jun 2000 10:43:48   STEVEN
change NULL to 0

   Rev 1.15   15 May 2000 16:48:12   MIKEP
incl_cds removal

   Rev 1.14   14 May 2000 18:00:36   MIKEP
nt pass 2

   Rev 1.13   01 Apr 2000 09:47:34   JOHNWT
key creation of config on existence of debug info

   Rev 1.12   20 Mar 2000 17:23:16   GLENN
Added std mode warning config option.

   Rev 1.11   18 Mar 2000 14:13:54   JOHNWT
commented out write of PWD entries

   Rev 1.10   27 Feb 2000 11:15:42   JOHNWT
wait/skip files change

   Rev 1.9   27 Feb 2000 08:37:50   GLENN
Added SetupExePath and ChangeToExeDir.

   Rev 1.8   23 Feb 2000 13:46:06   GLENN
Moved INI util functions to confmisc.c

   Rev 1.7   27 Jan 2000 12:51:16   GLENN
Changed hardware config init status.

   Rev 1.6   24 Jan 2000 14:50:48   GLENN
Updated the get hardware config function.

   Rev 1.5   20 Jan 2000 09:42:10   GLENN
Moved data path verification to verify functions.

   Rev 1.4   14 Jan 2000 08:16:44   GLENN
Added Sort BSD support.

   Rev 1.3   10 Jan 2000 11:18:42   DAVEV
16/32 bit port-2nd pass

   Rev 1.2   07 Jan 2000 17:29:00   GLENN
Added catalog data path support

   Rev 1.1   04 Dec 2000 18:43:10   GLENN
Added machine type references.

   Rev 1.0   20 Nov 2000 19:30:56   SYSTEM
Initial revision.
