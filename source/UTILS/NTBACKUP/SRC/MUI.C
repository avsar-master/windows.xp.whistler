...
add mem display to NT
   ...
   Rev 1.54   23 Nov 2000 14:28:56   MIKEP
add vm ptr to qtc_init call

   Rev 1.53   18 Nov 2000 13:04:04   GLENN
Fixed button states based on the poll drive state.

   Rev 1.52   01 Nov 2000 16:02:58   DAVEV
Unicode changes

   Rev 1.51   30 Oct 2000 15:44:02   GLENN
Moved the configuration deinit after the units deinit.

   Rev 1.50   07 Oct 2000 14:10:50   DARRYLP
Precompiled header revisions.

   Rev 1.49   04 Oct 2000 19:39:04   DAVEV
Unicode Awk pass

   Rev 1.48   02 Oct 2000 16:47:50   GLENN
Fixed wait cursor - set cursor stuff.

   Rev 1.47   28 Sep 2000 17:01:28   GLENN
MikeP changes (DriveType).

   Rev 1.46   22 Sep 2000 10:24:48   GLENN
Added the net connect and disconnect stuff.

   Rev 1.45   10 Sep 2000 17:19:14   GLENN
Resolved outstanding state issues for toolbar and menubar.

   Rev 1.44   09 Sep 2000 16:59:00   GLENN
Updated toolbar stuff for BIMINI and NT.

   Rev 1.43   08 Sep 2000 15:40:30   GLENN
Resolved modeless dialog while loop.

   Rev 1.42   02 Sep 2000 16:42:22   GLENN
Added support for toolbar button states based on current window.  MikeP added catalog enable stuff
.

   Rev 1.41   06 Aug 2000 13:17:30   CHUCKB
Changes for NT.

   Rev 1.40   27 Jun 2000 18:31:46   MIKEP
another qtc change to init

   Rev 1.39   27 Jun 2000 17:58:38   MIKEP
changes for qtc

   Rev 1.38   20 May 2000 18:07:42   GLENN
Fixed added checking to strtok - command line stuff.  Put in changes for 1.32.1.1 branch.

   Rev 1.37   19 May 2000 09:26:16   MIKEP
mo changes

   Rev 1.36   15 May 2000 16:48:14   MIKEP
incl_cds removal

   Rev 1.35   14 May 2000 18:00:26   MIKEP
nt pass 2

   Rev 1.34   11 May 2000 15:47:58   GLENN
Made sure RTD had focus when MUI_EnableOperations() was called, iff the RTD existed.

   Rev 1.33   11 May 2000 14:20:36   DAVEV
OEM_MSOFT: modifications for batch command line support

   Rev 1.32   27 Apr 2000 16:19:50   JOHNWT
get pw for pwdb before startup.bks

   Rev 1.31   23 Apr 2000 15:57:40   JOHNWT
added pwdb check to jobs

   Rev 1.30   20 Apr 2000 13:54:42   GLENN
Removed multitask from MUI_EnableOperations() - caused exit problems.

   Rev 1.29   09 Apr 2000 11:32:18   GLENN
Added catalog initializing and UI initializing status line calls.

   Rev 1.28   07 Apr 2000 10:25:30   GLENN
Added a call back when there is a system change. (future)

   Rev 1.27   02 Apr 2000 15:39:56   GLENN
Added NT support for tape-in-drive dependent selection bar buttons.

   Rev 1.26   26 Mar 2000 17:05:32   STEVEN
remove hwconfig

   Rev 1.25   23 Mar 2000 11:53:28   GLENN
Added bad data and catalog path warning support.

   Rev 1.24   22 Mar 2000 12:55:52   JOHNWT
finished stdmodewarn disable

   Rev 1.23   20 Mar 2000 17:23:50   GLENN
Added std mode warning config option.

   Rev 1.22   20 Mar 2000 12:40:08   DAVEV
Changes for OEM_MSOFT product alternate functionality

   Rev 1.21   19 Mar 2000 09:30:16   MIKEP
debug deinit

   Rev 1.20   17 Mar 2000 17:13:54   GLENN
Added standard mode warning message box.

   Rev 1.19   10 Mar 2000 15:50:46   DAVEV
fix for OEM_MSOFT changes

   Rev 1.18   09 Mar 2000 09:23:10   GLENN
GLENN - Added logo bitmap support.  DAVEV - Added NT ifdef options

   Rev 1.17   27 Feb 2000 13:53:02   GLENN
Enabled poll drive for command line jobs and scheduled jobs.

   Rev 1.16   18 Feb 2000 16:36:40   CHUCKB
Added code to make auto job for verify.

   Rev 1.15   11 Feb 2000 17:23:26   GLENN
Fixed ribbon enabling for search window.

   Rev 1.14   08 Feb 2000 16:50:38   MIKEP
refresh all selections

   Rev 1.13   05 Feb 2000 20:50:16   MIKEP
pass config to qtc init

   Rev 1.12   05 Feb 2000 17:39:46   GLENN
Added MUI_Deinit() call when forcefully terminating app.

   Rev 1.11   30 Jan 2000 12:36:02   GLENN
Changed UI_TapeHWProblem to HWC_TapeHWProblem for modularity.

   Rev 1.10   28 Jan 2000 08:27:28   JOHNWT
fixed my fix

   Rev 1.9   28 Jan 2000 08:24:40   JOHNWT
fixed pwdb flag setting

   Rev 1.8   27 Jan 2000 00:32:10   CHUCKB
Updated dialog id's.

   Rev 1.7   22 Jan 2000 12:32:48   GLENN
Added animate icon support.

   Rev 1.6   10 Jan 2000 15:47:40   CARLS
removed strings

   Rev 1.5   10 Jan 2000 11:18:12   DAVEV
16/32 bit port-2nd pass

   Rev 1.4   07 Jan 2000 17:29:42   GLENN
Added catalog data path support

   Rev 1.3   10 Dec 2000 14:30:22   GLENN
Bunches of changes by everyone

   Rev 1.2   04 Dec 2000 18:36:40   GLENN
Updated for ALT-F4 termination

   Rev 1.1   03 Dec 2000 16:19:10   GLENN
Added advanced restore, catalog maint operation to list.

   Rev 1.0   20 Nov 2000 19:16:42   SYSTEM
Initial revision.
