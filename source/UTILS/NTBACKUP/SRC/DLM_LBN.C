...
fixes from mikep and MSOFT
   ...
   Rev 1.17   21 Dec 2000 12:25:18   DAVEV
Enabled for Unicode - IT WORKS!!

   Rev 1.16   07 Oct 2000 13:46:52   DARRYLP
Precompiled header revisions.

   Rev 1.15   04 Oct 2000 19:33:04   DAVEV
Unicode Awk pass

   Rev 1.14   09 Sep 2000 16:13:34   GLENN
Updated castings for MikeP (NT).

   Rev 1.13   08 Sep 2000 11:48:58   ROBG
Changed cxPos, cyPos from USHORT to short.

   Rev 1.12   10 Jun 2000 10:57:24   STEVEN
NULL would not compile for mips

   Rev 1.11   15 May 2000 13:32:22   MIKEP
nt pass 2

   Rev 1.10   20 Mar 2000 17:22:32   GLENN
Fixed VK_RETURN to work on key down instead of key up.

   Rev 1.9   17 Mar 2000 18:27:46   GLENN
Removed unnecessary invalidate rects.

   Rev 1.8   09 Mar 2000 10:48:56   GLENN
Added VK_RETURN checking for keyboard processing.

   Rev 1.7   03 Mar 2000 18:22:02   GLENN
Put in error handling.

   Rev 1.6   11 Feb 2000 12:19:36   DAVEV
steve is brain-dead fix bug in NT_KLUG

   Rev 1.5   04 Feb 2000 16:07:26   STEVEN
various bug fixes for NT

   Rev 1.4   15 Jan 2000 15:16:36   DAVEV
16/32 bit port-2nd pass

   Rev 1.3   26 Dec 2000 17:22:10   ROBG
New and Improved.

   Rev 1.2   03 Dec 2000 13:21:20   DAVEV
Modifications for 16/32-bit Windows port - 1st pass.

   Rev 1.1   26 Nov 2000 13:21:28   ROBG
Added validity checks for the window handle, info structure, and the
dlm display header.

   Rev 1.0   20 Nov 2000 19:18:10   SYSTEM
Initial revision.
