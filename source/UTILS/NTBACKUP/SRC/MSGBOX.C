...
Change default tab stops in message box.
   ...
   Rev 1.42   01 Nov 2000 16:02:38   DAVEV
Unicode changes

   Rev 1.41   16 Oct 2000 15:55:24   GLENN
Got rid of a ton of compiler warnings for windows.

   Rev 1.40   14 Oct 2000 15:58:26   GLENN
Added code to pause and resume the wait cursor during a message box.

   Rev 1.39   04 Oct 2000 19:38:56   DAVEV
Unicode Awk pass

   Rev 1.38   17 Aug 2000 13:20:44   DAVEV
MikeP's changes at Microsoft

   Rev 1.37   10 Jun 2000 14:30:06   JOHNWT
changed font to ghFontMsgBox

   Rev 1.36   29 May 2000 15:59:42   JOHNWT
PCH updates

   Rev 1.35   30 Mar 2000 18:02:44   GLENN
Added support for pulling resources from .DLL

   Rev 1.34   23 Mar 2000 16:10:48   JOHNWT
added WMMB_BUT2DEFAULT functionality

   Rev 1.33   22 Mar 2000 12:53:06   JOHNWT
added WMMB_OKDISABLE

   Rev 1.32   19 Mar 2000 11:45:50   JOHNWT
moved WM_MakeAppActive to winmang.c

   Rev 1.31   17 Mar 2000 08:05:02   ROBG
added IDHELP

   Rev 1.30   28 Feb 2000 16:32:22   JOHNWT
tried more things

   Rev 1.29   25 Feb 2000 21:25:08   GLENN
Removed system modal specific calls.

   Rev 1.28   23 Feb 2000 13:55:56   GLENN
Trying new things...

   Rev 1.27   18 Feb 2000 18:33:46   GLENN
Placed strategically located WM_MultiTask() statements.

   Rev 1.26   11 Feb 2000 17:24:16   GLENN
Moved multitask to destroy case.

   Rev 1.25   06 Feb 2000 16:11:00   DAVEV
NT ONLY: Kludged weird bug where GetClientRect on a push button seems to return dialog units in Re
ct.bottom?!?

   Rev 1.24   31 Jan 2000 14:37:24   JOHNWT
if iconic use IDS_APPNAME as msg title

   Rev 1.23   31 Jan 2000 13:44:06   JOHNWT
moved center operation to DM_CenterDialog

   Rev 1.22   30 Jan 2000 11:41:04   JOHNWT
moved WMMB_SYSMODAL to msgbox.h

   Rev 1.21   29 Jan 2000 13:14:18   CARLS
No change

   Rev 1.20   27 Jan 2000 00:29:46   CHUCKB
Updated dialog id's.

   Rev 1.19   21 Jan 2000 16:53:52   JOHNWT
changed checkyy to noyycheck flag

   Rev 1.18   14 Jan 2000 17:25:00   JOHNWT
more sysmodal changes

   Rev 1.17   14 Jan 2000 16:36:16   JOHNWT
reset ghModelessDialog to sysmodal

   Rev 1.16   13 Jan 2000 10:22:18   JOHNWT
added help

   Rev 1.15   20 Dec 2000 16:58:36   JOHNWT
return ghModelessDialog

   Rev 1.14   19 Dec 2000 15:24:38   GLENN
Added windows.h

   Rev 1.13   18 Dec 2000 11:21:30   JOHNWT
changed modeless to runtime

   Rev 1.12   16 Dec 2000 17:18:18   JOHNWT
made parent the active window

   Rev 1.11   16 Dec 2000 10:07:20   JOHNWT
removed get/set focus call!

   Rev 1.10   13 Dec 2000 16:40:42   JOHNWT
fixed last fix

   Rev 1.9   13 Dec 2000 15:45:06   JOHNWT
added get/setfocus

   Rev 1.8   12 Dec 2000 17:07:12   DAVEV
16/32 bit port -2nd pass

   Rev 1.7   09 Dec 2000 11:43:58   JOHNWT
fixed bogus ReleaseDC

   Rev 1.6   04 Dec 2000 15:19:40   DAVEV
Modifications for 16/32-bit Windows port - 1st pass.


   Rev 1.5   02 Dec 2000 12:53:54   JOHNWT
check malloc/callocs

   Rev 1.4   25 Nov 2000 15:25:14   JOHNWT
adjusted size of msgbox

   Rev 1.3   24 Nov 2000 13:03:52   JOHNWT
removed large font on inst line

   Rev 1.2   21 Nov 2000 18:11:26   JOHNWT
added yy flag check

   Rev 1.1   21 Nov 2000 13:33:48   JOHNWT
do not force large font

   Rev 1.0   20 Nov 2000 19:34:00   SYSTEM
Initial revision.
