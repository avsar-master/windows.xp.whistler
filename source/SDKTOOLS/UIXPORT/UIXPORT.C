...
/*
    ...
    FILE HISTORY:
        KeithMo     09-Aug-2000 00.00.00 Created.
        KeithMo     14-Sep-2000 00.00.01 Strip stdcall decoration from symbols.
        KeithMo     16-Oct-2000 00.00.02 Handle goofy []()* in coff output.
...
/*******************************************************************
    ...
    HISTORY:
        KeithMo     09-Aug-2000 Created.
        KeithMo     14-Sep-2000 Strip stdcall decoration from symbols.
...
/*******************************************************************
    ...
    HISTORY:
        KeithMo     12-Aug-2000 Broke out of main().
