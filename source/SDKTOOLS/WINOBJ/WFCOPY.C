...
; Revision History:
;
; Modified by C. Stevens, August, 2000.  Added logic so that we would call
...
ProcessSearchResult:
         ...
         /* Ensure the source disk really exists before doing anything.
            ...
            checked.  Modified by C. Stevens, August 2000 */
...
;
; August 2000 - Modified by C. Stevens.  Added code to allow us to queue
...
;
; Written by C. Stevens, August 2000
;
============================================================================*/
