...
Revision History:
    ...
    21-Oct-2000 AzeemK   Detect resource files correctly, removing name restrictions.
    12-Oct-2000 AzeemK   removed -strict switch.
    09-Oct-2000 AzeemK   fixed the -order bug (cuda:1275)
    08-Oct-2000 BrentM   put TCE code under DB_TCE
    02-Oct-2000 AzeemK   Changes due to the new sections/groups/modules model. A
                         whole bunch of functions rewritten due to this. New
                         functions to build archive list in offset sorted order.
    02-Oct-2000 BrentM   replaced a read() with a FileRead()
    01-Oct-2000 BrentM   explicit calls to RemoveConvertTempFiles()
    27-Sep-2000 BrentM   added section mapping to read logging
    23-Sep-2000 BrentM   changed compare routines for reloc sorts to return
                         two values subtracted, rather than do magnitude
                         comparisons
    10-Sep-2000 AzeemK   Handle COMDEF & COMDATs for same data correctly for
                         FORTRAN.
    09-Sep-2000 AzeemK   Flush stdout buffer after warnings & echoing of
                         response file.
    04-Sep-2000 AzeemK & BrentM saved local section state before IncludeComDat
    03-Sep-2000 BrentM   initial transitive comdat elimination hooks
    19-Aug-2000 GeoffS   Added temporary hack to get symbol count high enough
    17-Aug-2000 AzeemK   Fix for .drectve section handling.
    13-Aug-2000 AzeemK   Fix for EXTERNALs in COMDATs
    12-Aug-2000 AzeemK   Fix for STATICs in COMDATs
    11-Aug-2000 GeoffS   Fixed additional debug format bugs
    06-Aug-2000 AzeemK   Added new lib search algorithm
    05-Aug-2000 GeoffS   Added extra prameter to ReadStringTable
    04-Aug-2000 BrentM   removed huge_* routines and references, slit off
                         buffer io routines to bufio.c, added io logging
                         support
    03-Aug-2000 AzeemK   Added default lib support
    27-Jul-2000 BrentM   removed binary tree traversals and replaced with
                         ...
                         BUFFER_SECTIONS
    24-Jul-2000 GlennN   Fixed not mapped debug section problem.
    21-Jul-2000 GeoffS   Changed IncludeComDat to compare Lib name
    26-Jun-2000 GlennN   negated defined for _NO_CV_LINENUMBERS
    25-Jun-2000 GeoffS   Changed ToolName to "tmp" for temp file creation
    25-Jun-2000 GeoffS   Added _NO_CV_LINENUMBERS
    25-Jun-2000 GlennN   Added offset init code in BufferedWrite
    09-Jun-2000 AzeemK   Added buffering support
    28-May-2000 geoffs   Added call to cvtres_main for resource conversion
...
#endif /* NT_BUILD */
           "\n"
           "Copyright (C) Microsoft Corp 2000-94. All rights reserved.\n"
           "\n",
