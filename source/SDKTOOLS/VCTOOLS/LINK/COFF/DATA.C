...
Revision History:
    ...
    10-Aug-2000 ChrisW  Change GpExtern to pGpExtern.
    19-Jul-1993 JamesS  added ppc support.
    12-Oct-2000 AzeemK  removed -strict switch.
    08-Oct-2000 JonM    added ToolPathname (set to argv[0]).
    30-Sep-2000 AzeemK  changes due to new sections, groups, modules module
    28-Sep-2000 BrentM  removed -bufscns
    23-Sep-2000 BrentM  added read buffering and logical file descriptor caching
    08-Sep-2000 BrentM  Merged in GlennN's -disasm code
    31-Aug-2000 AzeemK  Bug fix. Added initializers for SWITCH.
    ...
    05-Aug-2000 GeoffS  Added new variables for debug information
    04-Aug-2000 BrentM  i/o logging, /stat /logio
    03-Aug-2000 AzeemK  Added default lib support
    27-Jul-2000 BrentM  new global symbol table, removed FirstExtern
    21-Jul-2000 GeoffS  Change default alignment to 4K
    25-Jun-2000 GlennN  Added NoPack init to Switch
