...
Revision History:
    ...
    02-Oct-2000 AzeemK  Changes for the new section, group & module nodes.
    01-Oct-2000 BrentM  explicit calls to RemoveConvertTempFiles()
    23-Sep-2000 BrentM  changed tell()'s to FileTell()'s
    09-Sep-2000 AzeemK  Fix for 604.
    08-Sep-2000 BrentM  merged in GlennN's -disasm code
    08-Sep-2000 BrentM  changed -allbutrawdata to -rawdata:none
    25-Aug-2000 BrentM  Added -allbutrawdata switch to dumper
    11-Aug-2000 GeoffS  Added dump of PointerToNextLinenumber
    05-Aug-2000 GeoffS  Added extra parameter to ReadStringTable
