...
Revision History:
    ...
    07-Oct-2000 AzeemK   fixed write of zero bytes in EmitThunk()
    07-Oct-2000 AzeemK   fixed internal error in fuzzylookup()
    02-Oct-2000 AzeemK   changes due to the new sections/groups/modules model
    01-Sep-2000 BrentM   explicit call to RemoveConvertTempFiles()
    23-Sep-2000 BrentM   changed tell()'s to FileTell()'s
    07-Jul-2000 BrentM   Added a new global symbol table, removed references
