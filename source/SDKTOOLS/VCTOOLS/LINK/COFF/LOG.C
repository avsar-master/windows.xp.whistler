...
Author:
    ...
    Brent Mills (BrentM) 28-Jul-2000

Revision History:

    02-Oct-2000 AzeemK  changes due to the new sections model
    01-Oct-2000 BrentM  mapped i/o logging
    27-Sep-2000 BrentM  map reads on i/o logging
    23-Sep-2000 BrentM  corrected output for fopen(), added fflush()
    10-Sep-2000 BrentM  added [f]open/[f]close logging
    09-Sep-2000 BrentM  added read logging, separate DB macros for transactions
    03-Sep-2000 BrentM  put logging under DBEXEC macro calls
