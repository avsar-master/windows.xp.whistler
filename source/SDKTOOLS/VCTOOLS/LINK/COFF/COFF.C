...
Revision History:
    ...
    08-Oct-2000 JonM    set ToolPathname to Argv[0]
    01-Oct-2000 BrentM  put mapped i/o under a DBEXEC_REL
    01-Oct-2000 BrentM  added an error routine for bufio, updated FileInit
    28-Sep-2000 BrentM  moved FileInit() params to globals.h
    25-Sep-2000 BrentM  added #define's for bufio initialization parameters
    23-Sep-2000 BrentM  added read buffering and file handle caching
    09-Sep-2000 AzeemK  Added buffering for stdout
    09-Sep-2000 AzeemK  Fix for 604
    12-Aug-2000 AzeemK  Fix for link32 default
    21-Jul-2000 GeoffS  Added internal release banner
    15-Jun-2000 AzeemK  Added GlennN's IDE feedback mechanism
    27-May-2000 AzeemK  changed coff to default to link32 -link
    21-May-2000 AzeemK  changed banner
