...
*  14-Aug-2000 SS CAVIAR 2735: handle quoted macro values in command files
*  02-Feb-1990 SB Replace fopen() by FILEOPEN
*  01-Dec-2000 SB Changed realloc() to REALLOC()
*  22-Nov-2000 SB Changed free() to FREE()
*  17-Aug-2000 SB Add error check to closing file
*  05-Apr-2000 SB made func calls NEAR to put all funcs into 1 module
