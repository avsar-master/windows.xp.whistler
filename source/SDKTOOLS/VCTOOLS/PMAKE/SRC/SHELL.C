...
*
* Revision History:
*  12-Dec-2000 SB Fix so that extraneous blanks get avoided between arguments
*  08-Dec-2000 SB While doing previous change don't add extraneous blanks
*  08-Dec-2000 SB NMK.COM and PWB.COM cannot handle 'foo arg<in>out' so generate
*		  'foo arg <in >out' instead
*  14-Nov-2000 SB Created
*
*******************************************************************************/
