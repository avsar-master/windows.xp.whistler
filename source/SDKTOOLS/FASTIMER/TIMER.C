...
*
*     Modified to include f).  -     Feb. 14, 2000. (vaidy).
*/

char *COPYRIGHT = "Copyright Microsoft Corporation, 2000";
 ...
 *
 *  History:   13-Jan-2000 waynej    created
 *             30-Nov-2000 vaidy    modified - see comment in body of code
 *             27-Dec-2000 russbl    fix error of adding two many WRAP8253's
