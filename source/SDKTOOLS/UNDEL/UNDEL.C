...
*  28-Dec-2000 SB Add #ifdef BEAUTIFY stuff
*  27-Dec-2000 SB Changes for new index file format
*  15-Dec-2000 SB Include os2.h instead of doscalls.h
*                 Qh return code 3 means 'Topic not Found'
*  14-Dec-2000 LN Update Copyright to include 1990
*  23-Oct-2000 LN Version no bumped to 1.01
*  02-Oct-2000 LN Changed Version no to 1.00
*  08-Aug-2000 bw Add Version number, update copyright
*  15-May-2000 wb Add /help
*  24-Jan-2000 bw Use C runtime rename() so fastcopy doesn't get dragged in.
