...
void AddCorrespondence(
        ...
        if  (!nLength)
          {
            LOG("Warning- established second correspondence to same "
                  "value\r\n");
            /*
                BobK 9-28-2000 update correspondence count
            */
            (*(--piCount))++;
    ...
    *pItem++ = 1;   //  BobK 09-28-2000 Set Correspondence count to 1
...
void DeleteCorrespondence(
    ...
    */
    ...
    if (cOldItem ) {
        ...
        ** 09-13-2000   BobK Changed to look for item # match- faster, and
    ...
    if  (cOldItem && cNewItem)
      {
        ...
        /*
            BobK    09-28-2000  Decrement Correspondence count.  If still
...
/******************************************************************************
    ...
    Originally coded 10-01-2000 by BobK (Another sleepless night)
