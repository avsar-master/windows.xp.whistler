...
/*+-------------------------------------------------------------------------+
  ...
  |                                                                         |
  +-------------------------------------------------------------------------+*/
LPTSTR XPDriveShare(LPTSTR DriveLetter) {
...
/*+-------------------------------------------------------------------------+
  ...
  |                                                                         |
  +-------------------------------------------------------------------------+*/
void XPDriveInfoSet(DRIVE_BUFFER *DBuff) {
   ...
   RootPath = XPDriveShare(DBuff->Drive);
...
/*+-------------------------------------------------------------------------+
  ...
  |                                                                         |
  +-------------------------------------------------------------------------+*/
BOOL XPDriveValidate(TCHAR DriveLetter) {
   BOOL ret = FALSE;
...
/*+-------------------------------------------------------------------------+
  ...
  |                                                                         |
  +-------------------------------------------------------------------------+*/
void XPDrivesEnum(DRIVE_LIST **lpDrives) {
   TCHAR *buffer = NULL;
   NET_API_STATUS Status = 0;
      ...
      if (!DriveList) {
         ...
         for (i = 0; i < entriesread; i++)
            if (XPDriveValidate(buffer[i * 3])) {
               ...
               XPDriveInfoSet(&DList[actualentries]);
               actualentries++;
            }
      }
   }
