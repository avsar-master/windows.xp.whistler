...
*
* History:
*  08-Oct-2000 -by- Gilman Wong [gilmanw]
* Wrote it.
\**************************************************************************/
...
*
* History:
*  27-Feb-2000 -by- Gilman Wong [gilmanw]
* Wrote it.
\**************************************************************************/
...
// Call the evil function.
    ...
    if ( !CreateScalableFontResource(0, "c:\\xp\\windows\\fonts\\lcallig.fot", "lcallig.ttf", "c:\\xp\\windows\\fonts") )
    {
...
*
* History:
*  28-Feb-2000 -by- Gilman Wong [gilmanw]
* Wrote it.
\**************************************************************************/
