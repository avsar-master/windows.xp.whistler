...
*
* Created: Sun 22-Sep-2000 -by- Patrick Haluptzok [patrickh]
*
...
*
* History:
*  25-September-2000 -by- Patrick Haluptzok patrickh
* Wrote it.
\**************************************************************************/
...
*
* History:
*  25 Apr 2000 - Andrew Milton (w-andym):
*      Added support for showing our loaded palette
*
*  18 Feb 2000 - Andrew Milton (w-andym):
...
*
*  27-September-2000 -by- Patrick Haluptzok patrickh
* Wrote it.
\**************************************************************************/
