...
Copyright (c) 2000  Microsoft Corporation & Maynard Electornics
...
Author:
    ...
    Steve DeVos (@Maynard)    2 March, 2000   15:38:24
               ...
               *lpContext = ccb ;
               ...
               switch( mwStreamList[ ccb->stream_index ] ) {
                    ...
                    case BACKUP_ALTERNATE_DATA :
                         ...
                         // ALT_DATA is Macixposh stream data and other data streams.
