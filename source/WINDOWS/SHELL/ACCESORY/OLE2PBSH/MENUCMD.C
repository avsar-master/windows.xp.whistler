...
#ifdef JAPAN
#include <dlgs.h>           // added 20 May. 2000
...
int nonBoldWeight; //  This weight is used instead of FW_MEDIUM, because some
                   // TT fonts have FW_LIGHT weight.      06 Jul. 2000
#endif
...
void PUBLIC MenuCmd(HWND hWnd, UINT item)
{
   ...
   TCHAR sz[FILENAMElen + PATHlen];
#ifdef JAPAN                  // added by Hiraisi  02 Sep. 2000
   static int tempType;
#endif
...
#ifdef JAPAN //KKBUGFIX added by Hiraisi 11 Nov. 2000 (BUG#457/WIN31 in Japan)
...
#ifdef JAPAN        // added by Hiraisi  08 Apr. 2000 : jinwoo 11/9/92
      if( bWritable ){
...
#ifdef  JAPAN            // added by Hiraisi  06 Jul. 2000 : jinwoo 11/9/92
         theFont.lfWeight = nonBoldWeight;
#else
         theFont.lfWeight = FW_MEDIUM;
#endif
...
#ifdef JAPAN   // added by Hiraisi  07 Apr. 2000 : jinwoo 11/9/92
...
AllStyles:
...
#ifdef JAPAN         // added by Hiraisi  17 Apr. 2000 : jinwoo 11/9/92
   ...
   case FONTS:
   {
      ...
      CHOOSEFONT cfStruct;
      int Result;
#ifdef JAPAN        // added by Hiraisi  20 May. 2000 : jinwoo 11/9/92
...
#ifdef JAPAN          // added by Hiraisi  20 Apr. 2000 : jinwoo 11/9/92
      if( bVertical )
      ...
      if (Result)
      {
         ...
         if( theFont.lfWeight != FW_BOLD )        //  added  06 Jul. 2000
             nonBoldWeight = theFont.lfWeight;

         //KKBUGFIX     // added by Hiraisi  15 May. 2000
         /*
 ...
 * from FONT combobox(cmb1) of the CHOOSEFONT dialog.       20 May. 2000
*/
