...
#if defined (JAPAN)||defined(KOREA) //  added 01 Jun. 2000  by Hiraisi, JeeP 10/13/92
...
#if defined (JAPAN)||defined(KOREA) //  added 29 May 2000  by Hiraisi, JeeP 10/12/92
    if (fTimePrefix)
    {
...
#if defined (JAPAN)||defined(KOREA) //  added 01 Jun. 2000  by Hiraisi, JeeP 10/12/92
    if (fTimePrefix)
    {
...
#if defined (JAPAN)||defined(KOREA) // added 29 May 2000  by Hiraisi, JeeP 10/13/92
/*
