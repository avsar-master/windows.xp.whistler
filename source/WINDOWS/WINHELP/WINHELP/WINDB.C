...
* 08-Jan-2000 LeoN      Name changes for clarity
* 01-Feb-2000 LeoN      Clear PDB_HPHR on error.
* 04-Apr-2000 kevynct   Use symbolic names from <filedefs.h>
* 14-May-2000 JohnSc    Save time stamp of file when we open it
* 13-May-2000 Tomsn     Call FlushCache when freeing a DB.
* 19-May-2000 Tomsn     Free FM when disposing of DB.
* 21-May-2000 LeoN      pdbAlloc takes "ownership" of passed FM
* 09-Jul-2000 LeoN      HELP31 #1213: Add PDB_GHCITATION to deallocate code
* 29-jul-2000 tomsn     win32: ifdef out timestamp stuff.
* 17-oct-2000 JahyenC   3.5 #16:  FDeallocPdb frees global copyright string
*
*****************************************************************************/
#define H_ANNO
#define H_ASSERT
