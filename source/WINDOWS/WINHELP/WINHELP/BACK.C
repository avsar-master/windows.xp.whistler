...
*   08-Feb-2000 JohnSc  bug 853: removed LhAlloc()
*   10-Feb-2000 JohnSc  bug 490: remove inaccessible files from stack
*   11-Feb-2000 JohnSc  bug 873: Backup() -> FBackup() to allow OOM
*                                message on alloc failure
*   12-Feb-2000 JohnSc  bug 490: don't remove file from the stack, just
*                                make sure we don't break
*   02-Apr-2000 maha    Globals like fBackMagic and tlpBackMagic are defined
*                       here instead of back.h
*   13-Dec-2000 davidfe Fixed the way things are kept on the stack - a single
