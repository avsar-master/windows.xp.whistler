...
* 13-May-2000 maha    removed w4 warning by coomenting GlobalUnlock( hIcon )
*                     at EICleanup5.
* 27-May-2000 LeoN    HELP31 #1145: Free any pre-existing icon if we're adding
*                     one.
* 29-jul-2000 Tomsn     win32: use MSetWindowWord() meta api for handles..
*                     Also, ifdef out internal icon call stuff.
* 07-Sep-2000 RussPJ  Fixed 3.5 #335 - not letting icon be discarded.
*
*****************************************************************************/
