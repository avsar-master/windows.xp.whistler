...
* 26-Jan-2000 RussPJ  Made hbma's originally non-discardable, though
*                     many routines make the discardable after first use.
* 29-Mar-2000 DavidFe Put in #ifdefs to stub things out for the Mac build
* 29-Aug-2000 RussPJ  Fixed 3.5 #108 - displaying >50 bitmaps.
* 23-Jan-2000 BethF   Added xDest,yDest fields to PICTINFO.
*
******************************************************************************
*                                                                            *
