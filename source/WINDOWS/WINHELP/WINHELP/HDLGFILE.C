...
*   05-Mar-2000 LeoN     Help3.1 #957: Select entire edit field contents for
*                        copy if nothing is selected when the copy dialog OK
*                        button is pressed.
*   02-Apr-2000 RobertBu Removed CBT Support
*   28-May-2000 LeoN     Changed version number macros somewhat
*   03-Jul-2000 LeoN     HELP31 #1093: Move WinHelp_VER macro to version.h
*   20-Jan-2000 LeoN     HELP31 #1400: reorder CopySpecial init dialog code
