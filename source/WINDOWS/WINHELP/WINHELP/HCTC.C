...
* 04-Feb-2000 RobertBu  Added code to handle a failed GetDC()
* 09-Jul-2000 LeoN      HELP31 #1213: Add Citation processing
*
*****************************************************************************/
...
HWND  hwnd;
  ...
  for (cDE = 0; cDE < 2; ++cDE)
    ...
    if (hdeCopy)
       ...
       * as an alternate. But that's no longer true. 09-Jul-2000 LeoN)
       */
