...
*                       searches.
*  03-Jan-2000 RussPJ   Modified the dirIni stuff to deal with root
*                       directories
...
*   18-Jan-2000 RussPJ  Changed winhelp.ini messagebox to only have
*                       OK and Cancel buttons.
*   25-Jan-2000 RussPJ  Removed local allocs for temp buffers.
*   06-Feb-2000 RussPJ  Fixed SzGetDir in error condition (sz == szNil).
* 06-Feb-2000 LeoN      Use sharing mode in OpenFile call.
*   12-Feb-2000 RussPJ  Fixed bug #828 - System modal MsgBox repainting.
*   14-Feb-2000 RussPJ  Fixed bug #828 again - using pchCaption for MsgBox.
*   21-Feb-2000 LeoN    Fix Return value in SzGetDir
* 09-May-2000 RussPJ    Removed FM caching.
* 30-May-2000   JohnSc  removed remnants of FM cache; FMs now are stored
*                       as upper case ANSI strings; fixed SnoopPath() . bug
* 11-Jun-2000 RussPJ    Post code review clean up.
* 19-Nov-2000 RussPJ    Fixed 3.1 #1274 - ROM windows executable file names
* 06-Dec-2000 LeoN      HELP31 #1318 - Make sure new FM is valid before
