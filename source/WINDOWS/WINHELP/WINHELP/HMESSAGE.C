...
* 04-Jan-2000 LeoN      Re-enable back button with secondary windows present
*                       by moving the zero-out of the button hwnds to
*                       CreateCoreButtons
* 04-Jan-2000 LeoN      Remove EnableDisable call from CreateCoreButtons()
* 16-Jan-2000 LeoN      Move creation of note window here to happen on first
*                       demand.
* 21-Jan-2000 Robertbu  Added code to prevent more than one call to
*                       BrowseButtons() per file.
* 21-Jan-2000 LeoN      Disable Annotate menu while annotating
* 26-Jan-2000 RussPJ    Removed a bad use of LhAlloc for file temp.
* 30-Jan-2000 LeoN      Always Destroy Dialogs in ExecMnuCommand (avoids
*                       secondary window issues re removing the window
*                       underneath.)
* 31-Jan-2000 LeoN      Add fForce flag back to EnableDisable
* 01-Feb-2000 RussPJ    Updated interface to DlgOpenFile().
* 04-Feb-2000 RobertBu  Added code to handle failure of GetDC()
* 04-Feb-2000 RussPJ    Fixed DlgOpenFile error on cancel bug.
* 06-Feb-2000 LeoN      Correct test order in CreateBrowseButtons
* 08-Feb-2000 LeoN      Reset fShown a little earlier in ShowNote to avoid
*                       a recursive destruction of more than we intended.
* 08-Feb-2000 RobertBu  Fixed problem where MouseInFrame() was not getting
*                       a valid DC.
* 02-Feb-2000 kevynct   Turn off hotspots in ShowNote before showing note wnd
* 14-Feb-2000 RobertBu  Added case for HLPMENUDEBUGASKFIRST (bug #887).
* 15-Feb-2000 RussPJ    Fixed bug #903 - deleting stock brush.
* 15-Mar-2000 LeoN      MouseInFrame => MouseInTopicHde; RefreshHde =>
*                       RepaintHde; PtGetLayoutSizeHde => GetLayoutSizeHdePpt
* 22-Mar-2000 RussPJ    Using COLOR for colors.
* 02 Apr-2000 RobertBu  Remove H_CBT
* 20-Apr-2000 RussPJ    Removed some -W4s
* 03-May-2000 LeoN      HELP31 #1091: Glossaries should be on-top in Win 3.1.
* 15-May-2000 Dann      Added case for HLPMENUDEBUGMEMLEAKS
* 16-Jul-2000 LeoN      HELP31 #1225: Process Search hilight on/off messages
*                       for both main and secondary windows.
* 29-jul-2000 Tomsn     win32: use meta api MUnrealizeObject(), use 32 bit pt struct.
* 19-Jul-2000 LeoN      Disable hit highlighting in 2nd windows.
* 27-Aug-2000 LeoN      HELP31 #1256: Ensure that Full Text Search MNU
*                       commands affect the main window.
* 27-Aug-2000 LeoN      HELP31 #1260: Remove attempts to turn off FTS hit
*                       highlighting in 2nd windows.
* 27-Aug-2000 LeoN      Add processing for HLPMENUHELPONTOP
* 27-Aug-2000 LeoN      HELP307 #1278: Load shell.dll name as resource so
*                       that Viewer can blow it off if desired.
* 23-Sep-2000 LeoN      HELP31 #1278: just ignore attempts to place browse
*                       buttons up twice.
* 24-Sep-2000 JahyenC   Help 3.5 #5: replaced SetHds() calls in NoteWndProc()
*                       with GetAndSetHDS()/RelHDS() pair.
* 08-Nov-2000 BethF     HELP35 #615: ignore meta keys while Note window
*                       is up and don't process any menu keys (see hwproc.c).
* 12-Nov-2000 BethF     HELP35 #572: SelectObject() cleanup.
* 09-Dec-2000 LeoN      HELP31 #1289: ensure that history window gets set
*                       on top when we process HLPMENUHELPONTOP
* 13-Dec-2000 LeoN      HELP31 #1353: Make the current help window, rather
*                       than the main help window the parent for glossaries.
* 16-Jan-2000 LeoN      HELP31 #1393: Add test of WFLAGS_AUTHHOT to keep
*                       secondary window authored as on-top on-top.
* 22-Feb-2000 LeoN      HELP35 #744: GetVersion => GetWindowsVersion
* 07-Apr-2000 RussPJ    3.5 #748 - NULLing destroyed hwndNote.
*
*****************************************************************************/
...
HWND hwnd;
  ...
  if (hwndButtonPrev)
     ...
     * >right here<.
     *
     * Fix for HELP31 #1278; 23-Sep-2000 LeoN
     */
    return;
