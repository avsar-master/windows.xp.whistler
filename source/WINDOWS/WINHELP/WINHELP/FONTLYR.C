...
* 08-Jan-2000 LeoN      Decouple the font information read from a file and
*                       stored in the DB from the font cache, which is now
*                       stored in the DE. The contents of the cache is device
*                       dependant.
* 11-Jan-2000 LeoN      #ifdef out SelectStandardFont
* 13-Jan-2000 kevynct   Symbol font support
* 22-Mar-2000 RussPJ    Using COLOR for colors.
* 23-Apr-2000 RussPJ    Cleaned up for code review.
* 06-Nov-2000 BethF     Removed HINS parameter from InitFontLayer()
* 12-Nov-2000 BethF     HELP35 #572: SelectObject() cleanup.
* 10-Jan-2000 LeoN      HELP31 #1373: attempt to reload font table
*
*****************************************************************************/
