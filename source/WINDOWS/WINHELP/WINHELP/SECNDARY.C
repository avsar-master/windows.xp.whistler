...
* 02-Jan-2000 LeoN      Handle window creation failure
* 02-Jan-2000 LeoN      Set Title for all windows in FFocusSzHde
* 03-Jan-2000 LeoN      Change the way we resize to avoid double paints
* 04-Jan-2000 RussPJ    Added a check for user override on window background
*                       color (COLORS=NONE win.ini switch)
* 18-Jan-2000 LeoN      Correct transition from maximized to non-maximized
*                       state.
* 19-Jan-2000 LeoN      We cannot set the normal size of a window which is
*                       maximized. Sigh.
* 21-Jan-2000 LeoN      HwndMemberSz should return current window for null
*                       member name.
* 22-Jan-2000 LeoN      Add InvalidateMember. Clean-up recursion case.
* 01-Feb-2000 LeoN      Member names are now passed as near strings to avoid
*                       DS movement problems.
* 01-Feb-2000 LeoN      Restore minimized window before attempting to size
*                       it.
* 04-Feb-1990 RobertBu  Added code to handle failure of GetDC()
* 05-Feb-2000 LeoN      Have HwndMemberSz understand membernames of the form
*                       "@1".
* 16-Apr-2000 RobertBu  Added InformWindow() for positioning, focusing, and
*                       closing windows (#1037, #1031).
* 18-Apr-2000 LeoN      Add HelpOnTop. Remove "pascal"
* 01-May-2000 LeoN      Correct assert in InformWindow
* 01-May-2000 LeoN      HELP31 #1081: correct initial paint of secondary
*                       windows under WIN 3.0. HelpOnTop interaction.
* 03-May-2000 LeoN      HELP31 #1058: Clear up initial paint problems a
*                       little better.
* 03-May-2000 LeoN      HELP31 #1098: Ensure that focus is unchanged by
*                       InformWindow
* 20-May-2000 LeoN      GhDupGh takes an additional param
* 10-Jul-2000 DavidFe   Fixed a problem dealing with color records
* 29-jul-2000 Tomsn     win32: use MSetWindowWord() meta api
* 19-Jul-2000 LeoN      HELP31 #1232: disable fts hits in 2nd windows & gloss
* 27-Aug-2000 LeoN      HELP31 #1244: remove fHiliteMatches from DE.
* 27-Aug-2000 LeoN      HELP31 #1260: Add FIsSecondaryQde
* 27-Aug-2000 LeoN      Changes for most recent Help On Top proposal
* 07-Nov-2000 RussPJ    3.5 #641 - making sure that window caption is
*                       correct.
* 13-Dec-2000 LeoN      HELP31 #1290: ensure 2nd window gets set on top if
*                       allways on top global state is set
* 13-Dec-2000 LeoN      HELP31 #1271: Remove  default 2nd win caption
* 08-Jan-2000 LeoN      HELP31 #1351: Remove WFLAGS_SHADOW
* 16-Jan-2000 LeoN      HELP31 #1393: Add manipulation of WFLAGS_AUTHHOT to
*                       remember whether or not a secondary window was
*                       authored as on-top.
* 11-Feb-2000 RussPJ    3.5 #554 - Correct API for HOT.
* 22-Jan-2000 LeoN      HELP31 #1403: give each shadow window an invisible
*                       parent so that task manager won't try to tile or
*                       cascade the window seperately.
* 03-Apr-2000 RussPJ    3.5 #710 - Showing wash when unhiding.
* 04-Apr-2000 LeoN      HELP31 #1308: Add NszMemberCur
*
*****************************************************************************/
