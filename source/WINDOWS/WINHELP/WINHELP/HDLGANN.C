...
*  Revision History:
*
*  May 19 2000    w-kevct   Added dlgbox code.
...
*  2000/02/09   RobertBu    Disable the Save and Copy buttons for an empty
*                           edit control.
*  April 2 2000 RobertBu    Removed CBT Support
* 08-Sep-2000 RussPJ        Fixed 3.5 #? - Reporting when annotations too long.
*
*****************************************************************************/
