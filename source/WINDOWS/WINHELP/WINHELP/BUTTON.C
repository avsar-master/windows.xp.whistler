...
*   Revision History:
*
*   02-Feb-2000 RussPJ   Layered explicit calls to LocalAlloc().
*   08-Feb-2000 RobertBu Made all far string pointers near to solve real
*                        mode problems.
*   28-Mar-2000 RobertBu Added InsertAuthorItem() #993
*   16-Apr-2000 RobertBu Added PositionWin(), CloseWin(), and FocusWin()
*                        (#1037, #1031).
*   12-Aug-2000 LeoN     Change AbleAuthorItem magic numbers to constants
*
*****************************************************************************
*
