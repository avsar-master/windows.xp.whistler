...
*   28-Jan-2000 LeoN     In GetQFCINFO call FixUpBlock after calculating the
...
*   04-Feb-2000 Tomsn    Fix ptr 739 -- handle MOBJs crossing block boundaries,
*                        They arise due to a help 3.0 compiler bug.
*   91/03/12    kevynct  Major cleanup and changes for SDFF support.
*   23-Apr-2000 JohnSc   added character set stuff
*   14-May-2000 Tomsn    Ptr 1036: add a routine FlushCache() to invalidate
