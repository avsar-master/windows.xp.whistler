...
* 05-Feb-2000 LeoN      Disable both main and secondary windows while print
* 13-Mar-2000 RussPJ    Took ownership.
* 15-Mar-2000 LeoN      RefreshHde => RepaintHde; DptScrollLayout =>
*                       ScrollLayoutQdePt; Remove a now meaningless assert
* 20-Apr-2000 RussPJ    Removed some -W4s
* 06-May-2000 Dann      Use 3.1 COMMDLG Print Setup dialog
* 29-jul-2000 Tomsn     win32: back out MSendMsgWM_COMMAND() change previousely made.
* 10-Feb-2000 RussPJ   3.5 #699 - Support for international in print text.
* 03-Apr-2000 RussPJ   3.5 #709 - Clearing macro flag
* 16-Apr-2000 RussPJ   3.5 #756 - Checking GETPHYSPAGESIZE Escape return.
*
*****************************************************************************/
