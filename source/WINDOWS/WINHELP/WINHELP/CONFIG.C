...
* 18-Jan-2000 LeoN      Remove RepaintButtons & redundant individual button
*                       window invalidation
* 21-Jan-2000 RobertBu  Added code to handle NULL main menu bar and fixed
*                       problems with menu items being added on "bad"
*                       inserts.
* 29-Jan-1990 RobertBu  Fixed bad string delete in DeleteMenuItem()
* 02-Feb-2000 RussPJ    Layered Local memory calls completely.
* 04-Feb-2000 RobertBu  Fixed some comments
* 04-Feb-2000 RobertBu  AddAccelerator() logic was wrong resuling in using an
*                       uninitialized stack variable for a handle.
* 08-Feb-2000 RobertBu  AddAccelerator() -> FAddAccelerator()
* 14-Feb-2000 RobertBu  AcceleratorExecute() was double unlocking the local
*                       handle on a successful hit (bug #895)
* 05-Apr-2000 LeoN      HELP31 #1002: Modify YArrangeButtons not to
...
* 16-Apr-2000 RobertBu  Partial fix for duplicate menu when adding a
*                       popup fails (bug #935).
* 20-Apr-2000 RussPJ    Removed some -W4s
* 22-May-2000 LeoN      Set hmnuHelp when the menu changes.
* 29-jul-2000 Tomsn     win32: use MSetWindowWord() meta api for handles..
* 27-Aug-2000 RussPJ    Fixed 3.1 #1191 - Put in gross hack for MMV helpless
*                       ability.
* 27-Aug-2000 LeoN      Fixed 3.1 #1203: Don't keep adding accelerators for
*                       the same key over and over.
* 27-Aug-2000 LeoN      Add "Always on Top" Menu item under Win 3.1
* 06-Sep-2000 RussPJ    Fixed 3.5 #256 - Deleting right menu in InsertPopup()
*                       failure.
* 08-Sep-2000 RussPJ    3.5 #212 - Better repainting in EnableButton()
* 12-Nov-2000 BethF     HELP35 #572: Added DestroyFloatingMenu(), called
