...
* 01-Apr-2000 LeoN      SDFF rework.
* 04-Apr-2000 LeoN      Use Correct Constant
* 04-Apr-2000 kevynct   Use szSystemFileName from <filedefs.h>
* 23-Apr-2000 JohnSc    added CS stuff
* 13-May-2000 LeoN	Correct memory leak for 3.0 files.
* 15-Jun-2000 t-AlexCh  Fixed SDFF bug in FReadSystemFile:tagWindow
* 09-Jul-2000 LeoN      HELP31 #1213: Add tagCitation processing
* 29-Jul-2000 Tomsn    win32: sizeof(INT) -> sizeof( WORD )
* 17-Oct-2000 JahyenC   H3.5 #16: Changed copyright string read to allocate 
