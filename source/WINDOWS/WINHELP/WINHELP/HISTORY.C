...
*  08-Feb-2000 JohnSc   bug 824, 833: removed assertion on CreateWindow();
*                       bug 854: removed LhAlloc()
*  11-Feb-2000 JohnSc   bug 873: check FWinHelp() return and give OOM msg
*  10-Apr-2000 JohnSc   forget about WM_GETMINMAXINFO
*  09-Dec-2000 LeoN     HELP31 #1289: ensure that history window gets set
*                       on top when created if on-top is set.
* 28-Feb-2000 RussPJ   3.5 #608 - Localizable History caption.
*
*****************************************************************************/
