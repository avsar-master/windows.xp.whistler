...
*                                                                            *
*  Revision History:            *
*   22-Apr-2000 kevynct Created from bitmap.c
*   30-May-2000 Tomsn   Use win32 meta-api MSetWindowExt()
* 29-Aug-2000 RussPJ    Fixed 3.5 #108 - displaying >50 bitmaps.
* 28-Oct-2000 RussPJ    More work on efficient use of caching.
* 04-Nov-2000 RussPJ    Fixed memory leak with caching metafiles.
*
******************************************************************************
*                                                                            *
