...
* 08-Feb-2000 IanJa     Unicode/ANSI aware & neutral
\***************************************************************************/
...
*
* History:
* 10-Feb-2000 DavidPe       Created.
* 30-Jan-2000 IanJa         Added bAnsi parameter
\***************************************************************************/
...
*
* History:
* 28-Jan-2000 DavidPe      Created.
* 15-May-2000 ScottLu      Changed to work client/server.
* 30-Jan-2000 IanJa        Added bAnsi parameter
\***************************************************************************/
