...
* 12-Feb-2000 mikeke    Added Revalidation code
* 19-Feb-2000 JimA      Added access checks
\***************************************************************************/
...
*
* History:
* 19-Feb-2000 JimA      Added access check
...
*
* History:
*    04 Feb 2000 GregoryW  Neutral ANSI/Unicode version
\***************************************************************************/
